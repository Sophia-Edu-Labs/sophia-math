...
class LinAlg_1_5_I_1_I(SophiaCursorScene):
    ...
    def construct(self):
        ...
        with self.voiceover(
                text="""
                In diesem Kapitel lernen wir, was <bookmark mark="title_in"/>die Determinante einer Matrix ist.
                Die Determinante ist quasi ein skalarer Wert, der jeder Matrix zugeordnet wird. Sie<bookmark mark="mat"/> macht aus jeder quadratischen Matrix <bookmark mark="number"/>  <break time="0.4s"/> eine Zahl. Wir nennen diese Zahl <bookmark mark="det"/> die Determinante der Matrix. 
