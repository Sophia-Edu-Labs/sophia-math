...
class LinAlg_1_4_I_1(SophiaCursorScene):
    ...
    def construct(self):
        ...
        # Action Sequence
        with self.voiceover(
                text=""" Betrachte die zwei<bookmark mark="vec_1"/> Vektoren 1 0 0 <bookmark mark="vec_2"/><break time="0.6s"/>und 0 1 0.<split/>
                        ...
                        Betrachten wir also den Vektor <bookmark mark="vec_new_in_2"/>0 0 eins.<split/> Man kann einfach sehen, dass sich dieser Vektor nicht als Linearkombination der beiden anderen Vektoren darstellen lässt. In diesem Fall sagt man, dass die drei Vektoren <bookmark mark="indep"/>linear unabhängig sind.
                """
        ) as tracker:
