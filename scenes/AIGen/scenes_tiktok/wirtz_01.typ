...
#only("1")[
#voiceover("Hallo meine lieben Kartoffeln.")
]
#only("2")[
#voiceover("Hier ist Florian um mit euch etwas Mathe zu üben. Die Aufgabe heute: Wir addieren ein Viertel und zwei Drittel.")
]
]
...
#only("1")[
#voiceover("Beginnen wir damit, die Brüche zu betrachten. Hier siehst du die Brüche mit ihren ursprünglichen Nennern. Links haben wir ein Viertel und rechts zwei Drittel.")
]
#only("2")[
...
#only("2")[
#voiceover("Drei Zwölftel plus acht Zwölftel ist also gleich elf Zwölftel. Und das ist das korrekte Ergebnis. Schon fertig, ganz einfach.")
]
]