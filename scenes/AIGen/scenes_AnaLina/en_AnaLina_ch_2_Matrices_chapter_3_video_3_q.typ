...
questionText: "What is the result of multiplying the matrix $mat(1, 2; 3, 4)$ by the scalar $3$?",
answerOptions: ("The result is $mat(3, 6; 9, 12)$, or an equivalent statement.", "The answer is incorrect."),
