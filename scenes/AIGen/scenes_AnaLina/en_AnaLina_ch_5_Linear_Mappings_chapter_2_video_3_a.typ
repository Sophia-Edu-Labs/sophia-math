...
#only("1")[
#voiceover("Great job! That's the correct answer. Let's go through the solution step by step to understand how to find the kernel of the given linear mapping.")
]
]
