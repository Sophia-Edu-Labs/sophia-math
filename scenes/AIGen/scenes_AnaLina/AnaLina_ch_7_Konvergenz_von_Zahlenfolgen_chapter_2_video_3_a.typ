...
#only("1")[
#voiceover("Super, das ist richtig! Lass uns die Zahlenfolge a_n gleich n betrachten und herausfinden, ob sie einen Grenzwert hat, wenn n gegen unendlich geht.")
]
#only("2")[
