...
#slide()[
#only("1")[
  #voiceover("Hi, hier ist Max Verstappen und ich zeig euch jetzt wie man schneller Rechnen kann als ich Formel 1 fahre!")
]
...
#only("2")[
  #voiceover("Bestimmen wir die Ableitung der Funktion f von x gleich null Komma fünf mal x hoch vier plus x hoch minus drei.")
]
]

#slide()[
#only("1")[
  #voiceover("Dafür wenden wir die Summenregel an und leiten jeden Summanden einzeln ab.")
]
#only("1")[
...
#only("5")[#voiceover("Also ist f Strich von x gleich zwei mal x hoch drei minus drei mal x hoch minus vier. Ok, so viel von mir, folgt jetzt Sophhia auf TikTok und holt euch auf swipemath punkt com die SwipeMath App!")]
]