...
#slide()[
  ...
  #only("1")[
    #voiceover("Excellent work! Let's walk through the solution step-by-step. We're dealing with the quadratic equation x squared minus 3x minus 4 equals zero.")
  ]
  #only("2")[
