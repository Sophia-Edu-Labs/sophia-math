...
#only("3")[#voiceover("b) Ein Punkt ist die richtige Antwort. Koordinaten identifizieren einen bestimmten Punkt in einem Vektorraum eindeutig.")]
...
#v(20pt)
#only("2-")[- In einem Vektorraum hat jeder Punkt ein einzigartiges Koordinatensystem 📍]
...
#only("6-")[  - Dies liegt daran, dass $2 dot mat(1;0) + 3 dot mat(0;1) = mat(2;3)$]
...
#only("2")[#voiceover("Erstens, erinnern wir uns daran, dass in einem Vektorraum jeder Punkt ein einzigartiges Koordinatensystem hat.")]
...
#only("6")[#voiceover("Dies liegt daran, dass wir 2, 3 als Linearkombination der Basisvektoren schreiben, wir erhalten 2 mal 1, 0 plus 3 mal 0, 1, was gleich 2, 3 ist.")]
...
#only("4-")[- Jeder Punkt hat ein einzigartiges Koordinatensystem 🔢]
...
#only("4")[#voiceover("Jeder Punkt im Vektorraum hat ein einzigartiges Koordinatensystem.")]
#only("5")[#voiceover("Großartige Arbeit beim Verständnis dieses grundlegenden Konzepts der linearen Algebra! Machen Sie weiter so.")]
]