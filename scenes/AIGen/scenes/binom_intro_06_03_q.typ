...
#v(40pt)
#only("1")[
#voiceover("Betrachten wir folgende Frage:")
]
#only("2-")[Wie oft muss man mindestens einen fairen sechsseitigen Würfel werfen, damit man mit einer Wahrscheinlichkeit von mindestens 95% mindestens eine gerade Zahl würfelt?]
#only("2")[
