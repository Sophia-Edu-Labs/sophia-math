...
#slide()[
  ...
  #only("1")[
    #voiceover("Nicht ganz richtig. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit einer Potenzfunktion zu tun: f von x ist gleich minus fünf mal x hoch vier.")
  ]
  #only("2")[
