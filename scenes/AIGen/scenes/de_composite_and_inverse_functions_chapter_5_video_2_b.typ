...
#only("3")[#voiceover("Option b) $g(x)$ ist ebenfalls falsch aus dem gleichen Grund. Die Zusammensetzung von Umkehrfunktionen ergibt nicht eine der ursprünglichen Funktionen.")]
