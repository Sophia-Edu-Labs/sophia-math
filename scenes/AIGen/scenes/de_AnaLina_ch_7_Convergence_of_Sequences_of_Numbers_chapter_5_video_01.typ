...
#v(40pt)
#only("1-")[- Folgen, die nicht zu einem bestimmten Wert konvergieren]
#v(20pt)
#only("2-")[- Glieder wachsen unbegrenzt oder oszillieren]
#only("1")[
#voiceover("Divergente Folgen sind Folgen, die nicht zu einem bestimmten Wert konvergieren, wenn n gegen unendlich geht.")
]
#only("2")[
...
#only("3")[
#voiceover("Hier ist ein Diagramm der Folge. Du kannst sehen, dass die Glieder der Folge mit wachsendem n weiter wachsen und gegen unendlich divergieren.")
]
]
]
...
#only("1-")[- Glieder: -1, 2, -3, 4, ...]
#v(20pt)
#only("2-")[- Oszilliert und wächst im Betrag, wenn $n → ∞$]
#v(20pt)
#only("3-")[
#box()[
#morphchildren(id: "plot")[
...
#only("2")[
#voiceover("Wenn n wächst, oszillieren die Glieder der Folge zwischen positiven und negativen Werten, und ihr Betrag wächst unbegrenzt.")
]
#only("3")[
#voiceover("Hier ist ein Diagramm der Folge. Du kannst sehen, dass die Glieder zwischen positiven und negativen Werten wechseln und ihr Absolutbetrag mit wachsendem n weiter wächst.")
]
]
]
...
#only("1")[
#voiceover("Zusammenfassend sind divergente Folgen solche, die nicht zu einem bestimmten Wert konvergieren.")
]
#only("2")[
#voiceover("Wir haben uns zwei Beispiele angesehen: a_n gleich n und b_n gleich minus 1 hoch n mal n.")
]
#only("3")[
#voiceover("In diesen Folgen wachsen die Glieder entweder unbegrenzt oder oszillieren und wachsen im Betrag, wenn n gegen unendlich geht.")
]
]