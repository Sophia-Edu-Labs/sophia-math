...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's walk through the solution step-by-step. We're dealing with a cuboid, which is a three-dimensional rectangular shape. As you can see in this diagram, our cuboid has a length of 9 meters, a width of 4 meters, and a height of 6 meters.")
  ]
]
