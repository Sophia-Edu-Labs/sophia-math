...
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert und multipliziert hast. Ein Viertel plus zwei Drittel ist nicht gleich sieben Zwölftel.")
]
#only("2")[
...
#only("2")[
#voiceover("Zunächst siehst du ein Viertel, und daneben drei Zwölftel. Du kannst erkennen, dass der Wert gleich bleibt, nur die Darstellung ist anders. Also ist ein Viertel gleich drei Zwölftel, und nicht gleich sieben Zwölftel.")
]
#only("3")[
#voiceover("Und hier siehst du zwei Drittel und acht Zwölftel. Auch hier bleibt der Wert gleich, nur die Darstellung ist anders. Zwei Drittel ist also gleich acht Zwölftel, und nicht gleich sieben Zwölftel.")
]
]
...
#v(20pt)
#only("1-")[Also ist $1/4 + 2/3 = 11/12$, nicht $7/12$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beachte den Zähler beim Addieren von Brüchen]
#only("1")[
#voiceover("Also ist ein Viertel plus zwei Drittel gleich elf Zwölftel, nicht sieben Zwölftel.")
]
#only("2")[
