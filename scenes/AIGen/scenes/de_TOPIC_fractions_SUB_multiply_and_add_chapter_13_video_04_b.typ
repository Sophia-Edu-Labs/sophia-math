...
#slide()[
  ...
  #only("1")[
    #voiceover("Leider ist das nicht korrekt. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, warum drei Zehntel plus zwei Fünftel sieben Zehntel ergibt.")
  ]
