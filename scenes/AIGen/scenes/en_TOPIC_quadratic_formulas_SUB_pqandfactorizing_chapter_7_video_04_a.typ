...
#slide()[
  ...
  #only("1")[
    #voiceover("Great job on solving this quadratic equation! Let's go through the solution step-by-step. We start with the equation x squared plus 2x minus 8 equals zero.")
  ]
  #only("2")[
