...
#slide()[
#text(size: 30pt, weight: "bold")[Air Pressure at Lakes 🏞️]
#v(40pt)
...
#only("1")[#voiceover("Let's test your knowledge on air pressure at different lakes. Assuming the same weather conditions, at which of these Swiss lakes would the air pressure be the highest?")]
#only("2")[#voiceover("Would it be at Lake Zurich,")]
#only("3")[#voiceover("or at Lake Neuchâtel,")]
#only("4")[#voiceover("or maybe at Lake Klöntal,")]
#only("5")[#voiceover("or would it be at Lake Maggiore?")]
]#questionDef(
