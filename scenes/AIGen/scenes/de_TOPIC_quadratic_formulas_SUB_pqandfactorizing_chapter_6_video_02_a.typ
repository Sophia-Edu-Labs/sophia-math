...
#slide()[
  ...
  #only("1")[
    #voiceover("Ausgezeichnet! Lass uns diese quadratische Gleichung Schritt für Schritt lösen. Wir beginnen mit der Gleichung x Quadrat plus 4x plus 3 gleich null.")
  ]
  #only("2")[
