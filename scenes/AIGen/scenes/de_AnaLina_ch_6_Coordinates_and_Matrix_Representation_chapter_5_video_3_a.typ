...
#only("2")[
#voiceover("Um die Basiswechselmatrix zu finden, setzen wir einfach diese Basisvektoren als Spalten. Also ist die Basiswechselmatrix P die Matrix mit den Spalten eins, eins und eins, minus eins.")
]
]
