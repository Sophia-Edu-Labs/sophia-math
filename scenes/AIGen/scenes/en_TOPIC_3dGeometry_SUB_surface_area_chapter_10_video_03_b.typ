...
plt.show()
  ...
  #only("1")[
    #voiceover("Let's review the correct solution step-by-step. We're dealing with a cuboid that has a surface area of 220 square meters. We know two of its dimensions: 11 meters and 5 meters. Our task is to find the height.")
  ]
]]
