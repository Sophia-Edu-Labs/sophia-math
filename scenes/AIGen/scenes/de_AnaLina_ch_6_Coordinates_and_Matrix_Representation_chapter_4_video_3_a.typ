...
#v(40pt)
Das ist die richtige Antwort! Schauen wir uns an, wie wir dies Schritt für Schritt lösen können.
#only("1")[
#voiceover("Großartige Arbeit! Das ist die richtige Antwort. Schauen wir uns an, wie wir dies Schritt für Schritt lösen können.")
]
]
...
#only("2")[
#voiceover("Also, zwei, null gleich a mal eins, eins plus b mal eins, minus eins.")
]
]
...
#only("1")[
#voiceover("Dies ergibt ein System von zwei Gleichungen. Die erste Gleichung ist zwei gleich a plus b, und die zweite Gleichung ist null gleich a minus b.")
]
#only("2")[
...
#only("2")[
#voiceover("Dies ergab ein Gleichungssystem, das wir gelöst haben.")
]
#only("3")[
