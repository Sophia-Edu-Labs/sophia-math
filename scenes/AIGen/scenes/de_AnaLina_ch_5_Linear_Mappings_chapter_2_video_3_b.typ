...
#v(40pt)
#only("1-")[Das ist die richtige Antwort! Gehen wir die Lösung Schritt für Schritt durch.]
#only("1")[
#voiceover("Das ist nicht ganz richtig. Gehen wir die Lösung Schritt für Schritt durch, um zu verstehen, wie man den Kern der gegebenen linearen Abbildung findet.")
]
]
...
#only("1")[
#voiceover("Erinnern wir uns, dass der Kern einer linearen Abbildung T die Menge aller Vektoren v ist, sodass T von v gleich dem Nullvektor ist.")
]
#only("2")[
...
#v(20pt)
#only("3-")[- Lösung des Gleichungssystems:]
#v(10pt)
#only("4-")[  - $x + y = 0$]
#v(10pt)
#only("5-")[  - $x - y = 0$]
...
#v(40pt)
#only("1-")[- Addition der Gleichungen: $2x = 0$, also $x = 0$]
#v(20pt)
...
#only("1")[
#voiceover("Hier ist eine Visualisierung der linearen Abbildung T. Die blauen Pfeile stellen die Abbildung verschiedener Punkte in R² dar. Beachten Sie, dass alle Pfeile vom Ursprung wegzeigen, außer dem Ursprung selbst, der auf den Nullvektor abgebildet wird. Dies ist der Kern von T, hervorgehoben in Rot.")
]
]
]
