...
```
  ...
  #only("1")[
    #voiceover("Not quite. Let's go through the correct solution step by step. We're dealing with the power function f of x equals 7 times x squared. We need to find f of 3, which means we need to evaluate the function at x equals 3.")
  ]
]
