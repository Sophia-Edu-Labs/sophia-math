...
#v(40pt)
//Antwort des Schülers: $28/30$
#only("2-")[Deine Antwort: $28/30$]
#only("1")[
#voiceover("Wir sollen drei Fünftel plus zwei Sechstel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist achtundzwanzig Dreißigstel. Das ist richtig!")
]
]
...
#v(40pt)
#only("1-")[Deine Lösung: $3/5 + 2/6 = 28/30$]
#v(20pt)
#only("2-")[👍 Gut gemacht! Du hast die Brüche korrekt addiert]
#v(20pt)
#only("3-")[🔍 Schauen wir uns das noch einmal genauer an]
#only("1")[
#voiceover("Du hast drei Fünftel plus zwei Sechstel korrekt berechnet und das Ergebnis ist achtundzwanzig Dreißigstel.")
]
#only("2")[
...
#only("2")[
#voiceover("Also haben wir jetzt achtzehn Dreißigstel statt drei Fünftel,")
]
#only("3")[
#voiceover("und zehn Dreißigstel statt zwei Sechstel. Du siehst, dass auf jeder Seite der Wert gleich ist, lediglich die Darstellung ist anders.")
]
]
