...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartig! Das ist korrekt. Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit der Funktion f von x gleich 2x hoch 3 plus x hoch 2.")
  ]
