...
#slide()[
#only("1")[
#voiceover("Keine Sorge, wir gehen die Lösung der quadratischen Gleichung Schritt für Schritt durch, um zu sehen, wo der Fehler lag und wie man zur richtigen Antwort kommt.")
]
