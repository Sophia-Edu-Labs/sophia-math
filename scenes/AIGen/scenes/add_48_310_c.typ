...
#v(40pt)
#only("1-")[Dein Fehler: $4/8 + 3/10 ≠ (8+10)/(8 dot 10)$]
#v(20pt)
#only("2-")[🛠️ Du hast die Summe der Nenner durch das Produkt der Nenner geteilt]
#v(20pt)
#only("3-")[🛠️ Du musst den Zähler anders bestimmen]
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert und multipliziert hast. Vier Achtel plus drei Zehntel ist nicht gleich achtzehn Achtzigstel.")
]
#only("2")[
...
#only("2")[
#voiceover("Zunächst siehst du vier Achtel, und daneben zwanzig Vierzigstel. Du kannst erkennen, dass der Wert gleich bleibt, nur die Darstellung ist anders. Also ist vier Achtel gleich zwanzig Vierzigstel, und nicht gleich achtzehn Achtzigstel.")
]
#only("3")[
#voiceover("Und hier siehst du drei Zehntel und zwölf Vierzigstel. Auch hier bleibt der Wert gleich, nur die Darstellung ist anders. Drei Zehntel ist also gleich zwölf Vierzigstel, und nicht gleich achtzehn Achtzigstel.")
]
]
...
#v(20pt)
#only("1-")[Also ist $4/8 + 3/10 = 32/40$, nicht $18/80$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beachte den Zähler beim Addieren von Brüchen]
#only("1")[
#voiceover("Also ist vier Achtel plus drei Zehntel gleich zweiunddreißig Vierzigstel, nicht achtzehn Achtzigstel.")
]
#only("2")[
