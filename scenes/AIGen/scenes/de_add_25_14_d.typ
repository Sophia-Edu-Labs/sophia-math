...
#v(40pt)
#only("1-")[Deine Lösung: $2/5 + 1/4 = 13/20$]
#v(20pt)
#only("2-")[👍 Gut gemacht! Du hast die Brüche korrekt addiert]
#v(20pt)
#only("3-")[🔍 Schauen wir uns das noch einmal genauer an]
#only("1")[
#voiceover("Du hast zwei Fünftel plus ein Viertel korrekt berechnet und das Ergebnis ist dreizehn Zwanzigstel.")
]
#only("2")[
...
# Ersten Bruch 8/20 plotten
visualize_fraction(axs[0], 8, 20, 'blue', '8/20')
# Zweiten Bruch 5/20 plotten
...
#only("3")[
#voiceover("und fünf Zwanzigstel statt ein Viertel. Du siehst, dass auf jeder Seite der Wert gleich ist, lediglich die Darstellung ist anders.")
]
]
...
# Summe der Brüche 13/20 plotten
