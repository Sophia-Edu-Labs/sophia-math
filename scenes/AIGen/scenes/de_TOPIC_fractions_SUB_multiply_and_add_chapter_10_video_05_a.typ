...
#slide()[
  #only("1")[
    #voiceover("Großartige Arbeit! Du hast dieses Subtraktionsproblem korrekt gelöst. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, wie wir zur Antwort gekommen sind.")
  ]
