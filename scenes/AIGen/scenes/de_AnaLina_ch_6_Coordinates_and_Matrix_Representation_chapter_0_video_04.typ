...
#v(40pt)
#only("1")[
#voiceover("Lass uns rekapitulieren, was wir über Koordinaten gelernt haben.")
]
#only("2-")[
...
#only("3")[
#voiceover("Zum Beispiel hat der Vektor v, der der Matrix 3; 4 in R 2 entspricht, die Koordinaten 3, 4.")
]
]
...
#only("2")[
#voiceover("Zum Beispiel, wenn B der Matrix 1; 0, 0; 1 in R 2 entspricht, dann hat der Vektor v, der 2; 3 entspricht, die Koordinaten 2, 3 relativ zur Basis B.")
]
]
...
#only("3")[
#voiceover("Das Beherrschen des Konzepts der Koordinaten ist entscheidend für deine Reise in der linearen Algebra!")
]
]