...
#v(40pt)
#only("1-")[Was ist das Ergebnis, wenn man $4$ mit $2/3$ multipliziert?]
...
#only("1")[#voiceover("Lass uns dein Wissen über das Multiplizieren von Brüchen testen. Was ist das Ergebnis, wenn man 4 mit zwei Dritteln multipliziert?")]
