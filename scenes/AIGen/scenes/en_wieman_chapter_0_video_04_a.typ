...
#v(40pt)
#only("1-")[That's the correct answer! Let's see how we arrive at that solution.]
#only("1")[
#voiceover("Great job! You got the correct answer of 156.96 newtons per meter for the spring constant. Let's walk through the solution step-by-step to see how we arrive at that result.")
]
]
