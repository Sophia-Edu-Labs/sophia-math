...
#slide()[
  ...
  #only("1")[
    #voiceover("Das war nicht ganz richtig. Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit Matrix A. Es ist eine 2x3-Matrix mit den Elementen 1, 2, 3 in der ersten Zeile und 4, 5, 6 in der zweiten Zeile.")
  ]
  #only("2")[
