...
plt.show()
  ...
  #only("1")[
    #voiceover("Keine Sorge, das war eine knifflige Frage. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben einen Würfel mit einer Seitenlänge von 5,5 Zentimetern. Hier ist eine Visualisierung unseres Würfels.")
  ]
]
