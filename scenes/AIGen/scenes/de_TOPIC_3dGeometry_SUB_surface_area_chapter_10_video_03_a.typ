...
plt.show()
  ...
  #only("1")[
    #voiceover("Großartig! Du hast dieses Problem korrekt gelöst. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit einem Quader zu tun, der eine Oberfläche von 220 Quadratmetern hat. Wir kennen zwei seiner Dimensionen: 11 Meter und 5 Meter. Unsere Aufgabe ist es, die Höhe zu finden.")
  ]
]
