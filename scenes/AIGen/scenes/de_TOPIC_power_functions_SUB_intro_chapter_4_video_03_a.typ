...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartige Arbeit, dass Du Dich dieser Frage stellst! Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit einer Potenzfunktion mit einem negativen Exponenten zu tun.")
  ]
  #only("2")[
