...
#only("1")[#voiceover("Warum kann eine Matrix eine lineare Abbildung darstellen?")]
...
#only("4")[#voiceover("Insbesondere sind die Spalten der Matrix die Bilder der Basisvektoren unter der linearen Transformation. Daher definiert die Matrix die Abbildung vollständig.")]
]
...
#v(20pt)
#only("4-")[Daher ist die Matrixdarstellung von $T$:]
#only("4-")[$mat(2, 0; 0, 3)$]
