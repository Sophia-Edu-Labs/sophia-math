...
#v(40pt)
#only("1-")[Betrachte die Dezimalzahl $2.345$]
// Die Frage wird ab Folie 1 angezeigt
#v(40pt)
#only("2-")[$arrow$ Wandle sie in einen Bruch $square/square$ um!]
#only("1")[#voiceover("Lass uns dein Wissen über das Umwandeln von komplexen Dezimalzahlen in Brüche testen. Betrachte die Dezimalzahl zwei Komma drei vier fünf.")]
#only("2")[#voiceover("Kannst du sie in einen Bruch umwandeln, bei dem wir eine Zahl durch eine andere teilen?")]
]

//Typ: FREI 
#questionDef( 
questionText: "Welchem Bruch entspricht $2.345$?", 
answerOptions: ("$\\frac{2345}{1000}$", "Die Antwort ist falsch."),
