...
#slide()[
  #only("1")[
    #voiceover("Ausgezeichnete Arbeit! Du hast sowohl die Produktregel als auch die Kettenregel korrekt angewendet, um diese Funktion zu differenzieren. Lass uns die Lösung Schritt für Schritt durchgehen.")
  ]
