...
plt.show()
  ...
  #only("1")[
    #voiceover("Keine Sorge, das war eine knifflige Frage. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben eine zusammengesetzte Figur, die aus einem Quader mit den Maßen 6 cm mal 4 cm mal 3 cm und einem Würfel mit einer Seitenlänge von 3 cm oben drauf besteht. Unsere Aufgabe ist es, die gesamte Oberfläche zu berechnen.")
  ]
]
