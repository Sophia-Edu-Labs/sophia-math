...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartige Arbeit! Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit der quadratischen Funktion f von x gleich 3x Quadrat plus 2x plus 1 zu tun.")
  ]
  #only("2")[
