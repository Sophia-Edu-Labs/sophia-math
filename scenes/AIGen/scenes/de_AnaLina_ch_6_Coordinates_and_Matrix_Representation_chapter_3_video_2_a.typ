...
#only("1")[#voiceover("Nicht ganz, aber keine Sorge! Sehen wir uns die richtige Lösung an.")]
...
#only("1")[#voiceover("Lassen Sie uns dies Schritt für Schritt lösen. Wir haben eine lineare Abbildung T, definiert durch T von x, y gleich 2x, 3y, und einen Vektor v, der der Spaltenvektor 1, 2 ist.")]
