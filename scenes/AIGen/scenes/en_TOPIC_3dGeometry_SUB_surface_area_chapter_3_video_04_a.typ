...
```
  ...
  #only("1")[
    #voiceover("Great job! You got the correct answer. Let's break down the solution step by step. We're dealing with a cuboid, which is a three-dimensional rectangular shape. In this case, we know its surface area and two of its dimensions. Let's visualize it.")
  ]
]
