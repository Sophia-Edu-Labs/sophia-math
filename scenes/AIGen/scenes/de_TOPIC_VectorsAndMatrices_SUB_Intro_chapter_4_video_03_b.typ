...
#only("1")[
#voiceover("Leider war das nicht korrekt. Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit zwei Matrizen: A und B. Matrix A ist eine 2x2-Matrix mit den Elementen 5, 6, 7 und 8. Matrix B ist ebenfalls eine 2x2-Matrix mit den Elementen 1, 2, 3 und 4.")
]
