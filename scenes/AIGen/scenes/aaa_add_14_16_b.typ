...
#v(40pt)
#only("2-")[Deine Antwort: $2/10$]
#only("1")[
#voiceover("Unsere Aufgabe ist es, ein Viertel plus ein Sechstel zu berechnen.")
]
#only("2")[
#voiceover("Deine Antwort ist zwei Zehntel. Das ist leider nicht ganz richtig.")
]
]
#slide()[
#text(size: 30pt, weight: "bold")[Dein Fehler]
#v(40pt)
#only("1-")[Dein Fehler: $ 1/4 + 1/6 ≠ (1+1)/(4+6) $]
#v(20pt)
#only("2-")[🛠️ Du kannst Zähler und Nenner nicht einfach addieren]
#v(20pt)
#only("3-")[🛠️ Du musst einen gemeinsamen Nenner finden]
#only("1")[
#voiceover("Dein Fehler ist, dass du einfach die Zähler addiert und die Nenner addiert hast. Ein Viertel plus ein Sechstel ist nicht gleich eins plus eins geteilt durch vier plus sechs.")
]
#only("2")[
...
#v(40pt)
#only("1-")[Daher ist $1/4 + 1/6 = 5/12$, nicht $2/10$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beim Addieren von Brüchen, finde zuerst den gemeinsamen Nenner und passe dann die Zähler an!]
#only("1")[
#voiceover("Daher ist ein Viertel plus ein Sechstel gleich fünf Zwölftel, nicht zwei Zehntel.")
]
#only("2")[
