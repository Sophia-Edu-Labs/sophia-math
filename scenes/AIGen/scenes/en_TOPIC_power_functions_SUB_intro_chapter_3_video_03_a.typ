...
#slide()[
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's go through the solution step by step. We're dealing with a power function f of x equals negative two times x cubed.")
  ]
  #only("2")[
