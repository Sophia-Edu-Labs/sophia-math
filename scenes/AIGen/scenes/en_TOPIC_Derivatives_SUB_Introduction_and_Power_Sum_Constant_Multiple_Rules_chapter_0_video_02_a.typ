...
#only("1")[#voiceover("Not quite. Let's review the correct solution and understand why b) The rate of change is the right answer, and why the others are incorrect.")]
