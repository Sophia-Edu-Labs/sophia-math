...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job! You've correctly solved this problem. Let's go through the solution step-by-step to understand how we arrive at the height of 4 cm for this cuboid.")
  ]
]
