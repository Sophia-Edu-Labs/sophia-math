...
plt.show()
  ...
  #only("1")[
    #voiceover("Not quite. Let's go through the correct solution step-by-step. Here's a visualization of our cuboid with length 9 cm, width 5 cm, and height 3 cm.")
  ]
]
