...
```
  ...
  #only("1")[
    #voiceover("Leider war das nicht ganz richtig. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben eine zusammengesetzte Figur, die aus einem Würfel mit einer Kantenlänge von 6 cm und einem kleineren Quader mit den Abmessungen 4 cm x 3 cm x 2 cm besteht, die an einer Fläche verbunden sind. Hier ist eine Visualisierung unserer zusammengesetzten Figur.")
  ]
]
