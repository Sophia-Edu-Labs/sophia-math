...
plt.show()
  ...
  #only("1")[
    #voiceover("Keine Sorge, wir gehen die Lösung Schritt für Schritt durch. Hier ist eine visuelle Darstellung des Quaders, der 10 Meter lang, 4 Meter breit und 3 Meter hoch ist.")
  ]
]
