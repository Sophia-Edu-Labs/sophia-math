...
#only("1")[
#voiceover("Großartig, das ist die richtige Antwort! 🎉 Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben den Druck $p$ mit 1471500 Pascal und die Fläche $A$ des Pumpenkolbens mit 5 Quadratzentimetern gegeben.")
]
#only("2")[
