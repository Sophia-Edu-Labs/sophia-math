...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's go through the solution step-by-step. We have a composite figure consisting of a cuboid with dimensions 10 cm by 6 cm by 4 cm, and a cube with a side length of 3 cm on top. Our task is to find the total surface area.")
  ]
]
