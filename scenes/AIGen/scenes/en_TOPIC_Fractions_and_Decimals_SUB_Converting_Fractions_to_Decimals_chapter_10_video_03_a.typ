...
#slide()[
#only("1")[
#voiceover("Great job on tackling this question! Let's walk through the solution step-by-step, focusing on a method that involves multiplying both the numerator and denominator by 25.")
]
