...
#only("1")[
#voiceover("Lass uns dies mit einem Beispiel veranschaulichen. Betrachte die Folge a_n gleich 1 durch n. Mit zunehmendem n kommen die Glieder der Folge immer näher an 0 heran. Diese Folge konvergiert also gegen 0.")
]
]
]
...
#only("3")[
#voiceover("Für unsere Beispiel-Folge a_n gleich 1 durch n, wenn wir wollen, dass die Glieder innerhalb von epsilon von 0 liegen, können wir N größer als 1 durch epsilon wählen.")
]
]
...
#v(20pt)
#only("3-")[- Hauptidee: Kontrolle der Distanz zwischen $a_n$ und $L$ 🔒]
#only("1")[
...
#only("2")[
#voiceover("Die Epsilon-N-Definition formalisierte dies, indem sie sagt, dass für jedes positive epsilon ein Index N gefunden werden kann, so dass für alle n größer oder gleich N der absolute Unterschied zwischen a_n und L kleiner als epsilon ist.")
]
#only("3")[
#voiceover("Die Hauptidee ist, dass wir kontrollieren können, wie nahe die Glieder der Folge an den Grenzwert herankommen, indem wir einen geeigneten Index N wählen.")
]
]