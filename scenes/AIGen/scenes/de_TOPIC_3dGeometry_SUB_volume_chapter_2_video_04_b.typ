...
plt.show()
  ...
  #only("1")[
    #voiceover("Keine Sorge, das war knapp daneben. Lass uns gemeinsam die Lösung Schritt für Schritt durchgehen, um zu verstehen, wie wir auf 48 Kubikmeter kommen.")
  ]
]
