...
#only("5")[#voiceover("T ist die lineare Abbildung selbst, eine Funktion, die die Struktur des Vektorraums bewahrt.")]
...
#v(20pt)
#only("2-")[Also bezieht sich die Formel auf:]
#v(10pt)
#only("3-")[- Dimension des Definitionsbereichs ($"dim"(V)$) 📏]
#only("4-")[- Dimensionen des Kerns und des Bildes von $T$ 🔗]

#only("1")[#voiceover("Und das Bild von T, bezeichnet als im T, ist die Menge aller Vektoren im Wertebereich, auf die T abbildet.")]
#only("2")[#voiceover("Die Formel besagt also, dass:")]
#only("3")[#voiceover("Die Dimension des Definitionsbereichs V...")]
#only("4")[#voiceover("...die Summe der Dimensionen des Kerns und des Bildes von T ist. Mit anderen Worten, sie stellt die Dimensionen dieser beiden wichtigen Teilräume in Beziehung, die mit der linearen Abbildung verbunden sind.")]
]
...
#only("3")[#voiceover("Das grüne Quadrat stellt das Bild von T dar. Hier landen die Vektoren aus dem Definitionsbereich nach der Abbildung.")]
#only("4")[#voiceover("Und der Pfeil stellt die lineare Abbildung T selbst dar, die zeigt, wie Vektoren vom Definitionsbereich in den Wertebereich transformiert werden.")]
#only("5")[#voiceover("Die Dimensionsformel besagt, dass die Dimension des gesamten Definitionsbereichs V gleich der Summe der Dimensionen dieser beiden Teile ist: des Kerns und des Bildes. Dies ist eine grundlegende Beziehung in der linearen Algebra.")]
]