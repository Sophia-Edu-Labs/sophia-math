...
#only("1")[
#voiceover("Great job! That's the correct notation for the 6th root of 64. The notation for n-th roots is root of n, a, where n is the root and a is the number.")
]
]
