...
#slide()[
  ...
  #only("1")[
    #voiceover("Excellent work on solving this problem! Let's walk through the solution step-by-step. We're given an electric field of 50 volts per meter and the work done on an electron, which is 1.6 times 10 to the negative 18 joules.")
  ]
