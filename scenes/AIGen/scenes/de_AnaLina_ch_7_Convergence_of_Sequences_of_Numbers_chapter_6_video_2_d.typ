...
#v(20pt)
#only("2-")[🎯 Ziel: Zeigen Sie, dass für jedes $M > 0$ ein $N$ existiert, so dass $n^2 > M$ für alle $n >= N$.]
#v(20pt)
...
#only("5")[
#voiceover("Für alle $n$ größer oder gleich $N$ gilt $n$ größer oder gleich der Quadratwurzel von $M$, also ist $n$ Quadrat größer oder gleich $M$.")
]
#only("6")[
#voiceover("Daher divergiert die Folge $a_n$ gleich $n$ Quadrat ins Unendliche. Damit ist der Beweis abgeschlossen.")
]
]
...
#only("4")[
#voiceover("Wie Sie sehen können, ist die Folge $a_n$ für jedes $M$ größer als $M$ für alle $n$ größer oder gleich dem entsprechenden $N$. Dies veranschaulicht die Divergenz ins Unendliche.")
]
]