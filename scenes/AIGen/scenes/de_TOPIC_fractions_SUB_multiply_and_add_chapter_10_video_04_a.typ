...
#slide()[
  #only("1")[
    #voiceover("Großartige Arbeit! Du hast dieses Subtraktionsproblem korrekt gelöst. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, warum $2/4$ oder $1/2$ die richtige Antwort ist.")
  ]
