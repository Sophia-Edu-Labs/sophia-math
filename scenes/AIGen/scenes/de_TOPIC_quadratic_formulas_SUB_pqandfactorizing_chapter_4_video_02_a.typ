...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartig, dass Du diese quadratische Gleichung gelöst hast! Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit der Gleichung x Quadrat minus 5x plus 6 gleich null.")
  ]
  #only("2")[
