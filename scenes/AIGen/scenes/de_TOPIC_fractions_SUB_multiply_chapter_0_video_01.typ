...
#only("4")[
#voiceover("Wenden wir diese Schritte auf unser Pizza-Problem an. Wir haben 3 mal ein Viertel. Wir multiplizieren 3 mit 1, was uns 3 ergibt, und wir behalten den Nenner 4. Also ergibt 3 mal ein Viertel drei Viertel.")
 ]
#only("5")[
#voiceover("Das bedeutet, dass du drei Viertel einer Pizza für deine Freunde brauchst. Ist es nicht erstaunlich, wie uns Brüche helfen können, reale Probleme zu lösen?")
 ]
]
...
#only("1")[
#voiceover("Lass uns visualisieren, was passiert, wenn wir 3 mal 1/4 multiplizieren. Hier haben wir drei Kreise, die jeweils ein Ganzes darstellen. In jedem Kreis haben wir 1/4 oder ein Viertel schattiert.")
]
#only("2")[
#voiceover("Wenn wir 3 mal 1/4 multiplizieren, kombinieren wir im Wesentlichen diese drei Viertel-Teile.")
]
#only("3")[
...
#only("2")[
#voiceover("Wenn wir eine ganze Zahl 'a' mit einem Bruch 'b durch c' multiplizieren, erhalten wir 'a mal b' durch 'c'. Hier ist 'a' eine beliebige ganze Zahl und 'b durch c' ein beliebiger Bruch.")
 ]
#only("3")[
#voiceover("Das Wichtigste ist: Multipliziere die ganze Zahl mit dem Zähler und behalte den Nenner bei. Diese einfache Regel hilft dir, viele Multiplikationsprobleme mit Brüchen zu lösen!")
 ]
]
