...
#only("1")[
#voiceover("Das ist nicht ganz richtig. Schauen wir uns die korrekte Lösung Schritt für Schritt an.")
]
]
...
#only("1")[
#voiceover("Zuerst müssen wir die Basiswechselmatrix finden. Die neue Basis ist gegeben als B gleich die Vektoren eins, eins und eins, minus eins.")
]
#only("2")[
...
#only("2")[
#voiceover("Also müssen wir das Produkt der Inversen der Matrix eins, eins, eins, minus eins, dann der Matrix zwei, null, null, drei und dann wieder der Matrix eins, eins, eins, minus eins berechnen.")
]
]
...
#only("2")[
#voiceover("Zuerst berechnen wir die Inverse der Basiswechselmatrix. Dies ist die Matrix null Komma fünf, null Komma fünf, null Komma fünf, minus null Komma fünf.")
]
#only("3")[
