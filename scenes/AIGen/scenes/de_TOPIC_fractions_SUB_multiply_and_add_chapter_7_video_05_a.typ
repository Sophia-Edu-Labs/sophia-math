...
#slide()[
  #only("1")[
    #voiceover("Großartige Arbeit! Du hast diese Brüche korrekt addiert. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, wie wir zu der Antwort gekommen sind.")
  ]
