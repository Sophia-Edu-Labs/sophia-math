...
#slide()[
  ...
  #only("1")[
    #voiceover("Great job on solving this equation! Let's go through the solution step-by-step. We start with the quadratic equation x squared minus 2x minus 3 equals zero.")
  ]
  #only("2")[
