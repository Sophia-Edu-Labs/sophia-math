...
#only("1")[
#voiceover("Leider ist das nicht korrekt. Lass uns die Lösung Schritt für Schritt durchgehen. Es wird angegeben, dass der Wasserspiegel im Reservoir um 2 Meter sinkt und wir den neuen Druck am Wasserhahn mit der Formel p gleich rho mal g mal h berechnen müssen.")
]
]
