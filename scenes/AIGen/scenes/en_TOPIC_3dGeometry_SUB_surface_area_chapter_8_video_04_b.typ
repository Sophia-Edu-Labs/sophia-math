...
```
  ...
  #only("1")[
    #voiceover("Not quite. Let's go over the correct solution for finding the surface area of this rectangular prism with a cylindrical hole drilled through its center.")
  ]
]
