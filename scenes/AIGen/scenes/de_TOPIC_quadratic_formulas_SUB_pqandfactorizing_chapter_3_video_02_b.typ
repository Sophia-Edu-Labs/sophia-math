...
#slide()[
  ...
  #only("1")[
    #voiceover("Keine Sorge, das war knapp! Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit der quadratischen Gleichung x Quadrat minus 6x plus 9 gleich null.")
  ]
  #only("2")[
