...
#only("1")[
#voiceover("Großartig! Das ist die richtige Antwort. Lass uns Schritt für Schritt sehen, wie wir das lösen können. Wir wissen, dass das Volumen des Würfels 27 Kubikeinheiten beträgt.")
]
#only("2")[
