...
#only("4")[#voiceover("c) gleich epsilon ist auch falsch. Der Unterschied muss nicht genau gleich epsilon sein, sondern kleiner.")]
// Sehr kurz über d sprechen und warum es falsch ist
#only("5")[#voiceover("Und d) ungleich epsilon ist ebenfalls falsch. Der Unterschied kann gleich epsilon sein und dennoch die Definition erfüllen, solange er kleiner als epsilon ist.")]
]
