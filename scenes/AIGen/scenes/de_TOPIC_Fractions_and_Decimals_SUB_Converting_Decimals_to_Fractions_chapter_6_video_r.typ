...
#v(20pt)
#only("3-")[- Schrittweise Dezimalzahlen in Brüche umwandeln. 📏]
#v(20pt)
#only("4-")[- Nützlich, um Berechnungen zu vereinfachen und Zahlen zu verstehen. 🔍]
#only("1")[
#voiceover("Lass uns überprüfen, wie man eine Dezimalzahl, wie null Komma sieben fünf, in einen Bruch umwandelt.")
]
#only("2")[
#voiceover("Wir wollen diese Zahl als Bruch ausdrücken, etwas über etwas.")
]
#only("3")[
...
#only("4")[
#voiceover("Zum Beispiel wird null Komma sieben fünf zu fünfundsiebzig über hundert.")
]
]


#slide()[
#text(size: 30pt, weight: "bold")[Beispiel: $0.75$ in einen Bruch umwandeln]
#v(40pt)
...
#only("1")[
#voiceover("Lass uns ein Beispiel ansehen. Bei null Komma sieben fünf zähle die Dezimalstellen: Es gibt zwei.")
]
#only("2")[
#voiceover("Entferne das Dezimalzeichen, um fünfundsiebzig zu erhalten.")
]
#only("3")[
#voiceover("Dann teile fünfundsiebzig durch hundert, weil es zwei Dezimalstellen gibt. Also, fünfundsiebzig über hundert.")
]
]
