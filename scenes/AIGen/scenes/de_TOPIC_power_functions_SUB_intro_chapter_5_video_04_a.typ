...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartige Arbeit bei der Bewältigung dieser Potenzfunktion! Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben die Funktion f von x gleich 8 geteilt durch x Quadrat.")
  ]
  #only("2")[
