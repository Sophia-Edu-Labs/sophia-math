...
plt.show()
  ...
  #only("1")[
    #voiceover("Not quite, but let's go through the correct solution together. We're dealing with a cube that has a side length of 5.5 centimeters. Here's a visual representation of our cube.")
  ]
]
