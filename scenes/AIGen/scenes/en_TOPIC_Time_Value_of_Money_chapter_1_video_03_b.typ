...
#only("1")[
#voiceover("That's not quite right. Let's go through the correct solution step by step. We are given that the future value is 100 euros, the discount rate is 5%, and the time is 1 year.")
]
#only("2")[
