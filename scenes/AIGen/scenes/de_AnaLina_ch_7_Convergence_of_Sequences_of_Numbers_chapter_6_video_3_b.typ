...
#only("1")[
#voiceover("Keine Sorge, das war ein guter Versuch. Lass uns die Lösung Schritt für Schritt durchgehen, um zu sehen, wie man beweist, dass die Folge a_n gleich n gegen $infinity$ divergiert.")
]
