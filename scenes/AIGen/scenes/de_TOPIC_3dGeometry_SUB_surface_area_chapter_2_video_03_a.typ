...
plt.show()
  ...
  #only("1")[
    #voiceover("Großartige Arbeit bei der Lösung dieses Problems! Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit einem Quader zu tun, der eine Länge von 5 Zentimetern, eine Breite von 3 Zentimetern und eine Höhe von 4 Zentimetern hat. Hier ist eine visuelle Darstellung unseres Quaders.")
  ]
]
