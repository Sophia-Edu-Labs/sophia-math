...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartig! Du hast dieses Vektoradditionsproblem korrekt gelöst. Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit zwei Vektoren: Vektor a, der (3, 4) ist, und Vektor b, der (1, 2) ist.")
  ]
