...
#slide()[
  ...
  #only("1")[
    #voiceover("Not quite, but let's go over the correct solution step-by-step. We're dealing with a cubic function f of x equals 2x cubed plus 3x squared plus x plus 1.")
  ]
  #only("2")[
