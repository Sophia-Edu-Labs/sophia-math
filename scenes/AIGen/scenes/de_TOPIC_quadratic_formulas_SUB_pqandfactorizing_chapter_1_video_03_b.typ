...
#slide()[
  ...
  #only("1")[
    #voiceover("Das war leider nicht korrekt. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit der quadratischen Gleichung x Quadrat plus 6x plus 9 gleich null zu tun.")
  ]
  #only("2")[
