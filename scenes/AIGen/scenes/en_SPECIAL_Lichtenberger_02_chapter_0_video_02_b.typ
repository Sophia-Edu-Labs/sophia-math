...
#only("1")[
#voiceover("Don't worry about the incorrect answer. Let's go through the correct solution step by step. We need to lift a ship engine with a mass of 6000 kg by a height of 2.0 meters using a hydraulic lift.")
]
#only("2")[
