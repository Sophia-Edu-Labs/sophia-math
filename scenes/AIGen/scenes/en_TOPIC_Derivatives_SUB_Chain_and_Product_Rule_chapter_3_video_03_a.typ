...
#slide()[
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's go through the solution step-by-step. We start with the function f of x equals five x plus one, all cubed.")
  ]
