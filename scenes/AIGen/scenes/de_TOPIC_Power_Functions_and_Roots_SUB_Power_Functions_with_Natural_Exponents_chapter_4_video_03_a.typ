...
#only("1")[
#voiceover("Großartig! Das ist das richtige Verhalten. Lass uns sehen, warum. Wir betrachten die Funktion f von x gleich x hoch 7 und wollen wissen, was passiert, wenn x gegen Null geht.")
]
#only("2")[
