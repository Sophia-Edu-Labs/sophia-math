...
plt.show()
  ...
  #only("1")[
    #voiceover("Keine Sorge, das war nicht ganz richtig. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit der Potenzfunktion f von x gleich 10 geteilt durch x zu tun. Unsere Aufgabe ist es, f von 2 zu finden.")
  ]
]
