...
#v(20pt)
#only("4-")[#text()[- Gemeinsamer Nenner: $times.square/24$]]
#only("1")[
...
#only("3")[
#voiceover("und zwar auf Vierundzwanzigstel.")
]
]
...
# Ersten Bruch 1/6 auf der Zahlenlinie plotten
visualize_fraction(axs[0], 1, 6, 'red', '1/6')
# Zweiten Bruch 4/24 auf der Zahlenlinie plotten
...
# Ersten Bruch 3/4 auf der Zahlenlinie plotten
visualize_fraction(axs[0], 3, 4, 'red', '3/4')
# Zweiten Bruch 18/24 auf der Zahlenlinie plotten
...
#only("2")[
#voiceover("Aus ein Sechstel werden vier Vierundzwanzigstel. Wir haben also sowohl den Zähler als auch den Nenner mit vier multipliziert. Und wie du siehst, bleibt der Wert gleich.")
]
#only("3")[
...
# Ersten Bruch 4/24 auf der Zahlenlinie plotten
visualize_fraction(axs[0], 4, 24, 'red', '4/24')
# Zweiten Bruch 18/24 auf der Zahlenlinie plotten
visualize_fraction(axs[1], 18, 24, 'blue', '18/24')
...
# Summe der Brüche 4/24 + 18/24 auf der Zahlenlinie plotten
visualize_fraction(ax, 22, 24, 'green', '4/24 + 18/24 = 22/24')
