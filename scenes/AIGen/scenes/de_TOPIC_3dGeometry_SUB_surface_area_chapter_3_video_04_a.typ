...
```
  ...
  #only("1")[
    #voiceover("Großartig! Du hast die richtige Antwort gefunden. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit einem Quader zu tun, einer dreidimensionalen rechteckigen Form. In diesem Fall kennen wir die Oberfläche und zwei seiner Dimensionen. Lass es uns visualisieren.")
  ]
]
