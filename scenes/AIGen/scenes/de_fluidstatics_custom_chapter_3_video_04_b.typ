...
#only("1")[
#voiceover("Leider ist das nicht korrekt. Lass uns die Lösung Schritt für Schritt durchgehen. Gegeben ist, dass der Höhenunterschied zwischen Kopf und Herz 50 Zentimeter beträgt, was 0,5 Metern entspricht, und die Blutdichte beträgt 1060 Kilogramm pro Kubikmeter.")
]
#only("2")[
