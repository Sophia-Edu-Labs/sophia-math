...
#only("1")[#voiceover("Leider ist das nicht korrekt. Lass uns jede Option durchgehen, um zu verstehen, warum b die richtige Antwort ist und warum die anderen falsch sind.")]
