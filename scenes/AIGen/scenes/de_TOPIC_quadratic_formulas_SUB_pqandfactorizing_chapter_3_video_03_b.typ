...
#slide()[
  ...
  #only("1")[
    #voiceover("Keine Sorge, lass uns die Lösung der quadratischen Gleichung gemeinsam durchgehen. Zuerst erinnern wir uns daran, dass eine quadratische Gleichung die allgemeine Form a x Quadrat plus b x plus c gleich null hat.")
  ]
  #only("2")[
