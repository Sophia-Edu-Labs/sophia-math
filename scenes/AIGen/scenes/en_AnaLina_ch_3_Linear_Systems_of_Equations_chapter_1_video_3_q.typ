...
answerOptions: ("The matrix equation is $\\begin{pmatrix} 1 & 1 \\\\ 2 & -1 \\end{pmatrix} \\begin{pmatrix} x \\\\ y \\end{pmatrix} = \\begin{pmatrix} 2 \\\\ 3 \\end{pmatrix}$, or an equivalent statement.", "The answer is incorrect."),
