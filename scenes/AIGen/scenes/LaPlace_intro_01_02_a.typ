...
#v(40pt)
#only("1")[
#voiceover("Super, das ist richtig. Um die Wahrscheinlichkeit zu berechnen, beim einmaligen Ziehen eine Kugel mit einer durch 3 teilbaren Nummer zu ziehen, wenden wir die Laplace-Formel an.")
]
#only("1-")[
$ P(E) = ✔/📊 $
]
