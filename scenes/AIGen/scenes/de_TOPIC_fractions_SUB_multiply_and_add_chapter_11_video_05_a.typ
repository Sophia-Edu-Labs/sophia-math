...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartig! Du hast dieses Bruchsubtraktionsproblem korrekt gelöst. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, warum $4/7$ tatsächlich die richtige Antwort ist.")
  ]
