...
#only("1")[
#voiceover("Great job! That's the correct answer. Let's look at the solution step by step. We are given that the floating house weighs 50 tons or 50,000 kilograms, and it displaces 50 cubic meters of water. The draft, which is the depth of the platform below the water, is 0.5 meters.")
]
#only("2")[
