...
plt.show()
  ...
  #only("1")[
    #voiceover("Leider war das nicht ganz richtig. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit einem Würfel zu tun, der eine Seitenlänge von 4 Zentimetern hat. Hier ist eine Visualisierung unseres Würfels.")
  ]
]
