...
#v(40pt)
// Von Anfang bis Abschnitt eins ist die Option schwarz. Ab Abschnitt 2 wird sie dann rot, weil sie falsch ist.
...
#v(10pt)
// Von Anfang bis Abschnitt drei ist die Option schwarz. Ab Abschnitt 4 wird sie dann grün, weil sie richtig ist.
...
#only("2")[
#voiceover("Das bedeutet, sie müssen linear unabhängig sein und den Raum aufspannen, genau wie die ursprünglichen Basisvektoren.")
]
#only("3")[
