...
#slide()[
  ...
  #only("1")[
    #voiceover("Great job! That's the correct answer. Let's walk through the solution step by step. We start with the given function f of x equals 4 times x to the fourth power.")
  ]
