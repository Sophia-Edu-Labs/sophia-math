...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job! You've correctly calculated the surface area of the cube. Let's go through the solution step by step. Here we have a cube with a side length of 9 centimeters.")
  ]
]
...
#slide()[
  ...
  #only("2")[
    #voiceover("So we substitute 9 centimeters for s in our formula. This gives us: Surface Area equals 6 times 9 centimeters squared.")
  ]
]
...
#slide()[
  ...
  #only("3-")[- $"SA" = 486"cm"^2$]
  #only("1")[
    #voiceover("Now let's calculate. First, we square 9 centimeters.")
  ]
  #only("2")[
    #voiceover("9 centimeters squared is 81 square centimeters. So our equation becomes 6 times 81 square centimeters.")
  ]
  #only("3")[
    #voiceover("Finally, we multiply by 6. 6 times 81 is 486. So the surface area is 486 square centimeters.")
  ]
]
...
#slide()[
  ...
  #v(40pt)
  #only("1-")[#text(size: 24pt)[The surface area of the cube is $486"cm"^2$]]
  #v(40pt)
  #only("2-")[💡 Remember: Units are important!]
  #only("1")[
    #voiceover("So our final answer is that the surface area of the cube is 486 square centimeters.")
  ]
  #only("2")[
