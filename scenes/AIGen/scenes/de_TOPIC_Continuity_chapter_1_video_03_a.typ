...
#only("1")[
#voiceover("Großartig! Das ist die richtige Antwort. Lass uns Schritt für Schritt sehen, wie wir das lösen können. Wir müssen den linken Grenzwert der Funktion f von x gleich x Quadrat bestimmen, wenn x sich 2 nähert.")
]
#only("2")[
