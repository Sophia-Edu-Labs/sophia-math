...
#slide()[
  #only("1")[
    #voiceover("Großartige Arbeit! Du hast die Ableitung korrekt gefunden. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, wie wir zu diesem Ergebnis gekommen sind.")
  ]
