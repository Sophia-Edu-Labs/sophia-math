...
#slide()[
  ...
  #only("1")[
    #voiceover("Das war leider nicht korrekt. Lass uns gemeinsam durch die Lösung gehen, um zu verstehen, wie wir ein Halb in einen äquivalenten Bruch mit einem Nenner von 4 umwandeln.")
  ]
