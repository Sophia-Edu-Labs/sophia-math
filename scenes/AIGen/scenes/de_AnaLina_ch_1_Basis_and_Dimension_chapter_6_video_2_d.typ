...
#only("3")[#voiceover("Jetzt tauchen wir in die Erklärung ein, um das besser zu verstehen.")]
]
...
#v(20pt)
#only("2-")[- Neue Basisvektoren werden zu Spalten]
#v(40pt)
...
#only("4")[#voiceover("Die Basiswechselmatrix, bezeichnet als P unter B, wäre dann die Matrix mit diesen Vektoren als Spalten.")]
]
...
#v(20pt)
#only("4-")[- Drückt Vektor als Linearkombination von Basisvektoren aus]
...
#only("3")[#voiceover("In unserem Beispiel würde die Multiplikation von P unter B mit einem Vektor (x; y) x mal den ersten Spaltenvektor plus y mal den zweiten Spaltenvektor ergeben.")]
...
#only("4")[#voiceover("Fantastische Arbeit beim Erfassen dieses wichtigen Konzepts! Mach weiter so.")]
]