...
questionText: "What is the result of adding the matrices $ A = \begin{pmatrix} 1 & 2 \\\\ 3 & 4 \end{pmatrix} $ and $ B = \begin{pmatrix} 5 & 6 \\\\ 7 & 8 \end{pmatrix} $?",
answerOptions: ("The result is $ \begin{pmatrix} 6 & 8 \\\\ 10 & 12 \end{pmatrix} $, or an equivalent statement.", "The answer is incorrect."),
