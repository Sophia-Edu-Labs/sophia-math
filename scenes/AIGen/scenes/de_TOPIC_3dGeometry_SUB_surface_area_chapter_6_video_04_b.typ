...
plt.show()
  ...
  #only("1")[
    #voiceover("Keine Sorge, das war nicht ganz richtig. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben ein rechteckiges Prisma mit den Maßen 8 cm mal 6 cm mal 4 cm und ein zylindrisches Loch mit einem Radius von 1 cm und einer Höhe von 4 cm, das durch dessen Zentrum gebohrt wurde. Hier ist eine Visualisierung unserer zusammengesetzten Figur.")
  ]
]
