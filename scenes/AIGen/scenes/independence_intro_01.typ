...
#v(20pt)
#only("3-")[- #text(weight: "bold")[Formal:] $ P(A sect B) = P(A) dot P(B) $]
#only("1")[
...
$ 0.25 != 0.15 $]
#v(20pt)
#only("6-")[$->$ $A$ und $B$ #text(weight: "bold")[nicht] unabhängig]
#only("1")[
#voiceover("Betrachten wir ein konkretes Beispiel: Auf einer Party mögen 50% der Gäste Bier, das ist unser Ereignis A. ")
]
#only("2")[
#voiceover("30% der Gäste spielen gerne Bier-Pong, das ist Ereignis B")
]
#only("3")[
#voiceover("Wir wissen außerdem, dass 25 Prozent der Gäste sowohl gerne Bier mögen als auch gerne Bier-Pong spielen. Jetzt wollen wir wissen: Sind die Ereignisse A und B unabhängig? Oder in anderen Worten: Hat es einen Einfluss darauf, ob jemand gerne Bier-Pong spielt, ob er oder sie auch gerne Bier mag, und umgekehrt? Um das Herauszufinden,")
]
#only("4")[
...
#only("6")[
#voiceover("Somit sind die Ereignisse A und B in diesem Beispiel nicht unabhängig. Konkret bedeutet das, dass die Wahrscheinlichkeit, dass jemand gerne Bier-Pong spielt, höher ist, wenn er oder sie auch gerne Bier mag, und umgekehrt. Das leuchtet ein, oder?")
]
]