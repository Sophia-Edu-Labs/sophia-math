...
#slide()[
  ...
  #only("1")[
    #voiceover("Keine Sorge, wir gehen die Lösung gemeinsam durch. Lass uns die quadratische Gleichung x Quadrat minus 7x plus 12 gleich null durch Faktorisierung lösen.")
  ]
  #only("2")[
