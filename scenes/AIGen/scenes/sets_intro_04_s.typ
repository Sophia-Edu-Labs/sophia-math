...
#slide()[
  #only("1")[
    #voiceover("Nochmal im Überblick: Mächtigkeit von Mengen.")
  ]
#text(size: 30pt, weight: "bold")[Mächtigkeit]
  #v(40pt)

#only("2")[
  #voiceover("Die Mächtigkeit von Mengen ist eine Zahl, die Mengen beschreibt. Die Mächtigkeit einer Menge gibt an, wie viele Elemente in der Menge enthalten sind.")
  ]
