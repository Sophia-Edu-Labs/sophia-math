...
#only("1")[
#voiceover("Großartig! Das ist die richtige Antwort. Schauen wir uns an, wie wir den Druck in einer Tiefe von 1000 Metern im Meerwasser berechnen können. Der Druck hängt von der Tiefe, der Dichte der Flüssigkeit und der Beschleunigung durch die Schwerkraft ab.")
]
#only("2")[
