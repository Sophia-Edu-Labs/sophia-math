...
plt.show()
  ...
  #only("1")[
    #voiceover("Keine Sorge, das war ein schwieriges Problem. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben einen Quader mit einer Oberfläche von 400 Quadratzentimetern, einer Länge von 16 Zentimetern und einer Breite von 10 Zentimetern. Wir müssen seine Höhe finden.")
  ]
]
