...
#only("1")[
#voiceover("Great job! That's the correct answer. Let's go through the solution step by step. We are given two sequences: a sub n equals 1 over n, and b sub n equals 2 over n.")
]
#only("2")[
