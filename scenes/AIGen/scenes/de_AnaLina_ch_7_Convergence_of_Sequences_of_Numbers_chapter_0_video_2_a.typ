...
#only("3")[#voiceover("Zum Beispiel, betrachten Sie die Sequenz 1, 2, 3, 4 und so weiter. Jeder Term in dieser Sequenz entspricht seiner Position. Wir können dies als a_n = n schreiben.")]
...
#only("5")[#voiceover("Also, die richtige Antwort ist b) Eine geordnete Liste von Zahlen. Gut gemacht, dass Sie die richtige Option gewählt haben!")]
]