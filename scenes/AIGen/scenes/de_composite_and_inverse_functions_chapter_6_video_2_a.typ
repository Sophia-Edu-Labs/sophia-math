...
#v(40pt)
Wenn $f(x)$ und $g(x)$ Umkehrfunktionen sind, was ist über ihre Definitions- und Wertebereiche wahr?
#v(40pt)
...
#only("3")[#voiceover("Option b ist korrekt. Wenn zwei Funktionen Umkehrfunktionen voneinander sind, sind ihre Definitions- und Wertebereiche tatsächlich vertauscht.")]
#only("4")[#voiceover("Option c ist falsch. Komplementäre Mengen sind zwei Mengen, deren Vereinigung die universelle Menge ergibt. Dies ist nicht die Beziehung zwischen den Definitions- und Wertebereichen von Umkehrfunktionen.")]
...
#v(40pt)
#only("2-")[Schritt 3: Schließen Sie daraus, dass Definitions- und Wertebereiche vertauscht sind ✅]
#v(20pt)
...
#only("4")[#voiceover("Beachten Sie, wie der Definitionsbereich von f dem Wertebereich von g entspricht und der Wertebereich von f dem Definitionsbereich von g. Dies ist genau das, was wir für Umkehrfunktionen erwarten.")]
]
