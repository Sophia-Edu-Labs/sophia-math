...
#slide()[
  ...
  #only("2")[
    #voiceover("Consider the quadratic equation: x squared minus four x plus four equals zero.")
  ]

  #only("3")[
    #voiceover("Your task is to solve this equation by factorizing. Remember, factorizing involves finding the factors that, when multiplied together, give us our quadratic expression.")
  ]
]
