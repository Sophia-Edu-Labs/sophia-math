...
#only("1")[
#voiceover("Hier siehst du die Brüche mit ihren ursprünglichen Nennern. Oben haben wir ein Sechstel und unten drei Viertel.")
]
#only("2")[
#voiceover("Diese Brüche haben verschiedene Nenner, also teilen wir sie in Stücke verschiedener Größe ein: Oben haben wir Sechstel und unten Viertel. Das bedeutet, dass wir sie nicht direkt addieren können.")
]
#only("3")[
...
# Summe der Brüche 2/12 und 9/12 plotten
visualize_fraction(ax, 11, 12, 'purple', '2/12 + 9/12 = 11/12')
