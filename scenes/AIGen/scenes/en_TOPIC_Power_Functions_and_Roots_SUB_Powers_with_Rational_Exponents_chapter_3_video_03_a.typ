...
#only("4-")[- $= 3 root(3,3)$]
#only("1")[
#voiceover("That's right, great job! Let's see how we can simplify the expression 5 times the cube root of 3 minus 2 times the cube root of 3 step by step.")
]
#only("2")[
