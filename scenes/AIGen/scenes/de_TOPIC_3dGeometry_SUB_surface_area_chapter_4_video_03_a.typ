...
plt.show()
  ...
  #only("1")[
    #voiceover("Großartig! Du hast dieses Problem korrekt gelöst. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, wie wir auf die Höhe von 4 cm für diesen Quader kommen.")
  ]
]
