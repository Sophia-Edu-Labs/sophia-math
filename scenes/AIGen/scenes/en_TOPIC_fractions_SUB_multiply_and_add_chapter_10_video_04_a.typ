...
#slide()[
  #only("1")[
    #voiceover("Great job! You've correctly solved this subtraction problem. Let's go through the solution step-by-step to understand why 2/4 or 1/2 is the correct answer.")
  ]
