...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's go through the solution step by step. We have a cube with a side length of 5.5 centimeters. Here's a visualization of our cube.")
  ]
]
