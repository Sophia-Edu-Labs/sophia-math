...
#slide()[
  #only("1")[
    #voiceover("Great job! You've correctly identified the solution. Let's walk through the steps together to understand why 5/8 + 2/8 = 7/8 is the correct answer.")
  ]
