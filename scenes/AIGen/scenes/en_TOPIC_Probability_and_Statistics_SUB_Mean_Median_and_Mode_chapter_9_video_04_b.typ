...
#only("1")[
#voiceover("Nice try, but the answer was incorrect. Let's go over the correct solution step-by-step. The mode is the value that appears most frequently in a data set.")
]
#only("2")[
