...
#slide()[
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's go through the solution step-by-step. We start with the quadratic equation x squared minus 6x plus 9 equals zero.")
  ]
  #only("2")[
