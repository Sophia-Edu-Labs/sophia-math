...
#only("1")[
#voiceover("Großartige Arbeit! Das ist korrekt. Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit unserer Funktion f von x gleich x hoch drei plus x quadrat.")
]
