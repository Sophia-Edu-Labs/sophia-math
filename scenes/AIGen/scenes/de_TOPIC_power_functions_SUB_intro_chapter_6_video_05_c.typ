...
#only("1")[#voiceover("Leider ist das nicht korrekt. Lass uns gemeinsam herausfinden, warum der Flächeninhalt eines Kreises eine Anwendung von Potenzfunktionen ist und warum die anderen Optionen nicht stimmen.")]
