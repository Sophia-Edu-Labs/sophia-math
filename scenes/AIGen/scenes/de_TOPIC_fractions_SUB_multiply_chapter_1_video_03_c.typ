...
#v(40pt)
#only("1-")[- Übung: Multipliziere $3/4$ mit $4/5$.]
#v(20pt)
#only("2-")[- Option a) $7/9$]
#v(20pt)
...
#only("1")[#voiceover("Gut gemacht, dass Du die Frage richtig beantwortet hast! Lass uns die Lösung Schritt für Schritt durchgehen.")]
#only("2")[#voiceover("Option a) 7/9 ist falsch. Beim Multiplizieren von Brüchen multiplizieren wir die Zähler und die Nenner separat. Hier, 3 mal 4 = 12 und 4 mal 5 = 20, also ist 7/9 nicht die richtige Antwort.")]
#only("3")[#voiceover("Option b) 10/12 ist auch falsch. Wieder multiplizieren wir die Zähler und Nenner, was uns 12/20 ergibt, nicht 10/12.")]
#only("4")[#voiceover("Option c) 12/20 ist richtig. Das Multiplizieren der Zähler 3 mal 4 ergibt 12, und das Multiplizieren der Nenner 4 mal 5 ergibt 20. Also ergibt 3/4 mal 4/5 gleich 12/20.")]
...
#only("3")[#voiceover("Der ggT von 12 und 20 ist 4. Das bedeutet, 4 ist die größte Zahl, die sowohl 12 als auch 20 ohne Rest teilt.")]
