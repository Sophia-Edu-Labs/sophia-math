...
#v(40pt)
#only("1-")[- $2/3$ * $3/4$ * $4/5$]
#only("1")[#voiceover("Great job on getting the correct answer! Let's go through the solution step-by-step. We need to multiply the fractions two thirds, three fourths, and four fifths.")]
#v(20pt)
