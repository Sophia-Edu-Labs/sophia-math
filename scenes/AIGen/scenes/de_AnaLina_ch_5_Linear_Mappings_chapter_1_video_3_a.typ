...
#v(40pt)
#only("1-")[Das ist die richtige Antwort! Schauen wir uns Schritt für Schritt an, wie wir zu dieser Lösung kommen.]
#only("1")[
#voiceover("Großartige Arbeit! Das ist absolut richtig. Lassen Sie uns nun die Lösung Schritt für Schritt durchgehen, um zu sehen, wie wir zu dieser Antwort kommen.")
]
]
