...
#slide()[
  ...
  #only("2")[
    #voiceover("Your task is to solve the equation x squared minus 9x plus 14 equals zero by factorizing. Give it a try!")
  ]
]

//Type: Numeric
#questionDef(
questionText: "Solve the quadratic equation $x^2 - 9x + 14 = 0$ by factorizing.", 
