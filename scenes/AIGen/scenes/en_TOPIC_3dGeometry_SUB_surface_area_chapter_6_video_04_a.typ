...
plt.show()
  ...
  #only("1")[
    #voiceover("Excellent work! You've correctly calculated the surface area. Let's walk through the solution step by step. We have a rectangular prism with dimensions 8 cm by 6 cm by 4 cm, and a cylindrical hole with a radius of 1 cm and height of 4 cm drilled through its center. Here's a visualization of our composite figure.")
  ]
]
