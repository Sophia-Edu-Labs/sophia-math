...
#only("-1")[$ |A|=? $]#only("2-")[$ |A|=4 $]
#only("1")[
  #voiceover("Das ist nicht ganz richtig. Um die Mächtigkeit einer Menge zu bestimmen, zählen wir einfach die Anzahl der Elemente. In diesem Fall sind a, c, d und f die Elemente der Menge A.")
]
#only("2")[
