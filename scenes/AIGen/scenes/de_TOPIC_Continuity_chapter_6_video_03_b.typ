...
#only("1")[
#voiceover("Leider ist das nicht korrekt. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben zwei Funktionen gegeben: f von x ist gleich x Quadrat und g von x ist gleich 2x.")
]
#only("2")[
