...
#v(40pt)
#only("1")[
#voiceover("Das war leider nicht richtig. Um die Wahrscheinlichkeit zu berechnen, bei einmaligem Würfeln eine 1 oder eine 6 zu würfeln, wenden wir die Laplace-Formel an.")
]
#only("1-")[
$ P(E) = ✔/📊 $
]
