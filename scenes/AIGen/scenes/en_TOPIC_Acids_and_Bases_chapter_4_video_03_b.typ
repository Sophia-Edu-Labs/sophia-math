...
#only("1-")[- pH + pOH = 14]
#only("1")[
#voiceover("That's not quite right. Let's review the correct solution step by step. We know that pH and pOH are related by the equation pH plus pOH equals 14.")
]
]
