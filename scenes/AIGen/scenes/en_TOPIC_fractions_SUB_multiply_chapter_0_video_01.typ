...
#slide()[
#text(size: 30pt, weight: "bold")[Multiplying Fractions: Whole Number $dot$ Fraction]
#v(40pt)
#only("1-")[
#align(center)[
...
#only("5-")[
#align(center)[
#text(size: 24pt)[3/4 of a pizza 🍕🍕🍕]
 ]
 ]
#only("1")[
#voiceover("Welcome to our lesson on multiplying fractions! Imagine you're planning a pizza party and need to figure out how much pizza you'll have.")
 ]
#only("2")[
#voiceover("Let's say you want to give each of your 3 friends one-fourth of a pizza. How much pizza is that in total? We can express this mathematically as 3 times one-fourth.")
 ]
#only("3")[
...
#only("4")[
#voiceover("Let's apply these steps to our pizza problem. We have 3 times one-fourth. We multiply 3 by 1, which gives us 3, and we keep the denominator 4. So, 3 times one-fourth equals three-fourths.")
 ]
#only("5")[
#voiceover("This means you'll need three-fourths of a pizza for your friends. Isn't it amazing how fractions can help us solve real-life problems?")
 ]
]

#slide()[
#text(size: 30pt, weight: "bold")[Visualizing Multiplication: 3 $dot$ 1/4]
#v(40pt)
#only("1-")[
#box()[
#figure(
...
#only("1")[
#voiceover("Let's visualize what happens when we multiply 3 by 1/4. Here we have three circles, each representing one whole. In each circle, we've shaded 1/4 or one-quarter.")
]
#only("2")[
#voiceover("When we multiply 3 by 1/4, we're essentially combining these three quarter-portions.")
]
#only("3")[
#voiceover("The result is shown in this single circle. As you can see, when we combine three one-quarter portions, we end up with three-quarters of a whole, or 3/4. This visual representation helps us understand why 3 times 1/4 equals 3/4.")
]
]
