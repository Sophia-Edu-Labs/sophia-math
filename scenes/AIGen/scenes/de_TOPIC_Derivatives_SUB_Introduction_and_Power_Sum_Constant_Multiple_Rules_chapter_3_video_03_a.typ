...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartige Arbeit bei der Lösung dieses Problems! Lass uns die Lösung Schritt für Schritt durchgehen. Gegeben ist die Funktion f von x gleich 7 mal x hoch 3.")
  ]
