...
#v(40pt)
#only("1-")[1. Erinnern Sie sich an die Definition einer Basis 📚]
#v(20pt)
#only("2-")[   - Ein Satz von linear unabhängigen Vektoren, die einen Raum aufspannen]
#v(40pt)
#only("3-")[2. Verstehen Sie, was Basiswechsel bedeutet 🔄]
#v(20pt)
#only("4-")[   - Finden eines neuen Satzes von Basisvektoren für denselben Raum]
#v(40pt)
#only("1")[
#voiceover("Lassen Sie uns dies Schritt für Schritt durchgehen.")
]
#only("2")[
#voiceover("Erstens, erinnern Sie sich daran, dass eine Basis ein Satz von linear unabhängigen Vektoren ist, die einen Raum aufspannen.")
]
#only("3")[
#voiceover("Als nächstes verstehen Sie, dass Basiswechsel bedeutet, einen neuen Satz von Basisvektoren für denselben Raum zu finden.")
]
#only("4")[
#voiceover("Mit anderen Worten, wir suchen nach einem anderen Satz von Vektoren, die denselben Raum wie die ursprüngliche Basis aufspannen.")
]
]
...
#text(size: 30pt, weight: "bold")[Schritt-für-Schritt-Lösung]
#v(40pt)
#only("1-")[1. Identifizieren Sie die Schlüsselcharakteristik der neuen Vektoren 🔑]
#v(20pt)
...
#only("1")[
#voiceover("Die Schlüsselcharakteristik dieser neuen Vektoren ist, dass sie ebenfalls eine Basis bilden müssen.")
]
#only("2")[
