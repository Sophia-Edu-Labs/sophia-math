...
#only("1")[
#voiceover("Great job on tackling this problem! Let's walk through the solution step-by-step. We're dealing with the quadratic equation x squared minus 4x plus 4 equals zero.")
]
