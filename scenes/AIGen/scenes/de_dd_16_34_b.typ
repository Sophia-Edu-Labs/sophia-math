...
#v(20pt)
#only("4-")[#text()[- Gemeinsamer Nenner: $24$]]
#only("1")[
...
#only("3")[
#voiceover("Der gemeinsame Nenner ist vierundzwanzig, wie du schon richtig erkannt hast.")
]
]
...
#first subplot: 1/6 to 4/24
visualize_fraction(axs[0], 1, 6, 'red', '1/6')
visualize_fraction(axs[1], 4, 24, 'blue', '4/24')
...
#second subplot: 3/4 to 18/24
visualize_fraction(axs[0], 3, 4, 'red', '3/4')
visualize_fraction(axs[1], 18, 24, 'blue', '18/24')
...
#v(20pt)
#only("2-")[#text()[- $1/6 = 4/24$]]
#v(20pt)
#only("3-")[#text()[- $3/4 = 18/24$]]
#only("1")[
#voiceover("Wir müssen nur aufpassen, dass wir auch die Zähler anpassen, wenn wir die Nenner verändern.")
]
#only("2")[
#voiceover("Aus ein Sechstel werden dann vier Vierundzwanzigstel. Wir haben also sowohl den Zähler, als auch den Nenner mit vier multipliziert. Und wie du siehst bleibt dann der Wert gleich.")
]
#only("3")[
#voiceover("Und aus drei Viertel werden achtzehn Vierundzwanzigstel. Auch hier haben wir sowohl den Zähler, als auch den Nenner mit dem selben Wert multipliziert. Und auch hier bleibt der Wert gleich.")
]
]
...
fig, axs = plt.subplots(2, 1, figsize=(8, 6))
#first plot the fraction 4/24, which is equivalent to the fraction 1/6
visualize_fraction(axs[0], 4, 24, 'blue', '4/24')
#then plot the fraction 18/24, which is equivalent to the fraction 3/4
visualize_fraction(axs[1], 18, 24, 'red', '18/24')
...
visualize_fraction(ax, 22, 24, 'purple', '4/24 + 18/24 = 22/24')
...
#only("2")[
#voiceover("Vier Vierundzwanzigstel plus achtzehn Vierundzwanzigstel ist also gleich zweiundzwanzig Vierundzwanzigstel. Und das ist das korrekte Ergebnis.")
]
]