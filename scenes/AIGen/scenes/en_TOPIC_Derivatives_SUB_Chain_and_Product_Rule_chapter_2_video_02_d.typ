...
#only("1")[#voiceover("Not quite. Let's go over the correct solution and see why we need both the chain rule and the product rule to differentiate this function.")]
