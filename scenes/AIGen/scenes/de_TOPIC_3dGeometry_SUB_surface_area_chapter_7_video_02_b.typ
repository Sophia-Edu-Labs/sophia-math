...
plt.show()
  ...
  #only("1")[
    #voiceover("Leider ist das nicht ganz richtig. Lass uns die Lösung gemeinsam Schritt für Schritt durchgehen. Wir haben es mit einem Würfel zu tun, der eine Seitenlänge von 8 Zentimetern hat. Hier ist eine visuelle Darstellung unseres Würfels.")
  ]
]
