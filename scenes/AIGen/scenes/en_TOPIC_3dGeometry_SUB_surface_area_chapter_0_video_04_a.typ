...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job! You've correctly calculated the surface area of the cube. Let's go through the solution step-by-step. We have a cube with a side length of 7 meters. Here's a visualization of our cube.")
  ]
]
...
#slide()[
  ...
  #only("3-")[- $"SA" = 294"m"^2$]
  #only("1")[
    #voiceover("Now let's calculate. First, we square 7 meters.")
  ]
  #only("2")[
    #voiceover("7 meters squared is 49 square meters. So our equation becomes 6 times 49 square meters.")
  ]
  #only("3")[
    #voiceover("Finally, we multiply by 6. 6 times 49 is 294. So the surface area is 294 square meters.")
  ]
]
...
#slide()[
  ...
  #v(40pt)
  #only("1-")[#text(size: 24pt)[The surface area of the cube is $294"m"^2$]]
  #v(40pt)
