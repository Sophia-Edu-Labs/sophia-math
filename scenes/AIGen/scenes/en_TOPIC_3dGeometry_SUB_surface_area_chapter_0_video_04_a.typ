...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's walk through the solution step-by-step. We have a cube with a side length of 7 meters. Here's a visualization of our cube.")
  ]
]
