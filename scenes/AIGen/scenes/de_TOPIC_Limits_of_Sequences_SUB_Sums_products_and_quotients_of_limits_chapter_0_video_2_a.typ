...
#v(10pt)
// Von Anfang bis Abschnitt zwei ist die Option schwarz. Ab Abschnitt 3 bis zum Ende wird sie grün, weil sie richtig ist.
...
#only("2")[#voiceover("b) 0. Schauen wir uns an, warum...")]
]

#slide()[
#text(size: 30pt, weight: "bold")[Schritt-für-Schritt Lösung]
#v(40pt)
#only("1-")[Betrachten wir die Folge $a_n = 1/n$ 🔢]
#v(20pt)
...
#v(20pt)
#only("5-")[Daher, $lim_(n->∞) 1/n = 0$ ✅]

#only("1")[#voiceover("Gegeben ist die Folge a sub n gleich 1 durch n.")]
#only("2")[#voiceover("Wenn n steigt, sinkt der Wert von 1 durch n. Das liegt daran, dass der Bruch kleiner wird, je größer der Nenner wird.")]
#only("3")[#voiceover("Zum Beispiel, 1 durch 1 ist 1, 1 durch 10 ist 0.1, 1 durch 100 ist 0.01, und so weiter.")]
#only("4")[#voiceover("Wenn n gegen unendlich geht, nähert sich 1 durch n immer mehr 0. Stellen Sie sich vor, Sie teilen 1 durch eine sehr, sehr große Zahl - das Ergebnis wird sehr nahe bei 0 liegen.")]
...
#v(40pt)
#only("1-")[Hier ist ein Graph von $a_n = 1/n$ für verschiedene Werte von $n$ 📈]
#v(20pt)
#only("2-")[Wenn $n$ steigt, nähern sich die Punkte der roten Linie bei $y=0$ 🔴]
#v(20pt)
#only("3-")[Dies zeigt, dass $lim_(n->∞) 1/n = 0$ 🎯]

#only("1")[#voiceover("Lassen Sie uns diesen Grenzwert visualisieren. Hier ist ein Graph, der die Werte von a sub n gleich 1 durch n für verschiedene Werte von n darstellt.")]
#only("2")[#voiceover("Beachten Sie, wie die Punkte im Graphen, wenn n steigt, immer näher an die rote Linie bei y gleich 0 kommen.")]
...
#only("2")[#voiceover("Für die Folge a sub n gleich 1 durch n, wenn n gegen unendlich geht, nähert sich a sub n 0.")]
#only("3")[#voiceover("Das ist intuitiv verständlich, weil 1 geteilt durch eine sehr große Zahl nahe bei 0 liegt.")]
#only("4")[#voiceover("Die Visualisierung der Folge in einem Graphen kann helfen, den Grenzwert zu verstehen und zu bestätigen.")]
]