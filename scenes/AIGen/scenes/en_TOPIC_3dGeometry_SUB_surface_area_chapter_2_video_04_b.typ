...
plt.show()
  ...
  #only("1")[
    #voiceover("Let's review the correct solution step by step. We're dealing with a cuboid that has dimensions of 8 meters in length, 2 meters in width, and 3 meters in height. Here's a visual representation of our cuboid.")
  ]
]
