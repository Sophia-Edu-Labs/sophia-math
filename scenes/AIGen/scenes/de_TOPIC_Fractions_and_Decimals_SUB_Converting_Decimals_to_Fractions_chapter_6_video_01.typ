...
#v(20pt)
#only("2-")[- Du möchtest sie als Bruch schreiben: $square/square$]
#v(20pt)
#only("3-")[- Diese Fähigkeit hilft, Berechnungen zu vereinfachen und Zahlen besser zu verstehen. 🔍]
#only("1")[
#voiceover("Stell dir vor, du hast eine Dezimalzahl, wie null Komma sieben fünf.")
]
#only("2")[
#voiceover("Und du möchtest diese Zahl behalten, aber sie als Bruch schreiben, also als etwas über etwas anderes.")
]
#only("3")[
...
#only("1")[
#voiceover("Hier ist eine sehr kurze Übersicht der Schritte, die wir unternehmen müssen, um Dezimalzahlen in Brüche umzuwandeln. Zuerst zählen wir die Anzahl der Dezimalstellen in der Dezimalzahl.")
]
#only("2")[
...
#only("2")[
#voiceover("Als nächstes entfernen wir das Dezimalkomma, was uns fünfundsiebzig gibt.")
]
#only("3")[
