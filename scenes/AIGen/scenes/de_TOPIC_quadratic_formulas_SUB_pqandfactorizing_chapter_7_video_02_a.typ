...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartig! Du hast richtig erkannt, dass x gleich minus 3 die Lösung ist. Lass uns die Lösung Schritt für Schritt mit der p-q-Formel durchgehen. Wir beginnen mit der quadratischen Gleichung x Quadrat plus 6x plus 9 gleich 0.")
  ]
  #only("2")[
