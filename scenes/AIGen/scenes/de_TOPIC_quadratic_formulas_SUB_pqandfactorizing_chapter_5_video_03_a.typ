...
#only("1")[#voiceover("Großartige Arbeit beim Lösen dieser quadratischen Gleichung! Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit der Gleichung x Quadrat plus zwei x minus acht gleich null.")]
