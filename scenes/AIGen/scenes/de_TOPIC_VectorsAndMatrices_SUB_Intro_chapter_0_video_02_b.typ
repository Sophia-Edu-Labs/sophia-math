...
#only("1")[#voiceover("Ausgezeichnet! Du hast die richtige Antwort gewählt. Lass uns erklären, warum b) Eine mehrdimensionale Zahl die beste Beschreibung für einen Vektor ist.")]
