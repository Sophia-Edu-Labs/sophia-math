...
#only("1")[
#voiceover("Leider ist das nicht korrekt. Lass uns trotzdem Schritt für Schritt sehen, wie wir das lösen können. Wir haben zwei Folgen gegeben: a_n ist gleich 1 durch n, und b_n ist gleich 2.")
]
#only("2")[
