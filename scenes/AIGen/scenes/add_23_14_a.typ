...
#v(40pt)
#only("1-")[Dein Fehler: $2/3 + 1/4 ≠ (2+1)/(3+4)$]
#v(20pt)
...
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert hast. Zwei Drittel plus ein Viertel ist nicht gleich zwei plus eins geteilt durch drei plus vier.")
]
#only("2")[
...
#only("2-")[#text()[- $8/12 = 2/3$]]
#v(20pt)
#only("3-")[#text()[- $3/12 = 1/4$]]
#only("1")[
#voiceover("Hier siehst du die Brüche mit einem gemeinsamen Nenner von zwölf.")
]
#only("2")[
#voiceover("Also haben wir jetzt acht Zwölftel statt zwei Drittel,")
]
#only("3")[
#voiceover("und drei Zwölftel statt einem Viertel. Du siehst, dass auf jeder Seite der Wert gleich ist, lediglich die Darstellung ist anders.")
]
]
...
#v(20pt)
#only("1-")[Also ist $2/3 + 1/4 = 11/12$, nicht $3/7$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beachte den Zähler beim Addieren von Brüchen]
#only("1")[
#voiceover("Also ist zwei Drittel plus ein Viertel gleich elf Zwölftel, nicht drei Siebtel.")
]
#only("2")[
