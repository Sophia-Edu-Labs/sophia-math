...
#slide()[
#only("1")[
#voiceover("Großartige Arbeit! Du hast die Potenzfunktion korrekt identifiziert. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, warum f von x gleich zwei durch x die richtige Antwort ist.")
]
