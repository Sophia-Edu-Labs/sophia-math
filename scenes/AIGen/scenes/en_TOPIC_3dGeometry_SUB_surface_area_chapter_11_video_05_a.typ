...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's go through the solution step by step. We have a cuboid with a surface area of 400 square centimeters, a length of 16 centimeters, and a width of 10 centimeters. We need to find its height.")
  ]
]
