...
#only("1")[
#voiceover("Ausgezeichnet! Du hast die richtige Antwort. Lass uns die Lösung Schritt für Schritt durchgehen. Hier haben wir einen Würfel mit einer Kantenlänge von 4 Zentimetern.")
]
#only("2")[
