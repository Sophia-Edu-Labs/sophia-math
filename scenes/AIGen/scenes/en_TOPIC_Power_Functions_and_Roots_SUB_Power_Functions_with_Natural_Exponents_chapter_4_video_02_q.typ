...
// The title "Behavior of Power Functions" is shown on this slide
#v(40pt)
#only("1-")[As $x$ approaches zero, what happens to $f(x) = x^4$?]
// The question is shown from slide 1 onward
#v(40pt)
#only("2-")[a) Approaches zero 🎯]
// Answer option a) is shown from slide 2 onward
#v(10pt)
#only("3-")[b) Approaches infinity ∞]
...
#only("1")[#voiceover("Let's test your understanding of power functions. As x approaches zero, what happens to the function f of x equals x to the fourth power?")]
...
questionText: "As $x$ approaches zero, what happens to $f(x) = x^4$?",
