...
#v(40pt)
#only("1-")[Dein Fehler: $2/3 + 1/10 ≠ (3+10)/(3 dot 10)$]
#v(20pt)
#only("2-")[🛠️ Du hast die Summe der Nenner durch das Produkt der Nenner geteilt]
#v(20pt)
#only("3-")[🛠️ Du musst den Zähler anders bestimmen]
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert und multipliziert hast. Zwei Drittel plus ein Zehntel ist nicht gleich dreizehn Dreißigstel.")
]
#only("2")[
...
#only("2")[
#voiceover("Zunächst siehst du zwei Drittel, und daneben zwanzig Dreißigstel. Du kannst erkennen, dass der Wert gleich bleibt, nur die Darstellung ist anders. Also ist zwei Drittel gleich zwanzig Dreißigstel, und nicht gleich dreizehn Dreißigstel.")
]
#only("3")[
...
#v(20pt)
#only("1-")[Also ist $2/3 + 1/10 = 23/30$, nicht $13/30$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beachte den Zähler beim Addieren von Brüchen]
#only("1")[
#voiceover("Also ist zwei Drittel plus ein Zehntel gleich dreiundzwanzig Dreißigstel, nicht dreizehn Dreißigstel.")
]
#only("2")[
