...
#only("1")[
#voiceover("Großartig! Du hast diese Frage richtig beantwortet. Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit dem Problem: drei Fünftel multipliziert mit sieben Achtel.")
]
