...
#slide()[
  ...
  #only("3-")[
    #text(size: 20pt)[
      Change this fraction to have a denominator of 12.
    ]
  ]
  ...
  #only("3")[
    #voiceover("Your task is to change this fraction so that it has a denominator of twelve, while keeping its value the same. How would you approach this problem?")
  ]
]
