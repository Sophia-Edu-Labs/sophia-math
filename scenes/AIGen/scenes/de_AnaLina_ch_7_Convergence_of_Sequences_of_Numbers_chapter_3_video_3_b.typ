...
#only("1")[
#voiceover("Nicht ganz. Lassen Sie uns die richtige Lösung Schritt für Schritt durchgehen.")
]
...
#only("2-")[Beweisen Sie, dass die Folge $a_n = 1/n$ gegen 0 konvergiert, indem Sie die formale Definition der Konvergenz verwenden.]
...
// Die endgültige Ungleichung wird ab Folie 5 angezeigt
...
#only("6")[#voiceover("Somit konvergiert die Folge a sub n gleich eins durch n nach der formalen Definition der Konvergenz gegen null.")]
...
// Das Diagramm, das die Konvergenz visualisiert, wird ab Folie 1 angezeigt
...
#only("4")[#voiceover("Die wichtigsten Schritte waren, N gleich eins durch Epsilon zu wählen und dann zu zeigen, dass der Betrag von a sub n minus null kleiner als Epsilon ist für alle n größer oder gleich N.")]

#only("5")[#voiceover("Großartige Arbeit bei diesem Beweis! Sie haben ein solides Verständnis der formalen Definition der Konvergenz demonstriert.")]
