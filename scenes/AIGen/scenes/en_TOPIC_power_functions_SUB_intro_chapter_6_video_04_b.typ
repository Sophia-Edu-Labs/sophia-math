...
#slide()[
  ...
  #only("1")[
    #voiceover("Not quite. Let's go through the correct solution step-by-step. We're dealing with a power function f of x equals negative five times x to the fourth power.")
  ]
  #only("2")[
