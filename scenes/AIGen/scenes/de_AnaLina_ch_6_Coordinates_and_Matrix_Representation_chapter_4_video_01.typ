...
#only("1")[
#voiceover("Ein Basiswechsel beinhaltet das Finden eines neuen Satzes von Basisvektoren für einen Vektorraum.")
]
#only("2")[
...
#only("1")[
#voiceover("Schauen wir uns ein Beispiel an. In $RR^2$ sind die Standardbasisvektoren $mat(1;0)$ und $mat(0;1)$.")
]
#only("2")[
#voiceover("Wir möchten zu einer neuen Basis $B$ wechseln, die aus den Vektoren $mat(1;1)$ und $mat(1;-1)$ besteht.")
]
#only("3")[
#voiceover("Betrachten wir den Vektor $v = mat(2;0)$.")
]
]

#slide()[
#text(size: 30pt, weight: "bold")[Koordinaten in der neuen Basis]
#v(40pt)
#only("1-")[
#box()[
...
#v(20pt)
#only("4-")[- Koordinaten in der Basis $B$: $(1, 1)$]
#only("1")[
...
#only("3")[
#voiceover("Durch Lösen dieser Gleichung finden wir, dass $a = 1$ und $b = 1$ ist.")
]
#only("4")[
...
#only("2-")[- Koordinaten relativ zur neuen Basis ausdrücken 📐]
#v(20pt)
#only("3-")[- Es beinhaltet das Lösen eines linearen Systems 🧮]
#only("1")[
