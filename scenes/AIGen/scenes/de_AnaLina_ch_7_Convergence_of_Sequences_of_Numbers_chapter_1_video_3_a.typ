...
#only("1")[
#voiceover("Großartig! Das ist die richtige Antwort. Schauen wir uns an, wie wir die Konvergenz und den Grenzwert der Folge a sub n gleich 1 durch n bestimmen können.")
]
]
...
#only("1")[
#voiceover("Hier ist eine Visualisierung der Folge. Wenn n größer wird, nähern sich die in Blau dargestellten Glieder der Folge der roten Linie bei y gleich 0.")
]
]
]
