...
#only("1")[
#voiceover("Nicht ganz. Gehen wir die richtige Lösung Schritt für Schritt durch. Wir haben die Folge a_n gleich 2n plus 1 gegeben.")
]
#only("2")[
...
#only("-1")[- $a_n = 2n + 1$]
#v(20pt)
#only("2-")[- $n$ ist die Position des Gliedes in der Folge]
#only("1")[
#voiceover("Zuerst verstehen wir, was die Formel a_n gleich 2n plus 1 bedeutet.")
]
#only("2")[
#voiceover("In dieser Formel repräsentiert n die Position des Gliedes in der Folge.")
]
]
...
#only("1")[
#voiceover("Zusammenfassend hatten wir die Folge a_n gleich 2n plus 1 gegeben.")
]
#only("2")[
#voiceover("Unsere Aufgabe war es, das 5. Glied, a_5, zu finden.")
]
#only("3")[
#voiceover("Wir haben dies gelöst, indem wir n gleich 5 in die Formel eingesetzt haben, was uns a_5 gleich 2 mal 5 plus 1 ergab. Durch Vereinfachung fanden wir heraus, dass a_5 gleich 11 ist.")
]
]