...
#only("1")[
#voiceover("Betrachten Sie die lineare Abbildung T, die den Vektor (x, y) auf (2x, 3y) abbildet.")
]
]
...
#only("1")[
#voiceover("Wir wollen die Matrixdarstellung von T bezüglich der neuen Basis B finden, die aus den Vektoren (1; 1) und (1; -1) besteht.")
]
]
...
#v(40pt)
#only("1-")[
Finden Sie die Matrix $[T]_B$, die $T$ bezüglich $B$ darstellt.
]
// Die Frage wird ab Folie 1 gestellt
#only("1")[
#voiceover("Ihre Aufgabe ist es, die Matrix [T]_B zu finden, die die lineare Abbildung T bezüglich der Basis B darstellt.")
]
]#questionDef(
