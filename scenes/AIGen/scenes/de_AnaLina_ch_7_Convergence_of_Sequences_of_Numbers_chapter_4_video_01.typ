...
#v(40pt)
#only("1-")[Betrachte die Folge $a_n = n^2$]
#v(20pt)
#only("2-")[
#box()[
...
#only("1")[
#voiceover("Betrachte die Folge a_n gleich n zum Quadrat.")
]
#only("2")[
#voiceover("Wenn n wächst, werden die Glieder der Folge immer größer und größer ohne Grenze.")
]
]
]
...
#only("1")[
#voiceover("Formal divergiert eine Folge a_n zu unendlich, wenn:")
]
#only("2")[
...
#only("2")[
#voiceover("Ein Beispiel ist die Folge a_n gleich n zum Quadrat, die zu unendlich divergiert.")
]
#only("3")[
