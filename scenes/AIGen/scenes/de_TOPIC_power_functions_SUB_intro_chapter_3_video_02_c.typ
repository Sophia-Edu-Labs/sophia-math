...
#only("1")[#voiceover("Leider ist das nicht korrekt. Lass uns erklären, warum b) Spiegelt an der x-Achse die richtige Antwort ist und warum die anderen Optionen falsch sind.")]
