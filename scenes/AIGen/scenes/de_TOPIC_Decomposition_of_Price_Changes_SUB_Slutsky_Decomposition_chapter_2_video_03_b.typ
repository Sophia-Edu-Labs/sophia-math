...
#only("1")[
#voiceover("Leider falsch. Lass uns die Lösung Schritt für Schritt durchgehen. Es wird angegeben, dass der Preis des Gutes X von 10 Dollar auf 8 Dollar sinkt.")
]
#only("2")[
