...
#only("1")[
#voiceover("Großartige Arbeit! Das ist die richtige Antwort. Lass uns die Lösung Schritt für Schritt durchgehen. Gegeben sind zwei Folgen: a_n gleich 1 durch n und b_n gleich 2 durch n.")
]
#only("2")[
