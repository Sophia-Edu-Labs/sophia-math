...
#slide()[
  ...
  #only("1")[
    #voiceover("Leider war das nicht ganz richtig. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, wie wir zu dem richtigen Ergebnis kommen.")
  ]
