...
#only("1")[#voiceover("Excellent job! You've answered correctly. Let's break down why a) 3x squared is the correct answer and examine why the other options are incorrect.")]
