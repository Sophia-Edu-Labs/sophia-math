...
plt.show()
  ...
  #only("1")[
    #voiceover("Excellent work! You've got the correct answer. Let's walk through the solution step by step. We're dealing with a cube that has a side length of 8 centimeters. Here's a visual representation of our cube.")
  ]
]
