...
#slide()[
#only("1")[
#voiceover("Großartige Arbeit! Du hast die richtige Antwort. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, wie wir $9/20$ in eine Dezimalzahl umwandeln.")
]
