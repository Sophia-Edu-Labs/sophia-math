...
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert und multipliziert hast. Ein Achtel plus vier Fünftel ist nicht gleich dreizehn Vierzigstel.")
]
#only("2")[
...
plot_fraction_circle(axs[0], 8, 1, '1/8')
plot_fraction_circle(axs[1], 40, 5, '5/40')
...
#only("1")[
#voiceover("Hier siehst du die Brüche, die wir auf einen gemeinsamen Nenner bringen wollen. Beginnen wir mit ein Achtel.")
]
#only("2")[
#voiceover("Zunächst siehst du ein Achtel, und daneben fünf Vierzigstel. Du kannst erkennen, dass der Wert gleich bleibt, nur die Darstellung ist anders. Also ist ein Achtel gleich fünf Vierzigstel, und nicht gleich dreizehn Vierzigstel.")
]
#only("3")[
#voiceover("Und hier siehst du vier Fünftel und zweiunddreißig Vierzigstel. Auch hier bleibt der Wert gleich, nur die Darstellung ist anders. Vier Fünftel ist also gleich zweiunddreißig Vierzigstel, und nicht gleich dreizehn Vierzigstel.")
]
]
...
#v(20pt)
#only("1-")[Also ist $1/8 + 4/5 = 37/40$, nicht $13/40$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beachte den Zähler beim Addieren von Brüchen]
#only("1")[
#voiceover("Also ist ein Achtel plus vier Fünftel gleich siebenunddreißig Vierzigstel, nicht dreizehn Vierzigstel.")
]
#only("2")[
