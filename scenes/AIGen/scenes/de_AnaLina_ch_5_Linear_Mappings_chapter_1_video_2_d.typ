...
#only("1")[#voiceover("Nicht ganz, aber sehen wir uns an, warum a) 0 die richtige Antwort ist.")]
...
#only("3")[#voiceover("b) 1 ist falsch. Es gibt keine allgemeine Regel, die besagt, dass $T(0) = 1$ für lineare Abbildungen.")]
...
#v(40pt)
#only("1-")[Beweisen wir, dass $T(0) = 0$ für eine lineare Abbildung $T$:]
#v(20pt)
#only("2-")[- Per Definition gilt $T(c u) = c T(u)$ für jeden Skalar $c$ und Vektor $u$]
#v(20pt)
#only("3-")[- Sei $c = 0$ und $u$ ein beliebiger Vektor. Dann:]
#v(20pt)
#only("4-")[$T(0 u) = 0 T(u)$]
#v(20pt)
#only("5-")[$T(0) = 0$]
...
#only("1")[#voiceover("Nun beweisen wir, dass $T(0) = 0$ für eine lineare Abbildung $T$.")]
...
#only("5")[#voiceover("Da $0 u = 0$ für jeden Vektor $u$ und $0 T(u) = 0$, erhalten wir $T(0) = 0$.")]
#only("6")[#voiceover("Daher haben wir bewiesen, dass $T(0) = 0$ für jede lineare Abbildung $T$ gilt. Damit ist der Beweis abgeschlossen.")]
]
