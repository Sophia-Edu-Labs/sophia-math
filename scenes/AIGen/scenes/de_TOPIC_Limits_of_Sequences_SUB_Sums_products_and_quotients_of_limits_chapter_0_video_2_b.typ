...
#v(20pt)
#only("4-")[Wenn $n$ gegen ∞ geht, nähert sich $1/n$ der 0 🎯]
#v(20pt)
#only("5-")[Daher gilt $lim_(n->∞) 1/n = 0$ ✅]
...
#only("4")[#voiceover("Wenn n gegen unendlich geht, nähert sich 1 durch n immer mehr der 0 an. Stell dir vor, du teilst 1 durch eine sehr, sehr große Zahl - das Ergebnis wird sehr nahe bei 0 liegen.")]
...
#only("1")[#voiceover("Lass uns diesen Grenzwert visualisieren. Hier ist ein Diagramm, das die Werte von a_n gleich 1 durch n für verschiedene n-Werte darstellt.")]
#only("2")[#voiceover("Beachte, wie sich die Punkte im Diagramm der roten Linie bei y gleich 0 nähern, wenn n steigt.")]
...
#v(40pt)
#only("1-")[- Grenzwerte beschreiben das Verhalten einer Folge, wenn $n$ einen bestimmten Wert annimmt 📈]
#v(20pt)
#only("2-")[- Für $a_n = 1/n$, wenn $n$ gegen ∞ geht, nähert sich $a_n$ der 0 🎯]
#v(20pt)
#only("3-")[- Das liegt daran, dass $1/∞ = 0$ 🔢]
#v(20pt)
#only("4-")[- Die Visualisierung der Folge kann helfen, den Grenzwert zu verstehen 📊]

#only("1")[#voiceover("Zusammenfassend beschreiben Grenzwerte das Verhalten einer Folge, wenn n einen bestimmten Wert annimmt.")]
#only("2")[#voiceover("Für die Folge a_n gleich 1 durch n nähert sich a_n der 0, wenn n gegen unendlich geht.")]
