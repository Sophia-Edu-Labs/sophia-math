...
#only("5-")[  - $a_3 = 2(3) + 1 = 7$]
#only("1")[
#voiceover("Die Formel für das n-te Glied einer Folge wird normalerweise als a_n gleich eine Funktion von n geschrieben.")
]
#only("2")[
...
#only("5")[
#voiceover("Ähnlich ist für das dritte Glied a_3 gleich 2 mal 3 plus 1, was 7 ist. Und wir können diesen Prozess für jeden Wert von n fortsetzen.")
]
]
...
#only("3")[
#voiceover("Diese Formel wird normalerweise in der Form a_n gleich eine Funktion von n geschrieben.")
]
#only("4")[
