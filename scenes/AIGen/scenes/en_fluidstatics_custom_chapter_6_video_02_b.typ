...
#only("1")[
#voiceover("That's not quite right. Let's review the correct solution step by step. We are given that the height the water needs to be lifted is 30 meters.")
]
#only("2")[
