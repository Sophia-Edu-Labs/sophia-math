...
#v(40pt)
#only("1-")[Dein Fehler: $2/3 + 1/4 ≠ (2+1)/(3 dot 4)$]
#v(20pt)
#only("2-")[🛠️ Du hast die Zähler addiert und die Nenner multipliziert]
#v(20pt)
#only("3-")[🛠️ Du musst die Brüche auf einen gemeinsamen Nenner bringen]
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler addiert und die Nenner multipliziert hast. Zwei Drittel plus ein Viertel ist nicht gleich drei Zwölftel.")
]
#only("2")[
#voiceover("Denn du hast die Zähler addiert und die Nenner multipliziert, was falsch ist.")
]
#only("3")[
#voiceover("Du musst die Brüche auf einen gemeinsamen Nenner bringen, um sie korrekt addieren zu können.")
]
]
...
#only("4")[
#voiceover("Der gemeinsame Nenner ist zwölf.")
]
]
...
#only("2")[
#voiceover("Zunächst siehst du zwei Drittel, und daneben acht Zwölftel. Du kannst erkennen, dass der Wert gleich bleibt, nur die Darstellung ist anders. Also ist zwei Drittel gleich acht Zwölftel.")
]
#only("3")[
#voiceover("Und hier siehst du ein Viertel und drei Zwölftel. Auch hier bleibt der Wert gleich, nur die Darstellung ist anders. Ein Viertel ist also gleich drei Zwölftel.")
]
]
...
#v(20pt)
#only("1-")[Also ist $2/3 + 1/4 = 11/12$, nicht $3/12$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beachte den Zähler beim Addieren von Brüchen]
#only("1")[
#voiceover("Also ist zwei Drittel plus ein Viertel gleich elf Zwölftel, nicht drei Zwölftel.")
]
#only("2")[
