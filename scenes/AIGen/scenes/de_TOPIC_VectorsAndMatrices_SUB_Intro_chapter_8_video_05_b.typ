...
#only("1")[
#voiceover("Keine Sorge, lass uns die Lösung Schritt für Schritt durchgehen. Wir haben zwei Matrizen gegeben: A, eine 2x2-Matrix mit den Elementen 0, 1 in der ersten Zeile und 2, 3 in der zweiten Zeile; und B, eine weitere 2x2-Matrix mit den Elementen 4, 5 in der ersten Zeile und 6, 7 in der zweiten Zeile.")
]
