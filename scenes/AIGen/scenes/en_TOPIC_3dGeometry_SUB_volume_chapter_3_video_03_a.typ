...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's go through the solution step by step. We're dealing with a cuboid that has dimensions of 10 meters in length, 4 meters in width, and 3 meters in height. Here's a visual representation of our cuboid.")
  ]
]
