...
#only("1")[
#voiceover("Großartige Arbeit, das ist die richtige Antwort! Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben die Folge a_n gleich 2 durch n gegeben und müssen den Grenzwert bestimmen, wenn n gegen unendlich geht.")
]
]
