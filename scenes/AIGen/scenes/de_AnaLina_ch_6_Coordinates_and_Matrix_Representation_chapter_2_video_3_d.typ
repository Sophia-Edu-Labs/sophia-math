...
#only("1")[
#voiceover("Nicht ganz. Gehen wir die korrekte Matrixdarstellung der linearen Abbildung T Schritt für Schritt durch.")
]
]
...
#slide()[
#text(size: 30pt, weight: "bold")[Schritt 2: $T$ auf Basisvektoren anwenden]
#v(40pt)
#only("1-")[- $T(mat(1;0)) = mat(2;0)$]
#v(20pt)
#only("2-")[- $T(mat(0;1)) = mat(0;3)$]
#only("1")[
#voiceover("T von 1, 0 ergibt 2 mal 1, 3 mal 0, was sich zu 2, 0 vereinfacht.")
]
#only("2")[
#voiceover("Ähnlich ergibt T von 0, 1 2 mal 0, 3 mal 1, was sich zu 0, 3 vereinfacht.")
]
]
