...
plt.show()
  ...
  #only("1")[
    #voiceover("Keine Sorge, das war eine knifflige Frage. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit einem Quader zu tun, der die Maße 12 Meter mal 7 Meter mal 5 Meter hat. Hier ist eine visuelle Darstellung unseres Quaders.")
  ]
]
