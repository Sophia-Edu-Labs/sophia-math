...
#slide()[
  ...
  #only("1")[
    #voiceover("Not quite, but let's go through the correct solution step-by-step. We start with the quadratic equation x squared minus 4x minus 5 equals zero.")
  ]
  #only("2")[
