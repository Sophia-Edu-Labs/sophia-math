...
#slide()[
  ...
  #only("1")[
    #voiceover("Das ist leider falsch. Der Binomialkoeffizient n über k gibt die Anzahl der Möglichkeiten an, das Komitee zu bilden. Schauen wir uns an, welche Werte wir für n und k einsetzen müssen.")
  ]
  #only("2")[
