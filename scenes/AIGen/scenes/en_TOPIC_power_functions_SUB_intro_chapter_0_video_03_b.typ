...
#slide()[
  ...
  #only("1")[
    #voiceover("Not quite. Let's walk through the correct solution step-by-step. We're dealing with the quadratic function f of x equals 3x squared plus 2x plus 1.")
  ]
  #only("2")[
