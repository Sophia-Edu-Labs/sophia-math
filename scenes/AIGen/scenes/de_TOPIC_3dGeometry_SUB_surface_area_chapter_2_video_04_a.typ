...
plt.show()
  ...
  #only("1")[
    #voiceover("Großartige Arbeit bei der Lösung dieses Problems! Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit einem Quader zu tun, der Abmessungen von 8 Metern in der Länge, 2 Metern in der Breite und 3 Metern in der Höhe hat. Hier ist eine visuelle Darstellung unseres Quaders.")
  ]
]
