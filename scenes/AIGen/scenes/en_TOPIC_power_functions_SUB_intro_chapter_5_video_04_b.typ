...
#slide()[
  ...
  #only("1")[
    #voiceover("Nice effort on the power function question. Let's go through the correct solution step-by-step. We're dealing with the function f of x equals 8 divided by x squared.")
  ]
  #only("2")[
