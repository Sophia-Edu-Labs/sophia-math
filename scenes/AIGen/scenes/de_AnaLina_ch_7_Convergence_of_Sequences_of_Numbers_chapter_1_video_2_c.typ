...
#only("3")[#voiceover("Option b) n konstant bleibt ist ebenfalls falsch. Wenn n konstant bleibt, schreitet die Folge nicht voran und konvergiert daher nicht zu einem Wert.")]
#only("4")[#voiceover("Option c) n gegen unendlich geht ist die richtige Antwort. Wenn n immer größer wird, nähern sich die Folgenglieder einem bestimmten Grenzwert, falls die Folge konvergiert.")]
...
#only("4-")[- Also konvergiert $a_n = 1/n$ gegen 0, wenn $n->infinity$ 🎯]

#only("1")[#voiceover("Schauen wir uns ein Beispiel an, um das besser zu verstehen.")]
#only("2")[#voiceover("Betrachte die Folge a_n gleich 1 durch n. Wenn n zunimmt, wird 1 durch n immer kleiner.")]
...
#only("2")[#voiceover("Wenn n zunimmt, siehst Du, dass sich die Folgenglieder, dargestellt durch die blauen Punkte, der roten Linie nähern, die den Grenzwert von 0 darstellt.")]
...
#only("1")[#voiceover("Zusammengefasst bedeutet Konvergenz einer Folge, dass sich die Glieder einem bestimmten Grenzwert nähern.")]
...
#only("4")[#voiceover("Grafisch kannst Du die Konvergenz sehen, wenn sich die Folgenglieder der Grenzwertlinie nähern, wenn n zunimmt.")]
]