...
#only("2")[#voiceover("Option a) n abnimmt ist falsch. Wenn n abnimmt, entfernen sich die Folgenglieder von einem bestimmten Wert, anstatt sich ihm zu nähern.")]
#only("3")[#voiceover("Option b) n konstant bleibt ist ebenfalls falsch. Wenn n konstant bleibt, schreitet die Folge nicht voran und konvergiert somit zu keinem Wert.")]
#only("4")[#voiceover("Option c) n gegen unendlich geht ist die richtige Antwort. Wenn n immer größer wird, nähern sich die Folgenglieder einem bestimmten Grenzwert, wenn die Folge konvergiert.")]
...
#slide()[
#text(size: 30pt, weight: "bold")[Beispiel für Konvergenz]
#v(40pt)
#only("1-")[Betrachten Sie die Folge: $a_n = 1/n$]
#v(20pt)
#only("2-")[- Wenn $n$ zunimmt, wird $1/n$ kleiner]
#only("3-")[- $lim_(n->infinity) 1/n = 0$]
#only("4-")[- Also konvergiert $a_n = 1/n$ gegen 0, wenn $n$ gegen unendlich geht 🎯]

#only("1")[#voiceover("Schauen wir uns ein Beispiel an, um das besser zu verstehen.")]
...
#only("2")[#voiceover("Wenn n zunimmt, sehen Sie, dass sich die Folgenglieder, dargestellt durch die blauen Punkte, der roten Linie nähern, die den Grenzwert von 0 darstellt.")]
...
#v(40pt)
#only("1-")[- Konvergenz bedeutet Annäherung an einen bestimmten Grenzwert 🎯]
...
#only("4-")[- Grafisch nähern sich die Glieder der Grenzwertlinie, wenn $n$ zunimmt 📈]
...
#only("3")[#voiceover("Wenn sich die Glieder keinem Grenzwert nähern oder oszillieren, konvergiert die Folge nicht.")]
#only("4")[#voiceover("Grafisch sieht man die Konvergenz, wenn sich die Folgenglieder der Grenzwertlinie nähern, wenn n zunimmt.")]
]