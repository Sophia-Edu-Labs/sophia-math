...
#slide()[
  ...
  #only("1")[
    #voiceover("Not quite. Let's go through the correct solution step by step. We start with matrix A. It's a 2 by 3 matrix with elements 1, 2, 3 in the first row and 4, 5, 6 in the second row.")
  ]
  #only("2")[
