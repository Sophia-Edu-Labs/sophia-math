...
#v(40pt)
// Von Anfang bis Abschnitt eins ist die Option schwarz. Von Abschnitt 2 bis zum Ende wird sie dann rot, weil sie nicht gegen unendlich divergiert.
#only("-1")[a) $a_n = 1/n$]#only("2-")[#text(fill:red)[a) $a_n = 1/n$]]
#v(10pt)
// Von Anfang bis Abschnitt zwei ist die Option schwarz. Von Abschnitt 3 bis zum Ende wird sie dann grün, weil sie gegen unendlich divergiert.
#only("-2")[b) $b_n = n$]#only("3-")[#text(fill:green)[b) $b_n = n$]]
#v(10pt)
// Von Anfang bis Abschnitt drei ist die Option schwarz. Von Abschnitt 4 bis zum Ende wird sie dann rot, weil sie nicht gegen unendlich divergiert.
#only("-3")[c) $c_n = (-1)^n$]#only("4-")[#text(fill:red)[c) $c_n = (-1)^n$]]
#v(10pt)
// Von Anfang bis Abschnitt vier ist die Option schwarz. Von Abschnitt 5 bis zum Ende wird sie dann rot, weil sie nicht gegen unendlich divergiert.
...
#v(20pt)
- Berücksichtigen Sie immer das Langzeitverhalten einer Folge. ♾️
...
#only("4")[#voiceover("Berücksichtigen Sie immer das Langzeitverhalten einer Folge, wenn Sie bestimmen, ob sie gegen unendlich divergiert.")]
]