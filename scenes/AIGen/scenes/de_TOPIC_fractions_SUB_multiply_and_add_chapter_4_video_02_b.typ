...
#slide()[
  ...
  #only("1")[
    #voiceover("Keine Sorge, wir gehen die Lösung gemeinsam durch. Lass uns Schritt für Schritt sehen, wie wir ein Drittel in einen äquivalenten Bruch mit einem Nenner von 6 umwandeln.")
  ]
