...
#only("1")[
#voiceover("Du hast die Summe der Nenner durch das Produkt der Nenner geteilt. Also fünf plus sechs geteilt durch fünf mal sechs. Das ist leider nicht richtig.")
]
#only("2")[
...
#only("2")[
#voiceover("Aus drei Fünftel werden achtzehn Dreißigstel. Wir haben also sowohl den Zähler, als auch den Nenner mit sechs multipliziert. Und wie du siehst bleibt dann der Wert gleich.")
]
#only("3")[
#voiceover("Und aus zwei Sechstel werden zehn Dreißigstel. Auch hier haben wir sowohl den Zähler, als auch den Nenner mit dem selben Wert multipliziert. Und auch hier bleibt der Wert gleich.")
]
]
