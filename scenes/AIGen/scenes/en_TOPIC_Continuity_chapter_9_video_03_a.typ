...
#only("1")[
#voiceover("Great job! You correctly determined that the function f of x equals x cubed minus 3x plus 2 is continuous at x equals 1. Let's go through the solution step by step.")
]
#only("2")[
