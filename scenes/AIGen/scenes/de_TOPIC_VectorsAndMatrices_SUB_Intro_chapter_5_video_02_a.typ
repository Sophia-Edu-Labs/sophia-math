...
#only("1")[
#voiceover("Großartige Arbeit beim Lösen dieses Problems! Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen damit, die Matrix mit dem Skalar 3 zu multiplizieren.")
]
