...
#v(40pt)
#only("1-")[Dein Fehler: $1/8 + 4/5 ≠ (1+4)/(8 dot 5)$]
#v(20pt)
...
#only("3")[
#voiceover("Der gemeinsame Nenner ist vierzig, wie du schon richtig erkannt hast.")
]
]
...
visualize_fraction(axs[0], 5, 40, 'blue', '5/40')
#then plot the fraction 32/40, which is equivalent to the fraction 4/5
visualize_fraction(axs[1], 32, 40, 'red', '32/40')
...
visualize_fraction(ax, 37, 40, 'purple', '5/40 + 32/40 = 37/40')
