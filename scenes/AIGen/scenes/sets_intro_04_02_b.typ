...
#only("-1")[$ |B|=? $]#only("2-")[$ |B|=5 $]
#only("1")[
  #voiceover("Das stimmt leider nicht ganz. Um die Mächtigkeit einer Menge zu bestimmen, zählen wir einfach die Anzahl der Elemente. In diesem Fall sind ja die Elemente a,b,d, e und f in B.")
]
#only("2")[
