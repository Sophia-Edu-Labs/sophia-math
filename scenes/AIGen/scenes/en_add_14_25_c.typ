...
#v(40pt)
#only("1-")[Dein Fehler: $1/4 + 2/5 ≠ (4+5)/(4 dot 5)$]
#v(20pt)
#only("2-")[✅ Gemeinsamen Nenner gefunden]
#v(20pt)
#only("3-")[🛠️ Zähler falsch bestimmt]
#only("1")[
#voiceover("Du hast die Summe der Nenner durch das Produkt der Nenner geteilt. Also vier plus fünf geteilt durch vier mal fünf. Das ist leider nicht richtig.")
]
#only("2")[
...
#only("2")[
#voiceover("Aus ein Viertel werden fünf Zwanzigstel. Wir haben also sowohl den Zähler als auch den Nenner mit fünf multipliziert. Und wie du siehst, bleibt der Wert gleich.")
]
#only("3")[
#voiceover("Und aus zwei Fünftel werden acht Zwanzigstel. Auch hier haben wir sowohl den Zähler als auch den Nenner mit vier multipliziert. Und auch hier bleibt der Wert gleich.")
]
]
