...
#slide()[
#only("1")[
#voiceover("Großartig! Du hast die richtige Antwort. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, wie wir sieben Zwanzigstel in eine Dezimalzahl umwandeln.")
]
