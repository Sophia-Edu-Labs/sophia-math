...
#only("1")[#voiceover("Leider ist das nicht korrekt. Lass uns das Video ansehen, um die richtige Antwort zu verstehen.")]
...
#only("1")[#voiceover("Lass uns ein konkretes Beispiel durchgehen, um unser Verständnis zu festigen.")]
...
#only("3")[#voiceover("Als nächstes finden wir die Basiswechselmatrix von der Standardbasis zu B. Diese Matrix hat die neuen Basisvektoren als ihre Spalten.")]
]
...
#only("4")[#voiceover("Fantastische Arbeit beim Erfassen dieses wichtigen Konzepts. Mach weiter so auf deiner Reise durch die lineare Algebra!")]
]