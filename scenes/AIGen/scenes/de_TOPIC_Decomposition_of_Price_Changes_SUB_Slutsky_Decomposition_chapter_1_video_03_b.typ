...
#only("1")[
#voiceover("Leider nicht ganz richtig. Lass uns trotzdem Schritt für Schritt sehen, wie wir das lösen können. Uns wird mitgeteilt, dass der Preis von Gut X von 10 Dollar auf 8 Dollar sinkt.")
]
#only("2")[
