...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartig! Das ist die richtige Antwort. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben zwei Vektoren gegeben: a, das ist 2, 5, 6, und b, das ist 3, 1, 2.")
  ]
