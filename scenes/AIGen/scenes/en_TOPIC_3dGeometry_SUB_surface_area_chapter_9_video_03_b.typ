...
plt.show()
  ...
  #only("1")[
    #voiceover("That's okay, let's review the correct solution step by step. We have a cube with a side length of 9 centimeters. Here's a visualization of our cube.")
  ]
]
