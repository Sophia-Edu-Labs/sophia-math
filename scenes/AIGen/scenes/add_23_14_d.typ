...
#v(40pt)
#only("1-")[Deine Lösung: $2/3 + 1/4 = 11/12$]
#v(20pt)
#only("2-")[👍 Gut gemacht! Du hast die Brüche korrekt addiert]
#v(20pt)
#only("3-")[🔍 Schauen wir uns das noch einmal genauer an]
#only("1")[
#voiceover("Du hast zwei Drittel plus ein Viertel korrekt berechnet und das Ergebnis ist elf Zwölftel.")
]
#only("2")[
...
#v(20pt)
#only("1-")[Also ist $2/3 + 1/4 = 11/12$.]
#v(20pt)
#only("2-")[Gut gemacht! 🎉]
#only("1")[
#voiceover("Also ist zwei Drittel plus ein Viertel gleich elf Zwölftel.")
]
#only("2")[
