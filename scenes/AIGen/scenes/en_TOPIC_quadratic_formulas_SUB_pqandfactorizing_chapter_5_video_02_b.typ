...
#slide()[
  ...
  #only("1")[
    #voiceover("Nice try! Let's go through the correct solution step-by-step. We're solving the quadratic equation x squared minus 7x plus 12 equals zero by factoring.")
  ]
  #only("2")[
