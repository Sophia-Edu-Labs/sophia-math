...
#only("2")[
#voiceover("Deine Antwort, drei Neuntel, ist leider nicht richtig.")
]
]
...
#only("1")[
#voiceover("Du hast die Zähler addiert und die Nenner addiert. Also eins plus zwei geteilt durch vier plus fünf. Das stimmt aber leider nicht.")
]
#only("2")[
...
#only("2")[
#voiceover("Diese Brüche haben verschiedene Nenner, also teilen wir sie in Stücke verschiedener Größe ein: Links haben wir Viertel und rechts Fünftel. Deswegen können wir auch nicht einfach die Zähler addieren.")
]
#only("3")[
...
#only("1")[
#voiceover("Ein gemeinsamer Nenner wäre 20, denn 20 ist ein Vielfaches von 4 und 5.")
]
#only("2")[
#voiceover("Dann wandeln wir die Brüche um: Fünf Zwanzigstel ist gleich einem Viertel.")
]
#only("3")[
#voiceover("und acht Zwanzigstel statt zwei Fünftel. Du siehst, dass auf jeder Seite der Wert gleich ist, wie davor. Lediglich die Darstellung ist anders.")
]
]
...
plot_fraction_circle(axs, 20, 13, '5/20 + 8/20 = 13/20')
...
#plot the sum of the two fractions
plot_fraction_circle(ax, 20, 13, '13/20')
...
#v(20pt)
#only("1")[
#voiceover("Jetzt haben beide Brüche den gleichen Nenner - und du kannst die Brüche addieren. Du addierst die Zähler und behältst den gemeinsamen Nenner.")
]
#only("2")[
