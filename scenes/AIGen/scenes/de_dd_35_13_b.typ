...
#v(40pt)
//Antwort des Schülers: $4/15$
#only("2-")[Deine Antwort: $4/15$]
#only("1")[
#voiceover("Wir sollen drei Fünftel plus ein Drittel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist vier Fünfzehntel. Das ist leider nicht richtig.")
]
]
...
#v(40pt)
#only("1-")[Dein Fehler: $3/5 + 1/3 ≠ (3+1)/(5 dot 3)$]
#v(20pt)
#only("2-")[✅ Du hast die Nenner multipliziert!]
#v(20pt)
#only("3-")[🛠️ Du musst aber auch die Zähler anpassen...]
#only("1")[
#voiceover("Denn drei Fünftel plus ein Drittel ist nicht gleich drei plus eins durch fünf mal drei.")
]
#only("2")[
...
#v(20pt)
#only("4-")[#text()[- Gemeinsamer Nenner: $15$]]
#only("1")[
...
#only("3")[
#voiceover("Der gemeinsame Nenner ist fünfzehn, wie du schon richtig erkannt hast.")
]
]
...
#only("2")[
#voiceover("Aus drei Fünftel werden dann neun Fünfzehntel. Wir haben also sowohl den Zähler, als auch den Nenner mit drei multipliziert. Und wie du siehst bleibt dann der Wert gleich.")
]
#only("3")[
#voiceover("Und aus ein Drittel werden fünf Fünfzehntel. Auch hier haben wir sowohl den Zähler, als auch den Nenner mit dem selben Wert multipliziert. Und auch hier bleibt der Wert gleich.")
]
]
...
visualize_fraction(axs[1], 5, 15, 'red', '5/15')
