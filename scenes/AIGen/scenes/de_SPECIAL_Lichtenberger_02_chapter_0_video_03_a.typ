...
#only("1")[
#voiceover("Großartige Arbeit! Lass uns die Lösung überprüfen. Wir haben einen Druck von 14,7 bar und die Fläche des Pumpenkolbens beträgt 5,0 Quadratzentimeter.")
]
#only("2")[
