...
#slide()[
  #only("1")[
    #voiceover("Großartige Arbeit! Du hast die Ableitung korrekt identifiziert. Lass uns Schritt für Schritt die Lösung durchgehen, um zu verstehen, wie wir zu diesem Ergebnis gekommen sind.")
  ]
