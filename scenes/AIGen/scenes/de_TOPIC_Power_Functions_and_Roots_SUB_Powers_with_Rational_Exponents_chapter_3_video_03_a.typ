...
#only("4-")[- $= 3 root(3,3)$]
#only("1")[
#voiceover("Das ist richtig, großartige Arbeit! Lass uns Schritt für Schritt sehen, wie wir den Ausdruck 5 mal die Kubikwurzel von 3 minus 2 mal die Kubikwurzel von 3 vereinfachen können.")
]
#only("2")[
