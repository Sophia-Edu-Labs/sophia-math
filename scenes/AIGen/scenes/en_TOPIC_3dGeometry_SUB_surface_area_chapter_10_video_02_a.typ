...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's go through the solution step-by-step. We're dealing with a cuboid that has dimensions of 13 centimeters by 7 centimeters by 5 centimeters. Here's a visual representation of our cuboid.")
  ]
]
