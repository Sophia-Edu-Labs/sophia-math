...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartig, dass Du dieses Problem angehst! Lass es uns Schritt für Schritt lösen. Wir haben die quadratische Gleichung x Quadrat plus 3x plus 2 gleich null.")
  ]
  #only("2")[
