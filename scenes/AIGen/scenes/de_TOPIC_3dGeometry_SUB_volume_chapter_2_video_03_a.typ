...
plt.show()
  ...
  #only("1")[
    #voiceover("Großartig! Du hast das Volumen des Quaders korrekt berechnet. Lass uns die Lösung Schritt für Schritt durchgehen. Hier ist eine Visualisierung unseres Quaders mit einer Länge von 5 cm, einer Breite von 3 cm und einer Höhe von 4 cm.")
  ]
]
