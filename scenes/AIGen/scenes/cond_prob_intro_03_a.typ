...
#only("4-")[$P(B) = 3/10$]
#only("1")[
#voiceover("Alles klar, Ereignis A ist, dass eine Kugel mit einer geraden Zahl gezogen wird, und Ereignis B ist, dass eine Kugel mit einer Zahl größer als 7 gezogen wird.")
]
#only("2")[
