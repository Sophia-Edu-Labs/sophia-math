...
#only("1")[#voiceover("Ausgezeichnet! Du hast die allgemeine Form einer Potenzfunktion mit negativem Exponenten korrekt identifiziert. Lass uns erläutern, warum dies die richtige Antwort ist und warum die anderen Optionen falsch sind.")]
