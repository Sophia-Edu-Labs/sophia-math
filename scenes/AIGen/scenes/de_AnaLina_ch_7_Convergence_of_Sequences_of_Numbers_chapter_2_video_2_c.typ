...
#only("2")[#voiceover("a) Die Folge $a_n = n$ konvergiert nicht. Wenn $n$ größer wird, wachsen die Glieder der Folge unbegrenzt und nähern sich der Unendlichkeit.")]
#only("3")[#voiceover("b) Die Folge $b_n = 1/n$ konvergiert. Wenn $n$ größer wird, nähern sich die Glieder der Folge immer mehr 0 an. Tatsächlich ist der Grenzwert dieser Folge, wenn $n$ gegen unendlich geht, 0.")]
...
#only("5")[#voiceover("d) Die Folge $d_n = n^2$ konvergiert nicht. Ähnlich wie bei Folge a) wachsen die Glieder dieser Folge unbegrenzt, wenn $n$ größer wird, und nähern sich der Unendlichkeit.")]
]
...
#only("1")[#voiceover("In diesen Diagrammen können wir das Verhalten jeder Folge sehen, wenn $n$ größer wird.")]
#only("2")[#voiceover("Für Folge a) sehen wir einen stetigen linearen Anstieg, der auf eine Divergenz zur Unendlichkeit hinweist.")]
#only("3")[#voiceover("Für Folge b) sehen wir, dass die Glieder immer näher an 0 herankommen, was auf eine Konvergenz zu 0 hinweist.")]
...
#only("1")[#voiceover("Wenden wir diese Definition nun auf die Folge $b_n = 1/n$ an.")]
...
#only("4")[#voiceover("Dann für jedes $n$ größer oder gleich $N$ wird der absolute Wert von $b_n$ minus 0, was einfach 1 durch $n$ ist, kleiner als 1 durch $N$ sein, was wiederum kleiner als Epsilon ist.")]
