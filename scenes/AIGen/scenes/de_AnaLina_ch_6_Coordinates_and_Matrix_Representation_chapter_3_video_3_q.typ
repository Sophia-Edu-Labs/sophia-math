...
// Die gegebene Matrix A und der Vektor v werden ab Folie 1 gezeigt

#v(20pt)

#only("2-")[
Finde das Bild von $v$ unter der linearen Abbildung, die durch $A$ dargestellt wird.
// Die Frage, das Bild von v zu finden, wird ab Folie 2 gezeigt

#only("1")[
#voiceover("Betrachte die Matrix A, die gleich der 2x2-Matrix mit den Elementen 2, 0, 0 und 3 ist, und den Vektor v, der gleich dem Spaltenvektor mit den Elementen 1 und 2 ist.")
]

#only("2")[
#voiceover("Finde das Bild des Vektors v unter der linearen Abbildung, die durch die Matrix A dargestellt wird.")
]
]
