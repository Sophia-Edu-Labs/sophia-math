...
#only("1")[#voiceover("Das ist okay! Schauen wir uns die richtige Lösung an.")]
...
#only("1")[#voiceover("Lassen Sie uns dies Schritt für Schritt aufschlüsseln. Eine Sequenz ist tatsächlich eine geordnete Liste von Zahlen.")]
#only("2")[#voiceover("Die Zahlen in einer Sequenz sind nicht zufällig. Sie folgen einem bestimmten Muster oder einer Regel.")]
#only("3")[#voiceover("Betrachten Sie zum Beispiel die Sequenz 1, 2, 3, 4 und so weiter. Jedes Glied in dieser Sequenz entspricht seiner Position. Wir können dies als a_n = n schreiben.")]
#only("4")[#voiceover("Ein weiteres bekanntes Beispiel ist die Fibonacci-Sequenz: 1, 1, 2, 3, 5, 8 und so weiter. Jedes Glied ist die Summe der beiden vorhergehenden.")]
#only("5")[#voiceover("Also ist die richtige Antwort b) Eine geordnete Liste von Zahlen. Gut gemacht, dass Sie die richtige Option gewählt haben!")]
]