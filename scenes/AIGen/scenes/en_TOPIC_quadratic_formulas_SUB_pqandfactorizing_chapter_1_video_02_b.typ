...
#slide()[
  ...
  #only("1")[
    #voiceover("Nice try! Let's go through the correct solution step-by-step. First, let's recall what a quadratic equation looks like. It's in the form a x squared plus b x plus c equals zero.")
  ]
  #only("2")[
