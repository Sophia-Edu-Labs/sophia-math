...
plt.show()
  ...
  #only("1")[
    #voiceover("Not quite. Let's go through the correct solution step by step. We have a cuboid with a length of 7 centimeters, a width of 4 centimeters, and a height of 5 centimeters. Here's a visual representation of our cuboid.")
  ]
]
