...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartig! Du hast die richtige Antwort gefunden. Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit der gegebenen Funktion f von x gleich 4x hoch 4 plus 2x hoch 3.")
  ]
