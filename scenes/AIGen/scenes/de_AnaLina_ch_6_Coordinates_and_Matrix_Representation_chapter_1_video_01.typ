...
#v(40pt)
#only("1-")[- Basis: Menge von Vektoren, die einen Vektorraum aufspannen 🎛️]
#v(20pt)
...
#only("1")[
#voiceover("Eine Basis ist eine Menge von Vektoren, die einen Vektorraum aufspannen. Mit anderen Worten, jeder Vektor im Raum kann als Linearkombination der Basisvektoren ausgedrückt werden.")
]
#only("2")[
...
#only("3")[
#voiceover("Die Koordinaten eines Vektors werden relativ zur Basis ausgedrückt. Sie geben an, wie viel von jedem Basisvektor addiert werden muss, um den ursprünglichen Vektor zu erhalten.")
]
#only("4")[
...
#only("1")[
#voiceover("Hier ist eine Visualisierung. Die roten und grünen Pfeile repräsentieren die Standardbasisvektoren 1, 0 und 0, 1. Der blaue Pfeil ist der Vektor 2, 3. Wie Sie sehen können, ist der blaue Vektor 2 mal der rote Vektor plus 3 mal der grüne Vektor.")
]
]
]
...
#v(20pt)
#only("3-")[- Jeder Vektor ist eine Linearkombination von Basisvektoren 🧮]
#only("1")[
