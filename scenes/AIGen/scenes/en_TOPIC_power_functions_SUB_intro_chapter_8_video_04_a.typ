...
```
  ...
  #only("1")[
    #voiceover("Great job on answering this question! Let's break down the solution step by step. We're dealing with the power function f of x equals 27 divided by x cubed. Here's a graph of this function to help us visualize it.")
  ]
]
