...
#only("1")[
  #voiceover("Das ist leider falsch! Um die Wahrscheinlichkeit zu berechnen, dass beide Kugeln blau sind, müssen wir die Wahrscheinlichkeiten entlang des Pfades 'Blau-Blau' multiplizieren. Dabei müssen wir beachten, dass die Wahrscheinlichkeiten im zweiten Zug von der Farbe der ersten Kugel abhängen.")
]
