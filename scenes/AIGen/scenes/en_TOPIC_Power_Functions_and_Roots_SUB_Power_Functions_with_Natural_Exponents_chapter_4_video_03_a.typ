...
#only("1")[
#voiceover("Great job! That's the correct behavior. Let's see why. We're considering the function f of x equals x to the power of 7 and we want to know what happens as x approaches zero.")
]
#only("2")[
