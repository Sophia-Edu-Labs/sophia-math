...
plt.show()
  ...
  #only("1")[
    #voiceover("Excellent work! That's the correct answer. Let's break down the solution step by step. We have a composite figure consisting of a cuboid with dimensions 15 cm by 10 cm by 8 cm, and a cube with a side length of 6 cm on top. Here's a visualization of our composite figure.")
  ]
]
