...
#slide()[
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's walk through the solution step-by-step to understand how we change one-half to an equivalent fraction with a denominator of 4.")
  ]
