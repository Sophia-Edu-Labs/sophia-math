...
plt.show()
  ...
  #only("1")[
    #voiceover("Großartige Arbeit bei der Lösung dieses Problems! Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben eine zusammengesetzte Figur, die aus zwei Würfeln besteht: einem mit einer Seitenlänge von 4 cm und einem anderen mit einer Seitenlänge von 2 cm, die an einer Fläche verbunden sind.")
  ]
]
