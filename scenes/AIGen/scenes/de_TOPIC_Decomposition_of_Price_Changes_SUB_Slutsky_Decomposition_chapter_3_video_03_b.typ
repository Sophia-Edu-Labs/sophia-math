...
#only("3-")[- Gesamteffekt: ?]
#only("1")[
#voiceover("Leider ist das nicht korrekt. Lass uns Schritt für Schritt durchgehen, wie die richtige Antwort gefunden wird. Es wird angegeben, dass der Substitutionseffekt die nachgefragte Menge von 5 auf 7 Einheiten erhöht.")
]
#only("2")[  
