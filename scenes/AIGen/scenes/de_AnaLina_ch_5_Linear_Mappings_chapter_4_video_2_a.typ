...
#only("3")[#voiceover("Option b ist tatsächlich die richtige Dimensionsformel. Sie besagt, dass die Dimension des Definitionsbereichs V gleich der Summe der Dimensionen des Kerns und des Bildes von T ist.")]
#only("4")[#voiceover("Option c ist falsch. Die Dimensionsformel multipliziert nicht die Dimensionen des Kerns und des Bildes.")]
#only("5")[#voiceover("Und Option d ist auch falsch. Es subtrahiert die Dimensionen in der falschen Reihenfolge.")]
]
...
#only("2")[#voiceover("Der erste Schritt besteht darin, sich an die Dimensionsformel zu erinnern. Sie besagt, dass die Dimension des Definitionsbereichs V gleich der Summe der Dimensionen des Kerns und des Bildes von T ist.")]
]
...
#only("2")[#voiceover("Daher ist die richtige Antwort b. Die Dimension des Definitionsbereichs V entspricht der Summe der Dimensionen des Kerns und des Bildes von T.")]
]