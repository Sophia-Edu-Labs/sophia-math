...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's go through the solution step-by-step. We're dealing with a cuboid that has a length of 5 centimeters, a width of 3 centimeters, and a height of 4 centimeters. Here's a visual representation of our cuboid.")
  ]
]
