...
#only("1")[
#voiceover("Großartige Arbeit! Das ist die richtige Antwort. Die Koordinaten des Vektors v gleich 2; 3 relativ zur Basis B gleich 1; 0 und 0; 1 sind tatsächlich 2, 3.")
]
]
...
#only("1")[
#voiceover("Zuerst lassen Sie uns verstehen, was die Basisvektoren in B darstellen. Der Vektor 1; 0 zeigt entlang der x-Achse, und der Vektor 0; 1 zeigt entlang der y-Achse.")
]
]
...
#slide()[
#text(size: 30pt, weight: "bold")[Schritt 3: $a$ und $b$ lösen]
#v(40pt)
