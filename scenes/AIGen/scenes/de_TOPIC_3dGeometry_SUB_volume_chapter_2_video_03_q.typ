...
#slide()[
  ...
  #only("2")[
    #voiceover("Berechne das Volumen eines Quaders mit den folgenden Maßen: Länge 5 Zentimeter, Breite 3 Zentimeter und Höhe 4 Zentimeter.")
  ]
...
plt.show()
  ...
  #only("3")[
    #voiceover("Hier ist eine visuelle Darstellung des Quaders mit den gegebenen Maßen. Denke daran, wir müssen sein Volumen berechnen.")
  ]
]

//Type: Numeric
#questionDef(
questionText: "Was ist das Volumen eines Quaders mit Länge $5$ cm, Breite $3$ cm und Höhe $4$ cm?", 
answerOptions: ("$\\text{Volumen} = 60$", "$\\text{Volumen} = -116$"), 
