...
#only("1")[
#voiceover("Großartig! Du hast richtig erkannt, dass sieben Zehntel als Dezimalzahl null Komma sieben ist. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, warum das so ist.")
]
