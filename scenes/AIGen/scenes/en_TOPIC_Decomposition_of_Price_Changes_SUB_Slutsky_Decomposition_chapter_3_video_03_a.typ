...
#only("3-")[- Total effect: ?]
#only("1")[
#voiceover("Great job! That's the correct answer. Let's see how we arrive at that step-by-step. We are given that the substitution effect increases the quantity demanded from 5 to 7 units.")
]
#only("2")[  
