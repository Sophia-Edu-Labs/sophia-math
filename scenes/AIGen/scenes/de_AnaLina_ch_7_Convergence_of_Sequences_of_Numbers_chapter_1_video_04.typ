...
#v(40pt)
#only("1-")[
- Eine Folge $(a_n)$ konvergiert, wenn ihre Glieder einen bestimmten Wert $L$ annähern, wenn $n$ gegen $unendlich$ geht.
]
#only("1")[
...
#only("1")[
#voiceover("Betrachten wir zum Beispiel die Folge a_n gleich 1 durch n. Wenn n zunimmt, nähern sich die Glieder der Folge immer mehr 0 an.")
]
]
...
#v(40pt)
#only("1-")[
- Wir schreiben $lim_(n->unendlich) a_n = L$, um zu kennzeichnen, dass der Grenzwert von $(a_n)$ $L$ ist.
]
#only("2-")[
- Beispiel: $lim_(n->unendlich) 1/n = 0$
]
#only("1")[
#voiceover("Wir schreiben den Grenzwert als n gegen unendlich von a_n gleich L, um zu kennzeichnen, dass der Grenzwert der Folge a_n L ist.")
]
#only("2")[
#voiceover("Zum Beispiel ist der Grenzwert als n gegen unendlich von 1 durch n gleich 0.")
]
]
...
#v(40pt)
#only("1-")[
- Konvergenz: Glieder nähern sich einem bestimmten Wert, wenn $n -> unendlich$ 📈
]
#only("2-")[
- Grenzwert: der Wert, den eine konvergente Folge annähert 🎯
]
#only("3-")[
- Notation: $lim_(n->unendlich) a_n = L$ 📝
]
#only("1")[
...
#only("3")[
#voiceover("Und wir kennzeichnen dies mit der Grenzwertnotation: der Grenzwert als n gegen unendlich von a_n gleich L.")
]
]