...
#slide()[
#only("1")[
#voiceover("Ausgezeichnete Arbeit! Du hast dieses Problem korrekt gelöst. Lass uns Schritt für Schritt die Lösung durchgehen, um zu verstehen, wie wir zur Antwort kommen.")
]
