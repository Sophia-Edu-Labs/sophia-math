...
#v(40pt)
Was ist der Grenzwert der Folge $a_n = 1/n$, wenn $n$ gegen Unendlichkeit geht?
#v(40pt)
...
#only("2")[#voiceover("b) 0. Lass uns sehen warum...")]
]
...
#only("1")[#voiceover("Wir haben die Folge a sub n gleich 1 durch n gegeben.")]
#only("2")[#voiceover("Wenn n steigt, sinkt der Wert von 1 durch n. Dies liegt daran, dass der Bruch kleiner wird, wenn der Nenner größer wird.")]
#only("3")[#voiceover("Zum Beispiel, 1 durch 1 ist gleich 1, 1 durch 10 ist gleich 0.1, 1 durch 100 ist gleich 0.01, und so weiter.")]
#only("4")[#voiceover("Wenn n gegen Unendlichkeit geht, nähert sich 1 durch n immer mehr 0 an. Stell dir vor, du teilst 1 durch eine sehr, sehr große Zahl - das Ergebnis wird sehr nahe bei 0 liegen.")]
#only("5")[#voiceover("Daher ist der Grenzwert von 1 durch n, wenn n gegen Unendlichkeit geht, 0.")]
]
...
#only("1")[#voiceover("Lass uns diesen Grenzwert visualisieren. Hier ist ein Diagramm, das die Werte von a sub n gleich 1 durch n für verschiedene Werte von n darstellt.")]
#only("2")[#voiceover("Beachte, wie sich die Punkte im Diagramm der roten Linie bei y gleich 0 immer mehr nähern, wenn n steigt.")]
#only("3")[#voiceover("Dies ist eine visuelle Darstellung der Tatsache, dass der Grenzwert von 1 durch n, wenn n gegen Unendlichkeit geht, 0 ist.")]
]
...
#v(20pt)
#only("3-")[- Dies liegt daran, dass $1/∞ = 0$ 🔢]
#v(20pt)
...
#only("2")[#voiceover("Für die Folge a sub n gleich 1 durch n, wenn n gegen Unendlichkeit geht, nähert sich a sub n 0.")]
