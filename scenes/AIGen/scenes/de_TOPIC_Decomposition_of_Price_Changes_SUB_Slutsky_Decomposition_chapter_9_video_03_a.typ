...
#only("1")[
#voiceover("Großartig! Du hast korrekt den Minimalwert der Funktion f von x gleich x Quadrat minus 4x plus 7 gefunden. Lass uns die Lösung Schritt für Schritt durchgehen.")
]
#only("2")[
