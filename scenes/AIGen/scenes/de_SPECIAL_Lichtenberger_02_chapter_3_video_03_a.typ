...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartig! Das ist das richtige minimale Volumen, damit der Ballon in Uster abheben kann. Jetzt sehen wir uns an, wie wir das Schritt für Schritt berechnen können.")
  ]
  #only("2")[
