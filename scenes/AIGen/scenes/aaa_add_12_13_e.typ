...
#v(40pt)
#only("2-")[Deine Antwort: $5/6$]
#only("1")[
#voiceover("Wir sollen ein halb plus ein Drittel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist fünf sechstel. Das ist vollkommen richtig! Lass uns sehen, wie du zu dieser Antwort gekommen bist.")
]
]
#slide()[
...
#v(40pt)
#only("1-")[Daher ist $1/2 + 1/3 = 5/6$, und das hast du richtig berechnet!]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist ein halb plus ein Drittel gleich fünf Sechstel, und das hast du ganz richtig berechnet!")
]
#only("2")[
