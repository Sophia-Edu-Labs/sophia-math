...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartige Arbeit beim Lösen dieser Gleichung! Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit der Gleichung 2 x hoch 4 gleich 32.")
  ]
  #only("2")[
