...
plt.show()
  ...
  #only("1")[
    #voiceover("It seems you had some trouble with this problem. Let's go through the correct solution step by step. We have a cube with a side length of 5.5 centimeters. Here's a visualization of our cube.")
  ]
]
...
#slide()[
  ...
  #only("1")[
    #voiceover("Now, let's substitute our known value. We're given that the side length is 5.5 centimeters.")
  ]
  #only("2")[
    #voiceover("So we plug 5.5 centimeters in for s in our formula. This gives us: Surface Area equals 6 times 5.5 centimeters squared.")
  ]
]
...
#slide()[
  ...
  #only("1")[
    #voiceover("Now let's calculate. First, we square 5.5 centimeters.")
  ]
  #only("2")[
    #voiceover("5.5 centimeters squared is 30.25 square centimeters. So our equation becomes 6 times 30.25 square centimeters.")
  ]
  #only("3")[
    #voiceover("Finally, we multiply by 6. 6 times 30.25 is 181.5. So the surface area is 181.5 square centimeters.")
  ]
]
...
#slide()[
  ...
  #v(40pt)
  #only("1-")[#text(size: 24pt)[The surface area of the cube is $181.5"cm"^2$]]
  #v(40pt)
  #only("2-")[💡 Remember: Units are important!]
  #only("1")[
    #voiceover("So our final answer is that the surface area of the cube is 181.5 square centimeters.")
  ]
  #only("2")[
