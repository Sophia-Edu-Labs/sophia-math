...
#slide()[
  ...
  #only("1")[
    #voiceover("Leider war das nicht korrekt. Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit der Funktion f von x gleich 2 x hoch 3 plus 3 x hoch 2.")
  ]
