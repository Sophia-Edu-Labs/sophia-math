...
#only("1")[
#voiceover("Leider ist das nicht korrekt. Lass uns trotzdem sehen, wie wir das Schritt für Schritt lösen können. Es ist gegeben, dass die Höhe, auf die das Wasser gehoben werden muss, 30 Meter beträgt.")
]
#only("2")[
