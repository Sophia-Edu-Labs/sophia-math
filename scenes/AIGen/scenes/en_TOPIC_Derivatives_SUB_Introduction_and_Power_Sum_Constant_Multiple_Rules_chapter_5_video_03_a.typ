...
#slide()[
  ...
  #only("1")[
    #voiceover("Great job! That's correct. Let's walk through the solution step by step. We start with the given function f of x equals 7 times x to the sixth power.")
  ]
