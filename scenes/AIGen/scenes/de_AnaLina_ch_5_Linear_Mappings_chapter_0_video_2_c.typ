...
#only("2")[#voiceover("Option a) Vektoraddition ist teilweise korrekt, aber nicht die vollständige Antwort. Eine lineare Abbildung erhält mehr als nur die Vektoraddition.")]
// Sehr kurz über b sprechen und warum es falsch ist
#only("3")[#voiceover("Option b) Skalare Multiplikation ist ebenfalls teilweise korrekt, aber auch hier nicht die vollständige Antwort.")]
// Sehr kurz über c sprechen und warum es korrekt ist
#only("4")[#voiceover("Option c) Sowohl Vektoraddition als auch skalare Multiplikation ist in der Tat die richtige Wahl. Eine lineare Abbildung erhält beide Eigenschaften.")]
...
#v(40pt)
#only("1-")[Lass uns verstehen, warum c) die richtige Antwort ist. 🤔]
#v(20pt)
...
#v(20pt)
#only("6-")[Wenn eine Abbildung beides erhält, ist sie linear. Fehlt eine dieser Eigenschaften, ist sie nicht linear. 🧮]

#only("1")[#voiceover("Lass uns eine Schritt-für-Schritt-Erklärung durchgehen, warum Option c) Sowohl Vektoraddition als auch skalare Multiplikation die richtige Antwort ist.")]
...
#only("6")[#voiceover("Wenn eine Abbildung beide Eigenschaften erhält, ist sie eine lineare Abbildung. Fehlt eine dieser Eigenschaften, ist sie keine lineare Abbildung.")]
]

#slide()[
#text(size: 30pt, weight: "bold")[Zusammenfassung]
#v(40pt)
#only("1-")[- Eine lineare Abbildung erhält sowohl Vektoraddition als auch skalare Multiplikation. ✅]
#v(20pt)
...
#only("1")[#voiceover("Zusammenfassend erhält eine lineare Abbildung sowohl Vektoraddition als auch skalare Multiplikation.")]
...
#only("3")[#voiceover("Diese beiden Eigenschaften sind die entscheidenden Merkmale einer linearen Abbildung.")]
#only("4")[#voiceover("Großartige Arbeit bei der Identifizierung der richtigen Antwort und beim Verständnis der Eigenschaften linearer Abbildungen!")]
]