...
#only("1")[
#voiceover("Das ist nicht ganz richtig. Lass uns die Schritte durchgehen, um die richtige Lösung zu finden.")
]
]
...
#only("2")[
#voiceover("Also ist unser Eingangsvektor (1; 2).")
]
]
...
#only("2")[
#voiceover("Vereinfacht ergibt das T von (1; 2) gleich (2; 6).")
]
]
