...
#only("1-")[- $b_n = 2n/(n+1)$]
#only("1")[
#voiceover("Wir haben die Folge b Index n gleich 2n über n plus 1 gegeben.")
]
]
...
#only("3")[
#voiceover("Das ist gleich 2 über 1 oder einfach 2.")
]
]
...
#only("1")[
#voiceover("Hier ist eine Visualisierung der Folge b Index n. Wenn n größer wird, sehen Sie, dass b Index n, dargestellt in Blau, sich seinem Limit von 2, dargestellt durch die rote gestrichelte Linie, nähert.")
]
]
]
...
#only("1")[
#voiceover("Zusammenfassend ist das Limit der Folge b Index n gleich 2n über n plus 1, wenn n gegen unendlich geht, gleich 2.")
]
#only("2")[
