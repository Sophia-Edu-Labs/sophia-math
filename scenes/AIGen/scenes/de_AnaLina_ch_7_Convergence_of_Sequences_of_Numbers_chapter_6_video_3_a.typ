...
#only("1")[
#voiceover("Großartige Arbeit! Das ist der richtige Ansatz, um zu beweisen, dass die Folge a_n gleich n nach der formalen Definition gegen unendlich divergiert. Gehen wir die Lösung Schritt für Schritt durch.")
]
...
#only("1")[
#voiceover("Um zu beweisen, dass diese Folge gegen unendlich divergiert, müssen wir die formale Definition der Divergenz gegen unendlich verwenden.")
]
...
#only("2")[
#voiceover("Die formale Definition besagt, dass eine Folge a_n gegen unendlich divergiert, wenn für jede reelle Zahl M größer als 0 eine natürliche Zahl N existiert, so dass für alle n größer oder gleich N gilt, dass a_n größer als M ist.")
]
...
#only("1")[
#voiceover("Beginnen wir den Beweis. Sei M eine beliebige reelle Zahl größer als 0.")
]
...
#only("5")[
#voiceover("Nach der formalen Definition der Divergenz gegen unendlich divergiert die Folge a_n gleich n gegen unendlich.")
]
...
// Die Grafik der Folge wird mit matplotlib visualisiert

#only("1")[
#voiceover("Hier ist eine Visualisierung der ersten 10 Glieder der Folge a_n gleich n. Wie Sie sehen können, steigen die Glieder der Folge unbegrenzt an, wenn n zunimmt, was die Divergenz gegen unendlich veranschaulicht.")
]
...
#only("2")[
#voiceover("Wir haben die formale Definition der Divergenz gegen unendlich verwendet.")
]
