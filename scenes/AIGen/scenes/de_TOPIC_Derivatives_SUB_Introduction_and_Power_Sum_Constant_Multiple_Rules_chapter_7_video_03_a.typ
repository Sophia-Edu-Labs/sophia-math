...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartig! Das ist die richtige Antwort. Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit der gegebenen Funktion f von x gleich 4 mal x hoch 4.")
  ]
