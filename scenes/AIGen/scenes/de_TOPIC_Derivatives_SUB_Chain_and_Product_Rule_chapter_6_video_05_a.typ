...
#slide()[
  ...
  #only("1")[
    #voiceover("Gut gemacht beim Lösen dieses Problems! Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit der Funktion f von x gleich x Quadrat mal e hoch x.")
  ]
  #only("2")[
