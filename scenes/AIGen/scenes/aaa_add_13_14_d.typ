...
#only("2")[
#voiceover("Und deine Antwort ist zwei Zwölftel. Das ist schon sehr nah dran, aber noch nicht ganz richtig.")
]
]
#slide()[
#text(size: 30pt, weight: "bold")[Dein Fehler]
#v(40pt)
#only("1-")[Dein Fehler: $ 1/3 + 1/4 ≠ (1+1)/(3 dot 4) $]
#v(20pt)
...
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler einfach addiert und die Nenner multipliziert hast. Ein Drittel plus ein Viertel ist nicht gleich eins plus eins geteilt durch drei mal vier.")
]
#only("2")[
...
#v(40pt)
#only("1-")[Daher ist $1/3 + 1/4 = 7/12$, nicht $2/12$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist ein Drittel plus ein Viertel gleich sieben zwölftel, nicht zwei zwölftel.")
]
#only("2")[
