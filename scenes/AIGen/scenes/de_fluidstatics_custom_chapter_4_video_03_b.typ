...
#only("1")[
#voiceover("Leider ist das nicht korrekt. Lass uns gemeinsam Schritt für Schritt die Lösung durchgehen. Uns wird gegeben, dass der Ballon am Boden auf ein Volumen von 1550 Kubikmetern aufgeblasen wird. Wir haben auch die Werte für die Konstanten a und b in der Luftdichteformel.")
]
]
