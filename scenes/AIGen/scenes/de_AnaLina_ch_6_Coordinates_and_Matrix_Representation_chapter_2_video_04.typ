...
#slide()[
#only("1")[
#voiceover("Lassen Sie uns rekapitulieren: Eine lineare Abbildung kann durch eine Matrix dargestellt werden, die Koordinaten von einer Basis in eine andere transformiert.")
]
...
#only("3")[
#voiceover("Diese lineare Abbildung kann durch eine Matrix dargestellt werden, die durch T in eckigen Klammern mit Index B und Exponent C bezeichnet wird.")
]
#v(20pt)
#only("4-")[
...
#only("4")[
#voiceover("Der Index B repräsentiert die Basis für den Definitionsvektorraum V, und der Exponent C repräsentiert die Basis für den Zielvektorraum W.")
]
#v(20pt)
#only("5-")[
...
green_patch = mpatches.Patch(color='green', label='Vektor v')
magenta_patch = mpatches.Patch(color='magenta', label='Transformierter Vektor Tv')
...
#only("6")[
#voiceover("Dieses Diagramm veranschaulicht das Konzept. Die blauen Pfeile repräsentieren die Standardbasis B, die roten Pfeile repräsentieren eine andere Basis C. Der grüne Pfeil ist ein Vektor v, und der magentafarbene Pfeil ist der transformierte Vektor T von v unter der durch die Matrix T dargestellten linearen Abbildung.")
]
]