...
#v(40pt)
#only("1-")[Dein Fehler: $2/5 + 1/4 ≠ (2+1)/(5 \cdot 4)$]
#v(20pt)
...
visualize_fraction(axs[0], 2, 5, 'blue', '2/5')
# Zweiten Bruch 1/4 auf der Zahlenlinie plotten
visualize_fraction(axs[1], 1, 4, 'red', '1/4')
...
#only("1")[
#voiceover("Hier siehst du die Brüche mit ihren ursprünglichen Nennern. Oben haben wir zwei Fünftel und unten ein Viertel.")
]
#only("2")[
