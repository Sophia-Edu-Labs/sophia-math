...
#v(40pt)
#text(size: 24pt)[Schauen wir uns Schritt für Schritt an, wie wir zu dieser Lösung kommen. 📝]
#only("1")[
#voiceover("Nicht ganz. Gehen wir Schritt für Schritt die korrekte Matrixdarstellung der linearen Abbildung T durch.")
]
]
...
#only("1")[
#voiceover("Wir haben eine lineare Abbildung T von R 2 nach R 2 gegeben.")
]
#only("2")[
...
#slide()[
#text(size: 30pt, weight: "bold")[Schritt 2: Wende $T$ auf Basisvektoren an]
#v(40pt)
#only("1-")[- $T(mat(1;0)) = mat(2;0)$]
#v(20pt)
#only("2-")[- $T(mat(0;1)) = mat(0;3)$]
#only("1")[
#voiceover("T von 1, 0 ist gleich 2 mal 1, 3 mal 0, was zu 2, 0 vereinfacht.")
]
#only("2")[
#voiceover("Ebenso ist T von 0, 1 gleich 2 mal 0, 3 mal 1, was zu 0, 3 vereinfacht.")
]
]
...
#only("2")[
#voiceover("Die Matrixdarstellung von T ist also die Matrix mit den Spalten 2, 0 und 0, 3, was die Matrix 2, 0; 0, 3 ist.")
]
]
...
#only("2-")[$mat(2, 0; 0, 3)$]
#only("1")[
#voiceover("Zusammenfassend ist die Matrixdarstellung der linearen Abbildung T von x, y gleich 2x, 3y:")
]
#only("2")[
