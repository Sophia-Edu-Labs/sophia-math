...
#slide()[
  ...
  #only("1")[
    #voiceover("Keine Sorge, wir gehen die Lösung gemeinsam durch. Lass uns Schritt für Schritt die quadratische Gleichung x Quadrat minus 2x minus 3 gleich null lösen.")
  ]
  #only("2")[
