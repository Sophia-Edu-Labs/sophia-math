...
#only("1")[#voiceover("Nicht ganz, aber lassen Sie uns sehen, warum a) 0 die richtige Antwort ist.")]
...
#v(40pt)
#only("1-")[Lassen Sie uns beweisen, dass $T(0) = 0$ für eine lineare Abbildung $T$ gilt:]
#v(20pt)
#only("2-")[- Per Definition gilt $T(c u) = c T(u)$ für jeden Skalar $c$ und Vektor $u$]
#v(20pt)
#only("3-")[- Setzen wir $c = 0$ und $u$ sei ein beliebiger Vektor. Dann:]
#v(20pt)
#only("4-")[$T(0 u) = 0 T(u)$]
#v(20pt)
#only("5-")[$T(0) = 0$]
...
#only("1")[#voiceover("Nun, lassen Sie uns beweisen, dass $T(0) = 0$ für eine lineare Abbildung $T$ gilt.")]
#only("2")[#voiceover("Per Definition erfüllt eine lineare Abbildung $T(c u) = c T(u)$ für jeden Skalar $c$ und Vektor $u$.")]
#only("3")[#voiceover("Setzen wir $c = 0$ und lassen $u$ ein beliebiger Vektor sein.")]
#only("4")[#voiceover("Dann haben wir $T(0 u) = 0 T(u)$.")]
#only("5")[#voiceover("Da $0 u = 0$ für jeden Vektor $u$ gilt und $0 T(u) = 0$, erhalten wir $T(0) = 0$.")]
#only("6")[#voiceover("Daher haben wir bewiesen, dass $T(0) = 0$ für jede lineare Abbildung $T$ gilt. Dies schließt den Beweis ab.")]
]
