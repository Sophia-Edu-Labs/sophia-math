...
#only("1")[
#voiceover("Großartige Arbeit bei der richtigen Antwort! Lass uns die Lösung Schritt für Schritt durchgehen. Wir müssen einen Schiffsmotor mit einer Masse von 6000 kg um eine Höhe von 2,0 Metern mit einem Hydraulikheber anheben.")
]
#only("2")[
