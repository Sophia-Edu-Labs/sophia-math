...
plt.show()
  ...
  #only("1")[
    #voiceover("Keine Sorge, wir gehen die Lösung gemeinsam durch. Lass uns die Schritte ansehen. Wir haben einen Quader, der 20 Meter lang, 15 Meter breit und 10 Meter hoch ist. Hier ist eine visuelle Darstellung unseres Quaders.")
  ]
]
