...
#only("1")[
#voiceover("Great job! That's the correct answer. Let's see why. We want to determine the behavior of the function f of x equals x to the power of 6 as x approaches infinity.")
]
#only("2")[
