...
plt.show()
  ...
  #only("1")[
    #voiceover("Not quite, but let's go through the correct solution step by step. We're dealing with a cuboid that has dimensions of 12 meters by 7 meters by 5 meters. Here's a visual representation of our cuboid.")
  ]
]
