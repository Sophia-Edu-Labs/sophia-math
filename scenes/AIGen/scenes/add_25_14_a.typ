...
#only("1")[
#voiceover("Die Aufgabe ist, zwei Fünftel plus ein Viertel zu berechnen.")
]
#only("2")[
...
#only("1")[
#voiceover("Hier siehst du die ursprünglichen Brüche. Oben haben wir zwei Fünftel, und unten sehen wir ein Viertel.")
]
#only("2")[
#voiceover("Diese Brüche haben verschiedene Nenner, also teilen wir sie in Stücke verschiedener Größe ein: Oben haben wir Fünftel und rechts Viertel. Deswegen können wir auch nicht einfach die Zähler addieren. Weil wir dann Stücke verschiedenr Größe addieren würden.")
]
#only("3")[
...
#only("3")[
#voiceover("und fünf Zwanzigstel ist gleich ein Viertel. Du siehst, dass auf jeder Seite der Wert gleich ist, wie davor. Lediglich die Darstellung ist anders.")
]
]
