...
#only("1")[#voiceover("Great job! That's the correct answer. Let's walk through the solution step by step. We're given two sequences, a_n equals 1 over n and b_n equals 2 over n squared. We need to find the limit as n approaches infinity of a_n plus b_n, all divided by a_n.")]
]
