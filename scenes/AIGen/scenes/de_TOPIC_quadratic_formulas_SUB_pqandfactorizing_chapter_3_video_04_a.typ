...
#slide()[
  ...
  #only("1")[
    #voiceover("Ausgezeichnete Arbeit! Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit der quadratischen Gleichung x Quadrat minus 3x minus 4 gleich null zu tun.")
  ]
  #only("2")[
