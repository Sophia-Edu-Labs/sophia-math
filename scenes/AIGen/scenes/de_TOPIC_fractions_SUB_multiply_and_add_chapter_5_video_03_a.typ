...
#slide()[
  #only("1")[
    #voiceover("Großartige Arbeit! Du hast den Bruch korrekt geändert. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, wie wir dorthin gekommen sind.")
  ]
