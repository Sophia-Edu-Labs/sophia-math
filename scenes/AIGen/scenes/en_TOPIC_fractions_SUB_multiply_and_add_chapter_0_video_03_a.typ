...
#only("1")[
#voiceover("Great job on solving this multiplication problem! Let's go through the solution step by step. We start with seven-eighths multiplied by four-ninths.")
]
