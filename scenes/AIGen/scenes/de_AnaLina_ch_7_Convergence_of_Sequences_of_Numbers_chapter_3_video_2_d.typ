...
#only("2")[#voiceover("b) kleiner als epsilon. Die Definition besagt, dass der absolute Unterschied zwischen a_n und L für alle n größer oder gleich einem N kleiner als epsilon sein muss.")]
...
#only("4")[#voiceover("c) gleich epsilon ist auch falsch. Der Unterschied muss nicht genau gleich epsilon sein, sondern nur kleiner als epsilon.")]
...
#only("1")[#voiceover("Nun gehen wir die Definition Schritt für Schritt durch.")]
...
#only("2")[
#voiceover("Mit zunehmendem n kommen die Glieder immer näher an 0 heran. Für jedes gewählte epsilon können wir ein N finden, so dass für alle n größer als N die Glieder innerhalb von epsilon um 0 liegen.")
]
#only("3")[
