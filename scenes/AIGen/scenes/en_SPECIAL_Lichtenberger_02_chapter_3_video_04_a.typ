...
#only("1")[
#voiceover("Great job! That's the correct answer. Let's solve this step by step. We know that the balloon is inflated to a volume of 1550 cubic meters at the start in Uster.")
]
#only("2")[
