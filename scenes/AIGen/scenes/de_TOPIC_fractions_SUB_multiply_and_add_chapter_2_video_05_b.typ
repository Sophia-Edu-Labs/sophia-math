...
#slide()[
  ...
  #only("1")[
    #voiceover("Keine Sorge, das war ein guter Versuch! Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit der Multiplikation von 5/8 und 7/9.")
  ]
