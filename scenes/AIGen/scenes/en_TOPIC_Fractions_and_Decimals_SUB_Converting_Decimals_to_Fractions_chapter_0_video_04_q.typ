...
#v(40pt)
#only("1-")[Consider decimal number $0.7$]
// The question is shown from slide 1 onward
#v(40pt)
#only("2-")[$arrow$ Convert it to a fraction $square/square$!]
#only("1")[#voiceover("Let's test your knowledge on converting decimals to fractions. Consider the decimal number zero point seven.")]
#only("2")[#voiceover("Can you convert it into a fraction, where we divide one number by another?")]
]

//Type: FREE 
#questionDef( 
questionText: "What fraction is $0.7$ equal to?", 
