...
#only("1")[
#voiceover("Keine Sorge, wir gehen die Lösung Schritt für Schritt durch. Lass uns die quadratische Gleichung mit der p-q-Formel lösen. Wir beginnen mit der Gleichung x Quadrat minus 3x plus 2 gleich 0.")
]
#only("2")[
