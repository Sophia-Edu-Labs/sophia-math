...
#only("1")[
#voiceover("Das stimmt leider nicht. Lass uns sehen, warum. Wir wollen das Verhalten der Funktion f von x gleich x hoch 6 bestimmen, wenn x gegen unendlich geht.")
]
#only("2")[
