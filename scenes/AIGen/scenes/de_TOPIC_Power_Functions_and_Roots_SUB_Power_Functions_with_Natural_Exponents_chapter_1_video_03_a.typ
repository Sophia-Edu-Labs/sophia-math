...
#only("1")[
#voiceover("Großartig! Das ist absolut korrekt. Der Graph der Funktion f von x gleich x hoch 4 ist tatsächlich eine Parabel, aber steiler als der Graph von f von x gleich x quadrat. Lass uns sehen, warum.")
]
]
]
