...
plt.show()
  ...
  #only("1")[
    #voiceover("Let's review the correct solution step-by-step. We have a composite figure made up of two cubes: one with a side length of 4 cm and another with a side length of 2 cm, joined at one face.")
  ]
]
