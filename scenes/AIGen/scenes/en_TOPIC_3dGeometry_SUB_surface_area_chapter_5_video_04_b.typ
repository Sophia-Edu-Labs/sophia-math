...
#slide()[
  ...
  #only("1")[
    #voiceover("Not quite, but no worries! Let's walk through the correct solution step-by-step. We have a rectangular prism with a cylindrical hole drilled through its center.")
  ]
