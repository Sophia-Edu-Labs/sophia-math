...
#slide()[
  ...
  #only("1")[
    #voiceover("Great job! You've got the correct answer. Let's walk through the solution step-by-step. We start with the function f of x equals 2 x cubed plus 3 x squared.")
  ]
