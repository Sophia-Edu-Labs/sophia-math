...
#v(40pt)
#only("2-")[Deine Antwort: $2/24$]
#only("1")[
#voiceover("Unsere Aufgabe ist es, ein Viertel plus ein Sechstel zu berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist zwei Vierundzwanzigstel. Das ist schon sehr nah dran, aber noch nicht ganz richtig.")
]
]
#slide()[
#text(size: 30pt, weight: "bold")[Dein Fehler]
#v(40pt)
#only("1-")[Dein Fehler: $ 1/4 + 1/6 ≠ (1+1)/(4 dot 6) $]
#v(20pt)
...
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler einfach addiert und die Nenner multipliziert hast. Ein Viertel plus ein Sechstel ist nicht gleich eins plus eins geteilt durch vier mal sechs.")
]
#only("2")[
...
#v(40pt)
#only("1-")[Daher ist $1/4 + 1/6 = 5/12$, nicht $2/24$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist ein Viertel plus ein Sechstel gleich fünf Zwölftel, nicht zwei Vierundzwanzigstel.")
]
#only("2")[
