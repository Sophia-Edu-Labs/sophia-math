...
#slide()[
  ...
  #only("1")[
    #voiceover("Great job on tackling this question! Let's walk through the solution step-by-step. We're dealing with a power function f of x equals 4 times x cubed.")
  ]
  #only("2")[
