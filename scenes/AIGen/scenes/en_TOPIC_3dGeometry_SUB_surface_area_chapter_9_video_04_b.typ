...
plt.show()
  ...
  #only("1")[
    #voiceover("Don't worry about the mistake. Let's go through the correct solution step-by-step. We have a composite figure consisting of a cuboid with dimensions 7 cm by 6 cm by 5 cm, and a cube with side length 4 cm on top of it. Our task is to find the total surface area.")
  ]
]
