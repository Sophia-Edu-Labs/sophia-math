...
#v(40pt)
#only("1-")[Betrachte die Dezimalzahl $0.33$]
// Die Frage wird ab Folie 1 angezeigt
#v(40pt)
#only("2-")[$arrow$ Wandle sie in einen Bruch $square/square$ um!]
#only("1")[#voiceover("Lass uns dein Wissen über die Umwandlung von Dezimalzahlen in Brüche testen. Betrachte die Dezimalzahl null Komma drei drei.")]
#only("2")[#voiceover("Kannst du sie in einen Bruch umwandeln, bei dem wir eine Zahl durch eine andere teilen?")]
]

//Typ: FREI 
#questionDef( 
questionText: "Welchem Bruch entspricht $0.33$?", 
answerOptions: ("$\\frac{33}{100}$", "Die Antwort ist falsch."),
