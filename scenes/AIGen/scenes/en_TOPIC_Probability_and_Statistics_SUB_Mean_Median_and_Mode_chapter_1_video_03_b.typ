...
#only("1")[
#voiceover("Nice try! Let's review the correct solution and go over the concept of the median. The median is the middle number in a sorted list of numbers.")
]
#only("2")[
