...
#only("1")[#voiceover("Not quite. Let's go over the correct solution and see why b) reflects across the x-axis is the right answer, and why the other options are incorrect.")]
