...
#slide()[
  ...
  #only("2")[
    #voiceover("Here's your task: Solve the quadratic equation x squared minus 4x plus 3 equals 0 using the p-q formula.")
  ]
]

//Type: Numeric
#questionDef(
questionText: "Solve the quadratic equation $x^2 - 4x + 3 = 0$ using the p-q formula.", 
