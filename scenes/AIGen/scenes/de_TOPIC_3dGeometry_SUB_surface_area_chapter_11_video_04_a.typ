...
plt.show()
  ...
  #only("1")[
    #voiceover("Ausgezeichnete Arbeit! Das ist die richtige Antwort. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben eine zusammengesetzte Figur, die aus einem Quader mit den Maßen 15 cm mal 10 cm mal 8 cm und einem Würfel mit einer Seitenlänge von 6 cm oben drauf besteht. Hier ist eine Visualisierung unserer zusammengesetzten Figur.")
  ]
]
