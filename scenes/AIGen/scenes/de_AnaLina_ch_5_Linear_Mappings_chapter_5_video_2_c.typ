...
#v(40pt)
Was hilft uns die Dimensionsformel zu verstehen?
#v(40pt)
...
#only("3")[#voiceover("Option b ist falsch. Obwohl der Definitionsbereich und der Zielbereich wichtige Aspekte einer linearen Abbildung sind, bezieht sich die Dimensionsformel nicht direkt auf sie.")]
...
#only("2")[#voiceover("Was die Formel uns also sagt, ist:")]
...
#only("4")[#voiceover("Und der Pfeil repräsentiert die lineare Abbildung T selbst und zeigt, wie Vektoren vom Definitionsbereich zum Zielbereich transformiert werden.")]
