...
#v(10pt)
#only("3-")[b) It leads to following the crowd 🏃‍♂️🏃‍♀️]
#v(10pt)
#only("4-")[c) It has no effect 🤷]
#v(10pt)
#only("5-")[d) It improves rationality 🧠]
#only("1")[#voiceover("Let's test your understanding of herd behavior. How can herd behavior affect financial decisions?")]
