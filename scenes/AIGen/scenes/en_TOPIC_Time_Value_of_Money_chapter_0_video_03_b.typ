...
#only("1")[
#voiceover("That's not quite right. Let's review the correct solution step by step. We are given the present value of €100, an annual interest rate of 5%, and we want to know the future value after 1 year.")
]
#only("2")[
