...
#only("1")[
#voiceover("Great job! You've correctly answered that two plus two plus two plus two equals eight. Let's walk through the solution step by step to understand why.")
]
