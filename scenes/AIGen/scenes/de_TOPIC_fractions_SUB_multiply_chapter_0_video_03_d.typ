...
#only("1")[#voiceover("Keine Sorge, das war nicht ganz richtig. Lass uns die Lösung Schritt für Schritt durchgehen.")]
#only("2")[#voiceover("Die richtige Antwort ist c) 8/3. Nun, lass uns sehen, warum das die richtige Antwort ist.")]
...
#only("1")[#voiceover("Zuerst schreiben wir die ganze Zahl 4 als Bruch, also vier über eins.")]
...
#only("4")[#voiceover("Schließlich kombinieren wir die Ergebnisse zu acht Drittel.")]
]
...
#only("2")[#voiceover("Vier über eins stellt die ganze Zahl vier als Bruch dar.")]
...
#only("2")[#voiceover("Zum Beispiel ergibt vier mal zwei Drittel acht Drittel.")]
