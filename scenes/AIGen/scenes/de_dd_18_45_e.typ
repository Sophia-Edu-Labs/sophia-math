...
#only("1")[
#voiceover("Hier siehst du die Brüche mit ihren ursprünglichen Nennern. Oben haben wir ein Achtel und unten vier Fünftel.")
]
#only("2")[
#voiceover("Diese Brüche haben verschiedene Nenner, also teilen wir sie in Stücke verschiedener Größe ein: Oben haben wir Achtel und unten Fünftel. Das bedeutet, dass wir sie nicht direkt addieren können.")
]
#only("3")[
...
# Ersten Bruch 5/40 plotten
visualize_fraction(axs[0], 5, 40, 'red', '5/40')
# Zweiten Bruch 32/40 plotten
...
# Summe der Brüche 5/40 und 32/40 plotten
