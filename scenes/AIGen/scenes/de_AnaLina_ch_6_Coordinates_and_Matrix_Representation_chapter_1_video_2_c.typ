...
#only("1")[#voiceover("Lassen Sie uns tiefer in das Konzept eintauchen, was es bedeutet, dass Vektoren einen Raum aufspannen.")]
...
#only("3")[#voiceover("Zum Beispiel im zweidimensionalen reellen Raum R 2 spannen die Standardbasisvektoren (1; 0) und (0; 1) den gesamten Raum auf.")]
...
#only("4")[#voiceover("Wie Sie sehen können, kann jeder blaue Pfeil, d.h. jeder Vektor in R 2, durch eine Kombination der roten und grünen Basisvektoren erreicht werden. Dies bedeutet, dass die Basisvektoren den Raum aufspannen.")]
]
