...
#only("3")[#voiceover("b) $w = v$ für ein $v$ in $V$ ist falsch. Das würde bedeuten, dass das Bild dasselbe wie der Definitionsbereich ist, was nicht unbedingt für eine lineare Abbildung zutrifft.")]
// Sehr kurz über c sprechen und warum es falsch ist
#only("4")[#voiceover("c) $w = 0$ ist ebenfalls falsch. Während der Nullvektor Teil des Bildes sein kann, ist er nicht das einzige Element. Das Bild kann viele andere Vektoren enthalten.")]
...
#only("2")[#voiceover("Durch Lösen erhalten wir $x gleich a plus b durch 2$, und $y gleich a minus b durch 2$.")]
