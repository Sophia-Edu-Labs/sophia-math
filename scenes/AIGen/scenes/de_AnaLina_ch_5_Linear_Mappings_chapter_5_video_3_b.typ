...
#only("1")[
#voiceover("Nicht ganz. Gehen wir die richtige Lösung Schritt für Schritt gemeinsam durch.")
]
]
...
#v(40pt)
#only("1-")[- Verwende die Dimensionsformel 📏]
#only("1")[
...
#only("1-")[$ "dim"(ℝ^4) = 4 $]
#only("1")[
#voiceover("Erinnern Sie sich zunächst daran, dass die Dimension von ℝ^4 gleich 4 ist.")
]
#v(20pt)
...
#only("3-")[$ 4 = 2 + "dim"("im"(T)) $]
#only("3")[
#voiceover("Setzen wir die gegebenen Werte ein, erhalten wir 4 gleich 2 plus der Dimension des Bildes von T.")
]
#v(20pt)
#only("4-")[$ "dim"("im"(T)) = 4 - 2 = 2 $]
#only("4")[
#voiceover("Lösen wir nach der Dimension des Bildes auf, erhalten wir 2.")
]
#v(20pt)
#only("5-")[🎉 $ "dim"("im"(T)) = 2 $]
#only("5")[
#voiceover("Daher ist die Dimension des Bildes von T gleich 2.")
]
]
...
#only("1")[
#voiceover("Die durch die Dimensionsformel gezeigte Beziehung besteht darin, dass die Summe der Dimensionen des Kerns und des Bildes einer linearen Abbildung der Dimension ihres Definitionsbereichs entspricht.")
]
#v(20pt)
...
#only("2")[
#voiceover("Wir haben festgestellt, dass die Dimension des Bildes 2 ist.")
]
#only("3")[
