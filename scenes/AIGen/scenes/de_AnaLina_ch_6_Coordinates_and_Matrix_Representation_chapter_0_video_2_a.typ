...
#only("2")[#voiceover("Erstens, erinnern wir uns daran, dass in einem Vektorraum jeder Punkt ein einzigartiges Koordinatenset hat.")]
...
#only("4")[#voiceover("Wie wir sehen können, identifizieren die Koordinaten 2, 3 eindeutig diesen spezifischen Punkt im Vektorraum. Kein anderer Punkt hat diese gleichen Koordinaten.")]
]
