...
#slide()[
  #only("1")[
    #voiceover("Großartig! Du hast die Brüche korrekt addiert. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, warum 3/4 die richtige Antwort ist.")
  ]
