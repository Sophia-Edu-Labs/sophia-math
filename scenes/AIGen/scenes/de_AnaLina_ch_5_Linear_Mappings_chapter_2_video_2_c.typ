...
#only("4")[#voiceover("Also wird jeder Vektor im Kern auf den Nullvektor abgebildet, wenn Sie die lineare Abbildung $T$ darauf anwenden.")]
]
...
#v(20pt)
#only("1-")[
- Die blauen Pfeile stellen die Abbildung $T$ dar 🔵
]
#v(10pt)
#only("2-")[
...
#only("1")[#voiceover("In dieser Visualisierung stellen die blauen Pfeile die lineare Abbildung $T$ dar, die auf jeden Punkt in der Ebene angewendet wird.")]

#only("2")[#voiceover("Die rote Linie, die in diesem Fall die x-Achse ist, stellt den Kern von $T$ dar. Alle Punkte auf dieser Linie werden durch $T$ auf Null abgebildet.")]
]
...
#only("2")[#voiceover("Es ist formal definiert als die Menge aller Vektoren $v$ im Definitionsbereich $V$, sodass $T$ von $v$ gleich Null ist.")]
