...
#slide()[
#text(size: 30pt, weight: "bold")[Einen Vektorraum aufspannen]
#v(40pt)
...
#only("1")[#voiceover("Lassen Sie uns tiefer eintauchen, was es bedeutet, dass Vektoren einen Raum aufspannen.")]
...
#only("2")[#voiceover("In diesem Diagramm repräsentieren die roten und grünen Pfeile die Basisvektoren (1; 0) bzw. (0; 1).")]
