...
#slide()[
#only("1")[
#voiceover("Großartige Arbeit! Du hast die vereinfachte Form korrekt identifiziert. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, warum dies korrekt ist.")
]
