...
#only("2")[
#voiceover("Und deine Antwort ist acht Fünfzehntel. Das ist vollkommen richtig! Lass uns sehen, wie du zu dieser Antwort gekommen bist.")
]
]
#slide()[
...
#v(40pt)
#only("1-")[Daher ist $1/3 + 1/5 = 8/15$, und das hast du richtig berechnet!]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist ein Drittel plus ein Fünftel gleich acht Fünfzehntel, und das hast du ganz richtig berechnet!")
]
#only("2")[
