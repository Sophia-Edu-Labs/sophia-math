...
#only("2")[#voiceover("Is it overconfidence, where individuals overestimate their own abilities,")]
#only("3")[#voiceover("or is it confirmation bias, the tendency to search for information that confirms one's preconceptions,")]
#only("4")[#voiceover("or maybe loss aversion, the tendency to prefer avoiding losses over acquiring equivalent gains,")]
