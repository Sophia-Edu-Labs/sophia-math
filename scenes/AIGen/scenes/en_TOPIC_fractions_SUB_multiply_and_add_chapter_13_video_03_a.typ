...
#slide()[
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's go through the solution step by step to understand how we change five-sixths to an equivalent fraction with a denominator of 12.")
  ]
