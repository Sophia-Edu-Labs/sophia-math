...
#slide()[
#text(size: 30pt, weight: "bold")[Abbildung lineare Abbildung]
// Der Titel "Abbildung lineare Abbildung" wird auf dieser Folie angezeigt
#v(40pt)
#only("1-")[Um das Bild eines Vektors unter einer linearen Abbildung zu finden, ____ wir die Matrix mit dem Vektor.]
...
#only("1")[#voiceover("Lassen Sie uns Ihr Verständnis von linearen Abbildungen testen. Um das Bild eines Vektors unter einer linearen Abbildung zu finden, was machen wir mit der Matrix und dem Vektor?")]
