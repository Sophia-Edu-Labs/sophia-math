...
#slide()[
  #only("1")[
    #voiceover("Ausgezeichnete Arbeit! Du hast die Kettenregel korrekt angewendet, um dieses Problem zu lösen. Lass uns die Lösung Schritt für Schritt durchgehen, um den Prozess besser zu verstehen.")
  ]
