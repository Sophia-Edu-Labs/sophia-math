...
#slide()[
  ...
  #only("1")[#voiceover("Das war knapp! Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit der Gleichung x Quadrat minus 9x plus 14 gleich null.")]
