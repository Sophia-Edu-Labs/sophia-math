...
#slide()[
#text(size: 30pt, weight: "bold")[Darstellung der linearen Abbildung]
#v(40pt)
...
#only("1")[#voiceover("Nicht ganz, aber keine Sorge. Schauen wir uns die richtige Lösung an.")]
#only("2")[#voiceover("Ein Vektor ist falsch. Während ein Vektor ein Element ist, auf das eine lineare Abbildung wirken kann, stellt er nicht die Abbildung selbst dar.")]
...
#only("3")[#voiceover("Wenn wir eine Matrix mit einem Vektor multiplizieren, führt sie eine lineare Transformation an diesem Vektor durch und transformiert seine Koordinaten.")]
#only("4")[#voiceover("Genauer gesagt, die Spalten der Matrix sind die Bilder der Basisvektoren unter der linearen Transformation. Die Matrix definiert also die Abbildung vollständig.")]
]
...
#only("4")[#voiceover("Daher hat die Matrixdarstellung von T diese transformierten Basisvektoren als ihre Spalten. Es ist die Matrix 2, 0; 0, 3.")]
]
...
#v(20pt)
#only("4-")[Großartige Arbeit bei dieser Frage! 🌟 Sie beherrschen das Konzept der linearen Abbildungen und ihrer Matrixdarstellungen. Weiter so! 😄]
...
#only("4")[#voiceover("Großartige Arbeit bei dieser Frage! Sie beherrschen das Konzept der linearen Abbildungen und ihrer Matrixdarstellungen. Weiter so!")]
]