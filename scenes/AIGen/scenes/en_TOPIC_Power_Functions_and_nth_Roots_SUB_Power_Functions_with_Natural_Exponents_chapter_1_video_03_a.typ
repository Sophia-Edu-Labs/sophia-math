...
#only("1")[
#voiceover("Great job on attempting the question! Let's go through the solution step-by-step. We start with the function f of x equals x to the power of 4.")
]
#only("2")[
