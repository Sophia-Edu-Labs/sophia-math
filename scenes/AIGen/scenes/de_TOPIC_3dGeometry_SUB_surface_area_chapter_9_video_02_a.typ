...
```
  ...
  #only("1")[
    #voiceover("Großartig! Das ist korrekt. Lass uns die Lösung Schritt für Schritt durchgehen, um zu verstehen, wie wir auf die Höhe von 5 cm für diesen Quader kommen.")
  ]
]
