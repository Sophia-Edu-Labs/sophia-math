...
#only("1")[
#voiceover("Großartige Arbeit bei der Beantwortung dieser Frage! Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit der gegebenen Funktion f von x gleich x hoch drei.")
]
