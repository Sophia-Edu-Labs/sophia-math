...
#only("1")[
#voiceover("Das ist leider falsch. Lösen wir das ganze nochmal zusammen. Zunächst fassen wir die gegebenen Informationen zusammen: Die Zaubertasse lässt bei jeder Nutzung entweder 1, 2, 3, 4 oder 5 Eurostücke erscheinen, und zwar mit gleichen Wahrscheinlichkeiten für jede Menge.")
]
]
