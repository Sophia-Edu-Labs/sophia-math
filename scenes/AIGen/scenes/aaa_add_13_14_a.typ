...
#v(40pt)
#only("2-")[Deine Antwort: $1/7$]
#only("1")[
#voiceover("Wir wollen ja ein Drittel plus ein Viertel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist ein siebtel. Das ist leider Falsch.")
]
]
...
#v(40pt)
#only("1-")[Dein Fehler: $ 1/3 + 1/4 ≠ 1/(3+4) $]
#v(20pt)
#only("2-")[🛠️ Du kannst die Nenner nicht einfach nur addieren]
#v(20pt)
#only("3-")[🛠️ Du musst auch die Zähler anpassen]
#only("1")[
#voiceover("Dein Fehler ist, dass du die Nenner direkt addiert hast. ein drittel plus ein viertel ist nicht gleich 1 geteilt durch 3 plus 4.")
]
#only("2")[
...
#only("3")[
#voiceover("Die Vielfachen von 4 sind 4, 8, 12, 16 und so weiter.")
]
#only("4")[
#voiceover("Das kleinste gemeinsame Vielfache von 3 und 4 ist 12. Das ist unser gemeinsamer Nenner.")
]
]
...
#only("1")[
#voiceover("Als nächstes erweiterst du die Brüche, so dass sie den gemeinsamen Nenner 12 haben.")
]
#only("2")[
...
#v(40pt)
#only("1-")[Daher ist $1/3 + 1/4 = 7/12$, nicht $1/7$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beim Addieren von Brüchen, finde zuerst den gemeinsamen Nenner!]
#only("1")[
#voiceover("Daher ist ein drittel plus ein viertel gleich sieben zwölftel, nicht ein siebtel.")
]
#only("2")[
