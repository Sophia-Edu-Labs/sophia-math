...
#only("1")[
#voiceover("Great job! That's the correct answer. Let's see how we can solve this step-by-step. We are given that the price of good X decreases from 10 dollars to 8 dollars.")
]
#only("2")[
