...
#slide()[
#only("1")[
#voiceover("Lass uns rekapitulieren, wie man die Matrixdarstellung einer linearen Abbildung bezüglich einer neuen Basis findet.")
]
...
#v(20pt)
#only("3")[
#voiceover("Um dies zu tun, müssen wir die ursprüngliche Matrixdarstellung von $T$, nennen wir sie $A$, mit der Basiswechselmatrix multiplizieren, die wir als $P$ bezeichnen.")
]
#only("3-")[
...
#v(20pt)
#only("4")[
#voiceover("Die Basiswechselmatrix $P$ ist die Matrix, die Koordinaten von der Standardbasis zur neuen Basis $B$ transformiert.")
]
#only("4-")[
...
#v(20pt)
#only("5")[
#voiceover("Die Matrixdarstellung von $T$ bezüglich der neuen Basis $B$ ergibt sich also durch das Produkt $P A P^(-1)$.")
]
#only("5-")[
$[T]_B = P A P^(-1)$
]
...
#slide()[
#only("1")[
#voiceover("Lass uns diesen Prozess visualisieren.")
]
...
#only("3")[
#voiceover("Die Basiswechselmatrix $P$ transformiert Koordinaten von der Standardbasis zur neuen Basis.")
]
#only("4")[
...
#only("3")[
#voiceover("die Basiswechselmatrix $P$, die Koordinaten von der Standardbasis zur neuen Basis transformiert,")
]
#only("4")[
