...
plt.show()
  ...
  #only("1")[
    #voiceover("Keine Sorge, wir gehen die Lösung gemeinsam durch. Hier ist eine Visualisierung unseres Quaders mit einer Länge von 9 Zentimetern, einer Breite von 5 Zentimetern und einer Höhe von 3 Zentimetern.")
  ]
]
