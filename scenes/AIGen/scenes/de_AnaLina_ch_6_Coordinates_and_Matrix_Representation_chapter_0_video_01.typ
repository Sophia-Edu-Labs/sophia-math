...
#only("2")[
#voiceover("In R2 benötigen wir zwei Koordinaten, typischerweise x und y genannt.")
]
#only("3")[
#voiceover("In R3 benötigen wir drei Koordinaten, normalerweise x, y und z genannt.")
]
]
