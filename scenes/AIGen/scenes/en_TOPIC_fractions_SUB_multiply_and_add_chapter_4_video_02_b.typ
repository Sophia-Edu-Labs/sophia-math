...
#slide()[
  ...
  #only("1")[
    #voiceover("That's okay, let's review the correct solution step by step to understand how we change one-third to an equivalent fraction with a denominator of 6.")
  ]
