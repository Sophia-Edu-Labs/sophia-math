...
#only("1")[
#voiceover("Great job on answering the question correctly! Let's go over the solution step-by-step. The mode is the number that appears most frequently in a data set.")
]
#only("2")[
