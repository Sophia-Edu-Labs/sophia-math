...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job! Let's walk through the solution step-by-step. We're dealing with the power function f of x equals 10 divided by x. Our task is to find f of 2.")
  ]
]
