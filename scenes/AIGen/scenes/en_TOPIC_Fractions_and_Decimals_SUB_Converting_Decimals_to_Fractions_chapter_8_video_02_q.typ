...
#v(40pt)
#only("1-")[Consider the decimal number $2.345$]
// The question is shown from slide 1 onward
#v(40pt)
#only("2-")[$arrow$ Convert it to a fraction $square/square$!]
#only("1")[#voiceover("Let's test your knowledge on converting complex decimals to fractions. Consider the decimal number two point three four five.")]
#only("2")[#voiceover("Can you convert it into a fraction, where we divide one number by another?")]
]

//Type: FREE 
#questionDef( 
questionText: "What fraction is $2.345$ equal to?", 
answerOptions: ("$\\frac{2345}{1000}$", "The answer is incorrect."),
