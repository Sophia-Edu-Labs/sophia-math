...
#slide()[
#text(size: 30pt, weight: "bold")[Grundlagen und Koordinaten Rückblick 🎓]
#v(40pt)
#only("1-")[- Grundlage: Menge von Vektoren, die einen Vektorraum aufspannen 🌌]
#v(20pt)
#only("2-")[- Koordinaten: relativ zur Grundlage ausgedrückt 📍]
#only("1")[
#voiceover("Lassen Sie uns wiederholen, was wir über Grundlagen und Koordinaten gelernt haben. Eine Grundlage ist eine Menge von Vektoren, die einen Vektorraum aufspannen.")
]
#only("2")[
#voiceover("Koordinaten werden relativ zu dieser Grundlage ausgedrückt.")
]
]

#slide()[
#text(size: 30pt, weight: "bold")[Beispiel für Grundlage]
#v(40pt)
#only("1-")[
#box()[
...
#slide()[
#text(size: 30pt, weight: "bold")[Beispiel für Koordinaten]
#v(40pt)
#only("1-")[- Betrachten Sie den Vektor $v = mat(2; 3)$ in $RR^2$]
#v(20pt)
...
#v(40pt)
#only("1-")[- Grundlage: Menge von aufspannenden Vektoren 🌌]
#v(20pt)
#only("2-")[- Koordinaten: relativ zur Grundlage 📍]
#v(20pt)
#only("3-")[- Schlüsselkonzepte der linearen Algebra 🔑]
#only("1")[
#voiceover("Zusammenfassend ist eine Grundlage eine Menge von Vektoren, die einen Vektorraum aufspannen.")
]
#only("2")[
#voiceover("Koordinaten werden relativ zu dieser Grundlage ausgedrückt.")
]
