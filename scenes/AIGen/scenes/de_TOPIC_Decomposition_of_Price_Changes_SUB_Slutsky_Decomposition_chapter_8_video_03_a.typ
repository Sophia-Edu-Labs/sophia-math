...
#slide()[
#only("1")[
#voiceover("Großartig! Das ist ein perfektes Szenario, bei dem die Hicks-Zerlegung möglicherweise besser geeignet ist. Lass es uns Schritt für Schritt durchgehen.")
]
