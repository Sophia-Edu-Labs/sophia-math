...
#slide()[
  #only("1")[
    #voiceover("Großartige Arbeit! Du hast diese Brüche korrekt addiert. Lass uns Schritt für Schritt die Lösung durchgehen, um zu verstehen, warum das funktioniert.")
  ]
