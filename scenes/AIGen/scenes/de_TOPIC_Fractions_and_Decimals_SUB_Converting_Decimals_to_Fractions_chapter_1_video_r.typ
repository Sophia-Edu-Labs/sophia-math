...
#only("2")[
#voiceover("Wir wollen diese Zahl als Bruch ausdrücken, also etwas über etwas.")
]
#only("3")[
...
#only("3")[
#voiceover("Teile dann fünfundsiebzig durch hundert, weil es zwei Dezimalstellen gibt. Also, fünfundsiebzig über hundert.")
]
]
