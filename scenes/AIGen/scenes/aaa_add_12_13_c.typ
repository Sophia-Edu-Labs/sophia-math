...
#v(40pt)
#only("2-")[Deine Antwort: $1/6$]
#only("1")[
#voiceover("Wir sollen ein halb plus ein Drittel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist ein sechstel. Das ist zwar nah dran, aber leider nicht ganz richtig.")
]
]
#slide()[
#text(size: 30pt, weight: "bold")[Dein Fehler]
#v(40pt)
#only("1-")[Dein Fehler: $ 1/2 + 1/3 ≠ 1/(2 dot 3) $]
#v(20pt)
#only("2-")[🛠️ Du kannst die Nenner nicht einfach multiplizieren]
#v(20pt)
#only("3-")[🛠️ Du musst auch die Zähler anpassen]
#only("1")[
#voiceover("Dein Fehler ist, dass du die Nenner multipliziert hast. Ein halb plus ein Drittel ist nicht gleich eins geteilt durch zwei mal drei.")
]
#only("2")[
...
#v(40pt)
#only("1-")[Daher ist $1/2 + 1/3 = 5/6$, nicht $1/6$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beim Addieren von Brüchen, finde zuerst den gemeinsamen Nenner und passe dann die Zähler an!]
#only("1")[
#voiceover("Daher ist ein halb plus ein Drittel gleich fünf sechstel, nicht ein sechstel.")
]
#only("2")[
