...
#v(40pt)
#only("1-")[- $rho_"air"(h) = a dot e^(-b dot h)$]
#v(20pt)
#only("2-")[- $a = 1.247 "kg"/m^3$]
#v(20pt)
#only("3-")[- $b = 0.000104$]
#v(20pt)
...
#v(20pt)
#only("2-")[$rho_"air"(2000) = 1.247 dot e^(-0.000104 dot 2000)$]
#v(20pt)
#only("3-")[2. Simplify the exponent:]
#v(20pt)  
#only("4-")[$rho_"air"(2000) = 1.247 dot e^(-0.208)$]
#v(20pt)
#only("5-")[3. Calculate the result:]
#v(20pt)
#only("6-")[$rho_"air"(2000) = 1.013"kg"/m^3$]
#only("1")[
...
#v(20pt)
#only("2-")[- The formula $rho_"air"(h) = a dot e^(-b dot h)$ models this relationship]
#v(20pt)  
