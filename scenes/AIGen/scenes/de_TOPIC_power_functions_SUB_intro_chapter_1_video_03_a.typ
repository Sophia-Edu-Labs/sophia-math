...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartige Arbeit bei der Bearbeitung dieses Problems! Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit einer kubischen Funktion zu tun, f von x gleich 2x hoch 3 plus 3x hoch 2 plus x plus 1.")
  ]
  #only("2")[
