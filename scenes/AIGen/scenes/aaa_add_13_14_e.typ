...
#only("2")[
#voiceover("Und deine Antwort ist sieben Zwölftel. Das ist vollkommen richtig! Lass uns sehen, wie du zu dieser Antwort gekommen bist.")
]
]
#slide()[
...
#v(40pt)
#only("1-")[Daher ist $1/3 + 1/4 = 7/12$, und das hast du richtig berechnet!]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist ein Drittel plus ein Viertel gleich sieben Zwölftel, und das hast du ganz richtig berechnet!")
]
#only("2")[
