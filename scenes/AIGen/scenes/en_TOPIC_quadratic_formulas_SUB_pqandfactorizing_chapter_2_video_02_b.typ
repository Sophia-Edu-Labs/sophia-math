...
#slide()[
  ...
  #only("1")[
    #voiceover("Not quite, but let's go through the correct solution step-by-step. First, recall that a quadratic equation has the general form a x squared plus b x plus c equals zero.")
  ]
  #only("2")[
