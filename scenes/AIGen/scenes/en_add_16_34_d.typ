...
#v(40pt)
//Antwort des Schülers: $11/12$
#only("2-")[Deine Antwort: $11/12$]
#only("1")[
#voiceover("Wir sollen ein Sechstel plus drei Viertel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist elf Zwölftel. Das ist richtig!")
]
]
...
#v(40pt)
#only("1-")[Deine Lösung: $1/6 + 3/4 = 11/12$]
#v(20pt)
#only("2-")[👍 Gut gemacht! Du hast die Brüche korrekt addiert]
#v(20pt)
#only("3-")[🔍 Schauen wir uns das noch einmal genauer an]
#only("1")[
#voiceover("Du hast ein Sechstel plus drei Viertel korrekt berechnet und das Ergebnis ist elf Zwölftel.")
]
#only("2")[
...
#only("2")[
#voiceover("Diese Brüche haben verschiedene Nenner, also teilen wir sie in Stücke verschiedener Größe ein: Links haben wir Sechstel und rechts Viertel. Das bedeutet, dass wir sie nicht direkt addieren können.")
]
#only("3")[
...
# Ersten Bruch 2/12 plotten
visualize_fraction(axs[0], 2, 12, 'blue', '2/12')
# Zweiten Bruch 9/12 plotten
visualize_fraction(axs[1], 9, 12, 'blue', '9/12')
...
#only("1")[
#voiceover("Hier siehst du die Brüche mit einem gemeinsamen Nenner von zwölf.")
]
#only("2")[
#voiceover("Also haben wir jetzt zwei Zwölftel statt einem Sechstel,")
]
#only("3")[
#voiceover("und neun Zwölftel statt drei Viertel. Du siehst, dass auf jeder Seite der Wert gleich ist, lediglich die Darstellung ist anders.")
]
]
...
# Summe der Brüche 11/12 plotten
visualize_fraction(ax, 11, 12, 'blue', '2/12 + 9/12 = 11/12')
