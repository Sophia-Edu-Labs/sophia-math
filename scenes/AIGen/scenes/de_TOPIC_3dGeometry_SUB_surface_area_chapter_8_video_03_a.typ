...
plt.show()
  ...
  #only("1")[
    #voiceover("Großartige Arbeit bei der Lösung dieses Problems! Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit einem Quader zu tun, der 15 Meter lang, 8 Meter breit und 5 Meter hoch ist. Hier ist eine visuelle Darstellung unseres Quaders.")
  ]
]
