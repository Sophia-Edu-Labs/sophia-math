...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's go through the solution step by step. We're dealing with a cuboid that has dimensions of 15 meters in length, 8 meters in width, and 5 meters in height. Here's a visual representation of our cuboid.")
  ]
]
