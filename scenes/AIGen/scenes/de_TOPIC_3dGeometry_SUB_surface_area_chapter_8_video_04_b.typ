...
```
  ...
  #only("1")[
    #voiceover("Nicht ganz richtig, aber kein Problem! Lass uns die Lösung zur Berechnung der Oberfläche dieses rechteckigen Prismas mit einem zylindrischen Loch in der Mitte durchgehen.")
  ]
]
