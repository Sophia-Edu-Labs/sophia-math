...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job! You've correctly solved this problem. Let's go through the solution step-by-step. We're dealing with a cube that has a surface area of 216 square centimeters. Our task is to find the length of one edge. Here's a visualization of our cube.")
  ]
]
