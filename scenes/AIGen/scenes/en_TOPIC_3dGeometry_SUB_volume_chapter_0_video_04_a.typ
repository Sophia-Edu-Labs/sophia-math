...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's go through the solution step by step. We're dealing with a cube that has a side length of 7 meters. Here's a visualization of our cube.")
  ]
]
