...
#v(40pt)
#text(size: 24pt)[Lass uns Schritt für Schritt sehen, wie wir zu dieser Lösung kommen. 📝]
#only("1")[
#voiceover("Großartige Arbeit! Das ist die korrekte Matrixdarstellung der linearen Abbildung T. Lass uns Schritt für Schritt sehen, wie wir zu dieser Lösung kommen.")
]
]
...
#only("1")[
#voiceover("T von 1, 0 ergibt 2 mal 1, 3 mal 0, was zu 2, 0 vereinfacht wird.")
]
#only("2")[
#voiceover("Ähnlich ergibt T von 0, 1 2 mal 0, 3 mal 1, was zu 0, 3 vereinfacht wird.")
]
]
...
#v(40pt)
#only("1-")[- Spalten der Matrix sind die transformierten Basisvektoren]
#v(20pt)
