...
#only("1")[
#voiceover("Großartige Arbeit! Das ist die korrekte Matrixdarstellung der linearen Abbildung T. Lass uns Schritt für Schritt sehen, wie wir zu dieser Lösung gelangen.")
]
]
