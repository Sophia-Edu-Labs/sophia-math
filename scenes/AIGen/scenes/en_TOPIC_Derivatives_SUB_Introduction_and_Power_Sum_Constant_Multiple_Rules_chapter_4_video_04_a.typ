...
#only("1")[
#voiceover("Great job on solving this problem! Let's walk through the solution step by step. We start with our function f of x equals 4x cubed plus 3x squared plus 2x.")
]
