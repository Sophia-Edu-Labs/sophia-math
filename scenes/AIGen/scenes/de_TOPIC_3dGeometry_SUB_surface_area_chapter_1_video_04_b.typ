...
plt.show()
  ...
  #only("1")[
    #voiceover("Leider ist das nicht korrekt. Lass uns die Lösung Schritt für Schritt durchgehen. Hier haben wir einen Würfel mit einer Kantenlänge von 9 Zentimetern.")
  ]
]
