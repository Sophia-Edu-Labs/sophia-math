...
#slide()[
#only("1")[
#voiceover("Das war leider nicht korrekt. Lass uns gemeinsam die Lösung Schritt für Schritt durchgehen, um zu verstehen, wie wir $27/4$ in eine Dezimalzahl umwandeln.")
]
