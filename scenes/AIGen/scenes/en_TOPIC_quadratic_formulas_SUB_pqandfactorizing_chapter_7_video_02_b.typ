...
#slide()[
  ...
  #only("1")[
    #voiceover("Not quite. The correct solution is x equals negative 3. Let's walk through the solution step-by-step using the p-q formula. We start with the quadratic equation x squared plus 6x plus 9 equals 0.")
  ]
  #only("2")[
