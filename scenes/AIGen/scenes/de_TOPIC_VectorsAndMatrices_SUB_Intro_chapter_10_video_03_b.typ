...
#only("1")[
#voiceover("Leider ist das nicht korrekt. Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit zwei Matrizen, A und B. Matrix A ist eine 2x3-Matrix und Matrix B ist eine 3x2-Matrix.")
]
