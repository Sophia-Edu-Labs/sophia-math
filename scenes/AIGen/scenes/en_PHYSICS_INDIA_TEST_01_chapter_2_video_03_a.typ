...
plt.show()
  ...
  #only("1")[
    #voiceover("Excellent work on solving this problem! Let's walk through the solution step by step. Here we have a visualization of a 2 cubic millimeter conductor with some free electrons represented as red dots.")
  ]
