...
plt.show()
  ...
  #only("1")[
    #voiceover("Leider war das nicht ganz richtig. Lass uns die Lösung Schritt für Schritt durchgehen. Hier ist eine Visualisierung unserer zusammengesetzten Figur: zwei Würfel, die an einer Seite verbunden sind.")
  ]
]
