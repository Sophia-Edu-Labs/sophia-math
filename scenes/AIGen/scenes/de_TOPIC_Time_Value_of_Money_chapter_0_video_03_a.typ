...
#only("1")[
#voiceover("Genau, großartige Arbeit. Lass uns die richtige Lösung Schritt für Schritt durchgehen. Gegeben sind der Gegenwärtige Wert von €100, ein jährlicher Zinssatz von 5%, und wir wollen den zukünftigen Wert nach einem Jahr wissen.")
]
#only("2")[
