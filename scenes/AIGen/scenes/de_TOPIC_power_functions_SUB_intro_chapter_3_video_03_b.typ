...
#slide()[
  ...
  #only("1")[
    #voiceover("Keine Sorge, wir gehen die Lösung Schritt für Schritt durch. Wir haben es mit einer Potenzfunktion zu tun: f von x ist gleich minus zwei mal x hoch drei.")
  ]
  #only("2")[
