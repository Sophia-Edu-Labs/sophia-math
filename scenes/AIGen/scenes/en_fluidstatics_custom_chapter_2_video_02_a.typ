...
#only("1")[
#voiceover("Great job! That's the correct answer. Let's break down the solution step by step. We are given a dam section that is 2 meters wide and 4 meters high.")
]
#only("2")[
