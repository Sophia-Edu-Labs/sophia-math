...
#only("1")[
#voiceover("Nicht ganz. Gehen wir Schritt für Schritt die richtige Lösung durch. Wir haben die Folge a_n gleich 2n plus 1 gegeben.")
]
#only("2")[
...
#only("1")[
#voiceover("Zuerst wollen wir verstehen, was die Formel a_n gleich 2n plus 1 bedeutet.")
]
#only("2")[
...
#only("3-")[- $a_5 = 11$]
#only("1")[
#voiceover("Nun wollen wir diesen Ausdruck vereinfachen.")
]
#only("2")[
