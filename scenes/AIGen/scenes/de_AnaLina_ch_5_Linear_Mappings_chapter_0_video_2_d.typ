...
#only("3")[#voiceover("Option b) Skalare Multiplikation ist auch teilweise korrekt, aber ebenfalls nicht die vollständige Antwort.")]
...
#v(20pt)
#only("6-")[Wenn eine Abbildung beides erhält, ist sie linear. Wenn sie eines davon nicht erhält, ist sie nicht linear. 🧮]
...
#only("6")[#voiceover("Wenn eine Abbildung beide Eigenschaften erhält, ist sie eine lineare Abbildung. Wenn sie eine dieser Eigenschaften nicht erhält, ist sie keine lineare Abbildung.")]
]
...
#v(20pt)
#only("4-")[Großartige Arbeit beim Identifizieren der richtigen Antwort! 🌟]
...
#only("4")[#voiceover("Großartige Arbeit beim Identifizieren der richtigen Antwort und beim Verstehen der Eigenschaften linearer Abbildungen!")]
]