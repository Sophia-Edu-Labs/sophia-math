...
#slide()[
  ...
  #only("2")[
    #voiceover("Let's solve the equation x squared minus 4x minus 5 equals 0 using the p-q formula.")
  ]
]

//Type: Numeric
#questionDef(
questionText: "Solve the quadratic equation $x^2 - 4x - 5 = 0$ using the p-q formula.", 
