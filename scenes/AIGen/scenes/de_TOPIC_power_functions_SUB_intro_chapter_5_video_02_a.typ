...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartige Arbeit bei der Bearbeitung dieser Frage! Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit einer Potenzfunktion f von x gleich 4 mal x hoch 3 zu tun.")
  ]
  #only("2")[
