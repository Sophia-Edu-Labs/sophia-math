...
#slide()[
  ...
  #only("2")[
    #voiceover("Deine Aufgabe ist es, die Gleichung x Quadrat minus 8x plus 16 gleich null durch Faktorisierung zu lösen.")
  ]
]

//Typ: Numerisch
#questionDef(
questionText: "Löse die quadratische Gleichung $x^2 - 8x + 16 = 0$ durch Faktorisierung.", 
