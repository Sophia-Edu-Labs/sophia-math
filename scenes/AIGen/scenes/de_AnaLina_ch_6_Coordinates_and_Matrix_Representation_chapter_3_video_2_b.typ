...
#v(10pt)
// Von Anfang bis Abschnitt drei ist die Option schwarz. Von Abschnitt 4 bis zum Ende wird sie dann grün, weil sie richtig ist.
...
#only("1")[#voiceover("Lassen Sie uns das Schritt für Schritt lösen. Wir haben eine lineare Abbildung T, definiert durch T von x, y gleich 2x, 3y, und einen Vektor v, der der Spaltenvektor 1, 2 ist.")]
