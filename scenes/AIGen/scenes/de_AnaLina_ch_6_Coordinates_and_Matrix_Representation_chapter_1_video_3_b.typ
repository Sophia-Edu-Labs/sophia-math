...
#only("1")[
#voiceover("Das ist nicht ganz richtig. Lassen Sie uns die richtige Lösung überprüfen.")
]
]
...
#only("1")[
#voiceover("Lassen Sie uns die Lösung Schritt für Schritt durchgehen. Wir haben eine Basis B, die aus den Vektoren mat(1; 0) und mat(0; 1) besteht, und einen Vektor v gleich mat(2; 3).")
]
]

#slide()[
#text(size: 30pt, weight: "bold")[Schritt 1: Verstehen der Basis]
#v(40pt)
...
#only("1")[
#voiceover("Zuerst wollen wir verstehen, was die Basisvektoren in B darstellen. Der Vektor 1; 0 zeigt entlang der x-Achse, und der Vektor 0; 1 zeigt entlang der y-Achse.")
]
]

#slide()[
#text(size: 30pt, weight: "bold")[Schritt 2: $v$ als Linearkombination ausdrücken]
#v(40pt)
...
#only("2")[
#voiceover("Durch Einsetzen der Werte erhalten wir 2; 3 gleich a mal 1; 0 plus b mal 0; 1.")
]
]

#slide()[
#text(size: 30pt, weight: "bold")[Schritt 3: Lösen für $a$ und $b$]
#v(40pt)
...
#only("1")[
#voiceover("Daher sind die Koordinaten des Vektors v gleich 2; 3 relativ zur Basis B gleich 1; 0 und 0; 1 gleich 2, 3. Großartige Arbeit!")
]
]