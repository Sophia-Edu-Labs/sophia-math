...
#v(40pt)
#only("1-")[Eine Basis ist eine Menge von Vektoren, die \_\_\_\_ einen Vektorraum.]
...
#only("1")[#voiceover("Lass uns dein Wissen über die Basis eines Vektorraums testen. Eine Basis ist eine Menge von Vektoren, die einen Vektorraum blank.")]
...
questionText: "Eine Basis ist eine Menge von Vektoren, die _____ einen Vektorraum.",
