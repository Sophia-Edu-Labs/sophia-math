...
#only("2")[
#voiceover("Zum Beispiel, betrachte die Abbildung T, die einen Vektor (x; y) auf (2x; 3y) abbildet.")
]
]
...
#only("2")[
#voiceover("Im Diagramm stellen die roten Pfeile die Standardbasisvektoren (1; 0) und (0; 1) dar. Die blauen Pfeile stellen die neuen Basisvektoren (2; 0) und (0; 3) nach Anwendung der Transformationsmatrix dar.")
]
]
]
...
#v(20pt)
#only("2-")[- Matrixdarstellung: lineare Abbildung dargestellt durch eine Matrix 📜]
#v(20pt)
