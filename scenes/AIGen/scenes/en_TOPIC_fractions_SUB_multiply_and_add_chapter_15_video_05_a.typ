...
#slide()[
  #only("1")[
    #voiceover("Great job! You've correctly solved this subtraction problem with fractions. Let's walk through the solution step-by-step to understand the process better.")
  ]
