...
plt.show()
  ...
  #only("1")[
    #voiceover("Das war leider nicht korrekt. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben einen Quader mit einer Länge von 7 Zentimetern, einer Breite von 4 Zentimetern und einer Höhe von 5 Zentimetern. Hier ist eine visuelle Darstellung unseres Quaders.")
  ]
]
