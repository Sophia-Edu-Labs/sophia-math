...
plt.show()
  ...
  #only("1")[
    #voiceover("Großartig! Du hast dieses Problem korrekt gelöst. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit einem Würfel zu tun, der eine Oberfläche von 216 Quadratzentimetern hat. Unsere Aufgabe ist es, die Länge einer Kante zu finden. Hier ist eine Visualisierung unseres Würfels.")
  ]
]
