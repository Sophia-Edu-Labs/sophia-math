...
#v(20pt)
#only("4-")[- Nützlich zum Vereinfachen von Berechnungen und zum Verständnis von Zahlen. 🔍]
#only("1")[
...
#only("3")[
#voiceover("Dann teile die resultierende Zahl durch eine Eins, gefolgt von Nullen. Füge eine Null für jede Dezimalstelle hinzu.")
]
#only("4")[
...
#only("1")[
#voiceover("Zusammenfassend, zähle zuerst die Dezimalstellen.")
]
#only("2")[
#voiceover("Als nächstes entferne das Dezimalzeichen.")
]
