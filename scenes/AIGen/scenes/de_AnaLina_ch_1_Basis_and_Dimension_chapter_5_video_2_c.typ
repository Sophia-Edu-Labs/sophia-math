...
#only("5")[#voiceover("Und Option d) Spann ist ebenfalls falsch. Spann bezieht sich auf die Menge aller Linearkombinationen eines Satzes von Vektoren, nicht auf die Koordinaten eines bestimmten Vektors.")]
]
...
#only("2")[#voiceover("Betrachten Sie den Vektor v, der dem Vektor 3, 4 entspricht, und die Standardbasisvektoren 1, 0 und 0, 1 für R Quadrat.")]
