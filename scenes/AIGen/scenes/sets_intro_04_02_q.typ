...
#slide()[
  #only("1")[
    #voiceover("Betrachte die hier dargestellten Mengen ")
  ]
...
#only("5-")[$ |B|=? $]
#only("3")[
  #voiceover("A besteht aus den Elementen a, b, c und e.")
]
#only("4")[
  #voiceover("B hingegen besteht aus den Elementen a, b, d , e und f.")
]
#only("5")[
  #voiceover("Bestimme nun die Mächtigkeit der Menge B")
]
...
#questionDef(
  questionText: "Bestimme $|B|$, die Mächtigkeit von $B$",
  // use latex!
  answerOptions: ("$|B|=5$", "$|B|=0$"),
