...
#only("1")[
#voiceover("Unsere Aufgabe war es, ein Viertel plus ein Sechstel zu berechnen.")
]
#only("2")[
...
#only("1")[
#voiceover("Daher ist ein Viertel plus ein Sechstel gleich fünf Zwölftel.")
]
#only("2")[
