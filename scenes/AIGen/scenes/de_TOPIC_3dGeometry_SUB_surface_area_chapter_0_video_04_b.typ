...
plt.show()
  ...
  #only("1")[
    #voiceover("Leider war das nicht ganz richtig. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben einen Würfel mit einer Seitenlänge von 7 Metern. Hier ist eine Visualisierung unseres Würfels.")
  ]
]
