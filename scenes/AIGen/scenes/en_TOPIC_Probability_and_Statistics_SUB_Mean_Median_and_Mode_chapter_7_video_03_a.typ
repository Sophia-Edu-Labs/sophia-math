...
#only("1")[
#voiceover("Great job! Let's go through the solution step-by-step. First, we are given the set of numbers: 250, 350, 450, 150, 550, and 650.")
]
#only("2")[
...
#v(40pt)
#only("1-")[- Mean = $\dfrac{Sum}{Number of elements}$ 🧮]
#v(20pt)
#only("2-")[- Mean = $\dfrac{2400}{6}$]
#v(20pt)
#only("3-")[- Mean = $400$ 🎉]
#only("1")[
