...
questionText: "What is the inverse of the matrix $ \begin{pmatrix} 1 & 0 \\\\ 0 & 1 \end{pmatrix} $?",
answerOptions: ("$ \begin{pmatrix} 1 & 0 \\\\ 0 & 1 \end{pmatrix} $", "$ \begin{pmatrix} 0 & 1 \\\\ 1 & 0 \end{pmatrix} $", "$ \begin{pmatrix} 1 & 1 \\\\ 1 & 1 \end{pmatrix} $", "$ \begin{pmatrix} 2 & 0 \\\\ 0 & 2 \end{pmatrix} $"),
