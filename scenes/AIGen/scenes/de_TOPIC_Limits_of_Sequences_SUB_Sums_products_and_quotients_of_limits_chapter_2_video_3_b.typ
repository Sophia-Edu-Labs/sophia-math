...
#only("1")[
#voiceover("Leider ist das nicht korrekt. Schauen wir uns gemeinsam an, wie man das Problem richtig löst. Das Problem verlangt von uns, das Limit des Produkts zweier Folgen a_n und b_n zu finden, wenn n gegen unendlich geht, wobei a_n gleich 1 durch n und b_n gleich 2 durch n ist.")
]
]
