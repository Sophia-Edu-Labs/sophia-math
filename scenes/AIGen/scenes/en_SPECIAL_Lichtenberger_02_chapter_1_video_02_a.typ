...
#only("1")[
#voiceover("Great job! That's the correct answer. Let's see how we can solve this step by step. We are given that the pressure on the ground floor is 4.0 bar and the water pipe we are interested in is 14 meters higher.")
]
]
