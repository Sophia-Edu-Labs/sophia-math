...
#only("3")[#voiceover("Das Addieren der Matrizen würde uns nicht die korrekte Transformation liefern.")]
#only("4")[#voiceover("Ebenso würde das Subtrahieren der Matrizen nicht das gewünschte Ergebnis liefern.")]
#only("5")[#voiceover("Und obwohl das Invertieren von Matrizen eine wichtige Operation ist, brauchen wir das hier nicht für den Basiswechsel.")]
]
...
#only("1")[#voiceover("Zusammenfassend lässt sich sagen, dass der Basiswechsel einer linearen Abbildung die Matrixmultiplikation beinhaltet.")]
#only("2")[#voiceover("Die ursprüngliche Matrixdarstellung wird durch die Basiswechselmatrix transformiert.")]
#only("3")[#voiceover("Die resultierende neue Matrix stellt dieselbe lineare Abbildung dar, jedoch nun bezüglich der neuen Basis.")]
#only("4")[#voiceover("Fantastische Arbeit beim Verständnis dieses wichtigen Konzepts. Machen Sie weiter so auf Ihrer Reise durch die lineare Algebra!")]
]