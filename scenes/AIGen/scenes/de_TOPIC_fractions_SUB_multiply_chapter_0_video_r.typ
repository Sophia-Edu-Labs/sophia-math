...
#only("1-")[
#align(center)[
#text(size: 24pt)[🥧 Rückblick auf die Pie-Party! 🎉]
 ]
 ]
#only("2-")[
#align(center)[
...
#only("1")[
#voiceover("Während wir unsere Lektion über das Multiplizieren von Brüchen wiederholen, stell Dir vor, Du veranstaltest eine Pie-Party und musst herausfinden, wie viel Kuchen Du benötigst.")
 ]
#only("2")[
...
#only("4")[
#voiceover("Wenden wir diese Schritte auf unser Kuchenproblem an. Wir haben 4 mal ein Fünftel. Wir multiplizieren 4 mit 1, was uns 4 ergibt, und wir behalten den Nenner 5. Also ergibt 4 mal ein Fünftel vier Fünftel.")
 ]
#only("5")[
...
#slide()[
#text(size: 30pt, weight: "bold")[Multiplikation visualisieren: 4 $dot$ 1/5]
#v(40pt)
#only("1-")[
#box()[
#figure(
...
#only("3")[
#voiceover("Der Schlüssel ist: Zähler multiplizieren, Nenner bleibt gleich. Diese einfache Regel hilft Dir, viele Probleme beim Multiplizieren von Brüchen zu lösen!")
 ]
]
