...
#only("1")[#voiceover("Not quite. Let's explore why the area of a circle is an application of power functions and understand why the other options are incorrect.")]
