...
plt.show()
  ...
  #only("1")[
    #voiceover("Not quite, but let's go through the correct solution step-by-step. We're dealing with a cuboid, which is a three-dimensional rectangular shape. As we can see in this diagram, our cuboid has a length of 14 meters, a width of 9 meters, and a height of 6 meters.")
  ]
]
