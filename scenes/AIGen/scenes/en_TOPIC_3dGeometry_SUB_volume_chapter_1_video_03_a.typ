...
plt.show()
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's walk through the solution step-by-step. We're dealing with a cube, which is a three-dimensional shape where all edges have the same length. Here's a visualization of a cube with one edge highlighted in red.")
  ]
  #only("2")[
