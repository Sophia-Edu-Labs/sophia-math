...
#slide()[
  ...
  #only("1")[
    #voiceover("Leider war das nicht ganz richtig. Lass uns die Lösung Schritt für Schritt durchgehen. Zuerst erinnern wir uns daran, wie eine quadratische Gleichung aussieht. Sie hat die Form a x Quadrat plus b x plus c gleich null.")
  ]
  #only("2")[
