...
#only("1")[#voiceover("Excellent work! You've chosen the correct answer. Let's break down why a) 0.875 is the right choice and explore the solution step-by-step.")]
