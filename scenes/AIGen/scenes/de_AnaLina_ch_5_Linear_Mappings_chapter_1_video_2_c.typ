...
#only("5")[#voiceover("d) Keine der oben genannten ist falsch, da a) 0 tatsächlich die richtige Antwort ist, wie wir bereits gesehen haben.")]
]
...
#only("6")[#voiceover("Damit haben wir bewiesen, dass $T(0) = 0$ für jede lineare Abbildung $T$ gilt. Dies vervollständigt den Beweis.")]
]
