...
#slide()[
  #only("1")[
    #voiceover("Great job! You've correctly solved this subtraction problem. Let's walk through the solution step-by-step to understand how we arrive at the answer.")
  ]
