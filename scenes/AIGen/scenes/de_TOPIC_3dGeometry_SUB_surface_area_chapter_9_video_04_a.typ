...
plt.show()
  ...
  #only("1")[
    #voiceover("Großartige Arbeit bei der Lösung dieses Problems! Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben eine zusammengesetzte Figur, die aus einem Quader mit den Maßen 7 cm mal 6 cm mal 5 cm und einem Würfel mit einer Seitenlänge von 4 cm besteht, der darauf sitzt. Unsere Aufgabe ist es, die gesamte Oberfläche zu berechnen.")
  ]]
]
