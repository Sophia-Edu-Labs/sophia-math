...
#only("1")[
#voiceover("Lass uns zwei Beispiele für konvergente Folgen wiederholen. Das erste Beispiel ist die Folge a_n gleich 1 durch n.")
]
#only("2")[
...
#only("1")[
#voiceover("Die Folge a_n gleich 1 durch n konvergiert gegen 0, wenn n gegen unendlich geht. Wie Du im Diagramm sehen kannst, nähern sich die Glieder der Folge immer mehr dem Wert 0 an, wenn n größer wird.")
]
]
]
...
#only("1")[
#voiceover("Die Folge b_n gleich 2n durch n plus 1 konvergiert gegen 2, wenn n gegen unendlich geht. Das Diagramm zeigt, wie sich die Glieder der Folge dem Wert 2 annähern, wenn n größer wird.")
]
]
]
...
#v(40pt)
#only("1-")[- Konvergente Folgen nähern sich einem bestimmten Wert, wenn $n$ gegen $infinity$ geht 📈]
#v(20pt)
