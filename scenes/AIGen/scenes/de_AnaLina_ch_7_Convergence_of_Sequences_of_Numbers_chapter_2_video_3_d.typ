...
#only("1")[
#voiceover("Zuerst überlegen wir, was mit b Index n passiert, wenn n größer wird.")
]
#only("2")[
...
#only("1")[
#voiceover("Um dies deutlicher zu sehen, teilen wir sowohl den Zähler als auch den Nenner durch n.")
]
#only("2")[
...
#only("2")[
#voiceover("Das Limit wird also 2 durch 1 plus 0.")
]
#only("3")[
...
#only("1")[
#voiceover("Hier ist eine Visualisierung der Folge b Index n. Wenn n größer wird, sehen Sie, dass b Index n, dargestellt in Blau, seinem Limit von 2, dargestellt durch die rote gestrichelte Linie, immer näher kommt.")
]
]
]
