...
#slide()[
#text(size: 30pt, weight: "bold")[Darstellung einer linearen Abbildung]
#v(40pt)
...
#only("4")[#voiceover("Ein Skalar ist falsch. Ein Skalar ist eine einzelne Zahl, die nicht genügend Informationen enthält, um eine lineare Abbildung zwischen Vektorräumen zu definieren.")]
#only("5")[#voiceover("Ein Polynom ist ebenfalls falsch. Polynome sind eine Art von Funktion, aber sie stellen nicht direkt lineare Abbildungen dar.")]
]
...
#v(10pt)
#only("3-")[2️⃣ Die #text(fill:aqua)[Multiplikation] der Matrix mit einem Vektor führt die lineare Transformation durch.]
#v(10pt)
#only("4-")[3️⃣ Die #text(fill:aqua)[Spalten] der Matrix sind die Bilder der Basisvektoren.]

#only("1")[#voiceover("Warum genau kann eine Matrix eine lineare Abbildung darstellen?")]
#only("2")[#voiceover("Erstens, erinnere dich daran, dass eine lineare Abbildung Koordinaten von einer Basis in eine andere transformiert. Eine Matrix kann diese Transformation kodieren.")]
...
#only("4")[#voiceover("Genauer gesagt, die Spalten der Matrix sind die Bilder der Basisvektoren unter der linearen Transformation. Daher definiert die Matrix die Abbildung vollständig.")]
]

#slide()[
#text(size: 30pt, weight: "bold")[Beispiel 📚]
#v(40pt)
#only("1-")[Betrachte die lineare Abbildung $T: RR^2 -> RR^2$, definiert durch $T(x, y) = (2x, 3y)$.]
#v(20pt)
...
#only("1")[#voiceover("Schauen wir uns ein Beispiel an. Betrachte die lineare Abbildung T von R-2 nach R-2, definiert durch T von x, y gleich 2x, 3y.")]
...
#v(20pt)
#only("4-")[Großartige Arbeit bei dieser Frage! 🌟 Du beherrschst das Konzept der linearen Abbildungen und ihrer Matrixdarstellungen. Weiter so! 😄]
...
#only("4")[#voiceover("Großartige Arbeit bei dieser Frage! Du beherrschst das Konzept der linearen Abbildungen und ihrer Matrixdarstellungen. Weiter so!")]
]