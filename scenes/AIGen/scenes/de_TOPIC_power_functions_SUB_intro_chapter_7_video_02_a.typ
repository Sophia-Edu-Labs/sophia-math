...
```
  ...
  #only("1")[
    #voiceover("Großartige Arbeit! Das ist korrekt. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit der Potenzfunktion f von x gleich 7 mal x Quadrat zu tun. Wir müssen f von 3 finden, das bedeutet, wir müssen die Funktion bei x gleich 3 auswerten.")
  ]
]
