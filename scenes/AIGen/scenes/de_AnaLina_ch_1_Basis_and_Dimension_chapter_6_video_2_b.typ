...
#only("1")[#voiceover("Fantastische Arbeit! Du hast die richtige Antwort gewählt.")]
...
#only("4")[#voiceover("Die Basiswechselmatrix, bezeichnet als P sub B, wäre dann die Matrix mit diesen Vektoren als Spalten.")]
]
...
#only("1")[#voiceover("Zusammenfassend transformiert die Basiswechselmatrix Koordinaten von einer Basis in eine andere.")]
