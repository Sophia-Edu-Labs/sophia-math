...
#only("1")[
#voiceover("Das ist nicht ganz richtig. Gehen wir Schritt für Schritt die Lösung durch, um die richtige Antwort zu verstehen.")
]
]
...
#only("2")[
#voiceover("Es wird auch angegeben, dass die Dimension des Kerns von T 1 ist.")
]
]
...
#only("2")[
#voiceover("Lösen wir nach der Dimension des Bildes von T auf, erhalten wir 3 minus 1, was 2 ergibt.")
]
]
