...
#slide()[
  ...
  #only("2")[
    #voiceover("Your task is to solve the equation x squared minus 7x plus 10 equals zero using the p-q formula.")
  ]
]

//Type: Numeric
#questionDef(
questionText: "Solve the quadratic equation $x^2 - 7x + 10 = 0$ using the p-q formula.", 
