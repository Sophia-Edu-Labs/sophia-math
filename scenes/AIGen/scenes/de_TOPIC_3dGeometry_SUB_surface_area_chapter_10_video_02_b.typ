...
plt.show()
  ...
  #only("1")[
    #voiceover("Keine Sorge, das war eine knifflige Frage. Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit einem Quader zu tun, der die Abmessungen 13 Zentimeter mal 7 Zentimeter mal 5 Zentimeter hat. Hier ist eine visuelle Darstellung unseres Quaders.")
  ]
]
