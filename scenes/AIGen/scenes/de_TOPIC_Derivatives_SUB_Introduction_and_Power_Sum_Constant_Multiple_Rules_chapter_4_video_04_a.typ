...
#only("1")[
#voiceover("Großartige Arbeit bei der Lösung dieses Problems! Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit unserer Funktion f von x gleich 4x hoch drei plus 3x hoch zwei plus 2x.")
]
