...
#only("3")[
#voiceover("b) unabhängig ist nah dran, aber nicht ganz richtig. Während Basisvektoren tatsächlich linear unabhängig sind, ist 'unabhängig' allein nicht der beste Begriff, um den neuen Satz von Vektoren zu beschreiben, den wir beim Basiswechsel suchen.")
]
#only("4")[
#voiceover("c) Basis ist richtig! Beim Basiswechsel suchen wir speziell nach einem neuen Satz von Basisvektoren, die denselben Raum wie die ursprüngliche Basis aufspannen.")
]
#only("5")[
