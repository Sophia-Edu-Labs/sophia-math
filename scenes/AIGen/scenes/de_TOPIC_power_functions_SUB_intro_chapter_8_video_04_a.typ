...
```
  ...
  #only("1")[
    #voiceover("Großartige Arbeit bei der Beantwortung dieser Frage! Lass uns die Lösung Schritt für Schritt durchgehen. Wir haben es mit der Potenzfunktion f von x gleich 27 geteilt durch x hoch drei zu tun. Hier ist ein Diagramm dieser Funktion, um sie zu veranschaulichen.")
  ]
]
