...
#slide()[
  ...
  #only("1")[
    #voiceover("Großartige Arbeit beim Lösen dieser Gleichung! Lass uns die Lösung Schritt für Schritt durchgehen. Wir beginnen mit der quadratischen Gleichung x Quadrat minus 4x minus 5 gleich null.")
  ]
  #only("2")[
