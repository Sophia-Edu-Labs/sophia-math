...
#v(10pt)
// Von Anfang bis Abschnitt drei ist die Option schwarz. Ab Abschnitt 4 bis zum Ende wird sie grün, weil sie korrekt ist.
...
#only("2")[#voiceover("Option a) ist falsch. Wenn die Glieder ohne Schranke abnehmen, würde die Folge gegen minus Unendlichkeit divergieren, nicht gegen plus Unendlichkeit.")]
...
#only("4")[#voiceover("Option c) ist die richtige Antwort. Eine Folge divergiert ins Unendliche, wenn ihre Glieder ohne Schranke zunehmen, während n gegen Unendlichkeit geht.")]
...
#v(20pt)  
- Das bedeutet:
  - Egal wie groß $M$ ist, wir können immer ein $N$ finden, sodass für alle Glieder ab dem $N$-ten Glied $a_n$ größer als $M$ ist. 📈
#v(20pt)  
- Mit anderen Worten:
  - Die Glieder der Folge nehmen ohne Schranke zu, während $n$ gegen Unendlichkeit geht. ∞
#only("1")[#voiceover("Lass uns das Schritt für Schritt durchgehen. Eine Folge a_n divergiert ins Unendliche, wenn für jedes M größer als 0 ein N existiert, sodass für alle n größer oder gleich N, a_n größer als M ist.")]
#only("2")[#voiceover("Das bedeutet, dass egal wie groß wir M wählen, wir immer ein N finden können, sodass für alle Glieder ab dem N-ten Glied a_n größer als M ist.")]
#only("3")[#voiceover("Mit anderen Worten, die Glieder der Folge nehmen ohne Schranke zu, während n gegen Unendlichkeit geht. Sie werden immer größer und größer und überschreiten jeden endlichen Wert.")]
]

#slide()[
#text(size: 30pt, weight: "bold")[Beispiel]
#v(40pt)
Betrachte die Folge $a_n = n^2$.
#v(20pt)
#only("1-")[
#box()[
...
#v(20pt)
- Für jedes $M > 0$, wähle $N = ceil(sqrt(M))$. 🎯
- Dann für alle $n >= N$, $a_n = n^2 >= N^2 > M$. ✅
- Somit divergiert $a_n$ ins Unendliche. 🚀
#only("1")[#voiceover("Schauen wir uns ein Beispiel an. Betrachte die Folge a_n gleich n Quadrat. Hier ist eine Grafik der ersten paar Glieder.")]
...
#only("3")[#voiceover("Einige Beispiele für Folgen, die ins Unendliche divergieren, sind a_n gleich n, a_n gleich n Quadrat und a_n gleich 2 hoch n. In jedem Fall werden die Glieder immer größer, ohne eine Grenze zu erreichen, während n zunimmt.")]
]