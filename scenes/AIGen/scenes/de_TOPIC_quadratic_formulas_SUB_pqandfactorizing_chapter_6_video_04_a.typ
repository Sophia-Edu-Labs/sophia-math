...
#slide()[
  ...
  #only("1")[
    #voiceover("Ausgezeichnete Arbeit! Lass uns diese quadratische Gleichung Schritt für Schritt lösen. Wir beginnen mit der Gleichung x Quadrat plus 5x plus 6 gleich null.")
  ]
  #only("2")[
