...
#slide()[
  ...
  #only("1")[
    #voiceover("Great job on solving this problem! Let's go through the solution step-by-step. We start with the function f of x equals x times sine of x squared.")
  ]
