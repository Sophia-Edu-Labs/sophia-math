...
#slide()[
#only("1")[
#voiceover("Lassen Sie uns die formale Definition der Konvergenz für Folgen rekapitulieren.")
]
...
#v(40pt)
#only("2")[
#voiceover("Eine Folge $a_n$ konvergiert gegen einen Grenzwert $L$, wenn für jedes positive Epsilon eine natürliche Zahl $N$ existiert, sodass für alle $n$ größer oder gleich $N$ der absolute Wert von $a_n - L$ kleiner als Epsilon ist.")
]
#only("2-")[
...
#slide()[
#only("1")[
#voiceover("Lassen Sie uns das Schritt für Schritt aufschlüsseln.")
]
#text(size: 30pt, weight: "bold")[Aufschlüsselung]
// Der Titel "Aufschlüsselung" wird auf dieser Folie angezeigt
#v(40pt)
#only("2-")[- $ε > 0$ steht für eine beliebig kleine positive Zahl 🔍]
// Die Erklärung für Epsilon wird ab Folie 2 angezeigt
#only("2")[
#voiceover("Erstens, Epsilon steht für eine beliebig kleine positive Zahl. Es ist eine Schwelle, die wir wählen.")
]
#v(20pt)
#only("3-")[- $N ∈ ℕ$ ist eine natürliche Zahl, die von $ε$ abhängt 🔢]
// Die Erklärung für N wird ab Folie 3 angezeigt
#only("3")[
#voiceover("Zweitens, $N$ ist eine natürliche Zahl, die von der Wahl des Epsilon abhängt. Es ist ein Punkt in der Folge, ab dem alle Terme nahe am Grenzwert liegen.")
]
#v(20pt)
...
#only("4")[
#voiceover("Schließlich bedeutet die Bedingung $|a_n - L| < ε$, dass der absolute Unterschied zwischen den Termen $a_n$ und dem Grenzwert $L$ kleiner als Epsilon ist, für alle Terme nach dem $N$-ten Term.")
]
]
...
// Die Abbildung zeigt eine Folge a_n, die gegen einen Grenzwert L konvergiert, mit dem Epsilon-Nachbarschaft und dem Punkt N markiert. Diese Abbildung wird ab Folie 2 angezeigt.
#only("2")[
#voiceover("In diesem Diagramm repräsentiert die blaue Linie die Folge $a_n$, die gegen die rote Grenzwertlinie $L$ konvergiert. Die grünen Linien markieren die Epsilon-Nachbarschaft um $L$, und die magentafarbene Linie zeigt den Punkt $N$, ab dem alle Terme innerhalb dieser Nachbarschaft liegen.")
]
]

#slide()[
#only("1")[
#voiceover("Zusammengefasst:")
]
