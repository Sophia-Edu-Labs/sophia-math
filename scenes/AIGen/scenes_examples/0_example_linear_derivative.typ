...
#only("1")[
  #voiceover("Finden wir also die Ableitung")
]
Gesucht: Ableitung der Funktion
#v(40pt)
#only("2-")[#text()[$ f(x) = 0.5x^4 - 2x^2 + 3x - 2 $]]
#only("2")[
  #voiceover("der Funktion f von x gleich null komma fünf x hoch vier minus zwei mal x Quadrat plus drei mal x minus zwei.")
]
]
