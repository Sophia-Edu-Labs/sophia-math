...
#v(40pt)
#only("1-")[Unfortunately, that wasn't the right answer. Let's go through the correct solution and understand why.]
#v(40pt)
...
#only("1")[#voiceover("Unfortunately, that wasn't the right answer. Let's go through the correct solution and understand why.")]
