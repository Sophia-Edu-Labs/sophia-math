...
#only("1")[#voiceover("The correct solution is important to understand. Here's how it should be done: A pie chart is not suitable for tracking changes over time. It's used to show parts of a whole at a single point in time.")]
