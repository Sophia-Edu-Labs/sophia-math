...
#only("1")[
#voiceover("That's right, great job! Let's go through the solution step by step. We are given the closing prices of the stock over 5 days: 150, 152, 149, 153, and 148.")
]
#only("2")[  
