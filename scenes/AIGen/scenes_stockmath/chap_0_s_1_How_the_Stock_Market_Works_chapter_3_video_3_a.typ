...
#slide()[
#only("1")[
#voiceover("Great job! You've identified some key factors that influence how economic conditions affect stock prices. Let's dive deeper into each of these points.")
]
