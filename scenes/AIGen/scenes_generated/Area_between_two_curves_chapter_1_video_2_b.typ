...
#only("1")[#voiceover("That's not right. So we're considering the following question: When setting up the integral to find the area between two curves, what do the boundaries represent?")]
