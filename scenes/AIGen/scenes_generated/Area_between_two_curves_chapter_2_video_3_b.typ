...
#v(40pt)
#only("2")[
#voiceover("That's not it... To solve this integral, we can use the power rule for integration. The power rule states that the integral of x to the power of n is equal to x to the power of n plus 1, divided by n plus 1, plus a constant C.")
]
#only("3")[
