...
#slide()[
  ...
  #only("2")[
    #voiceover("Wir haben die Funktion f von x gleich drei mal x hoch drei plus zwei mal x hoch fünf minus drei mal x gegeben, und suchen die Ableitung davon.")
  ]    
]

#slide()[
  #only("1")[
    #voiceover("Dafür, nutzen wir die Linearität der Ableitung, also leiten wir alle Summanden einzeln ab. Für die einzelnen Ableitungen")
  ]
  #only("2")[
