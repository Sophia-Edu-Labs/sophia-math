...
#only("1")[
#voiceover("To find the area between the curves f of x equals e to the power of x and g of x equals the natural logarithm of x over the interval from 1 to e, we need to set up an integral.")
]
]
#slide()[
