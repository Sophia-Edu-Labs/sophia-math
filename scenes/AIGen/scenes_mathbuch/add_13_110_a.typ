...
#v(40pt)
//Antwort des Schülers: $2/13$
#only("2-")[Deine Antwort: $2/13$]
#only("1")[
#voiceover("Wir sollen ein Drittel plus ein Zehntel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist zwei Dreizehntel. Das ist leider nicht richtig.")
]
]
...
#v(40pt)
#only("1-")[Dein Fehler: $1/3 + 1/10 ≠ (1+1)/(3+10)$]
#v(20pt)
...
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert hast. Ein Drittel plus ein Zehntel ist nicht gleich eins plus eins geteilt durch drei plus zehn.")
]
#only("2")[
...
fig, ax = plt.subplots(figsize=(12, 5))
#plot the sum of the two fractions
plot_fraction_circle(ax, 30, 13, '13/30')
...
#v(20pt)
#only("1-")[Also ist $1/3 + 1/10 = 13/30$, nicht $2/13$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beachte den Zähler beim Addieren von Brüchen]
#only("1")[
#voiceover("Also ist ein Drittel plus ein Zehntel gleich dreizehn Dreißigstel, nicht zwei Dreizehntel.")
]
#only("2")[
