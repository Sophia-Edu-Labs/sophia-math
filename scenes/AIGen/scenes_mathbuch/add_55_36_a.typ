...
#v(40pt)
//Antwort des Schülers: 8/11
#only("2-")[Deine Antwort: $8/11$]
#only("1")[
#voiceover("Wir sollen fünf Fünftel plus drei Sechstel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist acht Elftel. Das ist leider nicht richtig.")
]
]
...
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert hast. Fünf Fünftel plus drei Sechstel ist nicht gleich fünf plus drei geteilt durch fünf plus sechs.")
]
#only("2")[
...
#only("2")[
#voiceover("Dreißig Dreißigstel plus fünfzehn Dreißigstel ist gleich fünfundvierzig Dreißigstel, was gleich drei Halbe ist.")
]
]
...
#v(40pt)
#only("1-")[Daher ist $5/5 + 3/6 = 3/2$, nicht $8/11$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist fünf Fünftel plus drei Sechstel gleich drei Halbe, nicht acht Elftel.")
]
#only("2")[
