...
#v(40pt)
//Antwort des Schülers: $23/30$
#only("2-")[Deine Antwort: $23/30$]
#only("1")[
#voiceover("Wir sollen zwei Drittel plus ein Zehntel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist dreiundzwanzig Dreißigstel. Das ist richtig!")
]
]
...
#v(40pt)
#only("1-")[Deine Lösung: $2/3 + 1/10 = 23/30$]
#v(20pt)
#only("2-")[👍 Gut gemacht! Du hast die Brüche korrekt addiert]
#v(20pt)
#only("3-")[🔍 Schauen wir uns das noch einmal genauer an]
#only("1")[
#voiceover("Du hast zwei Drittel plus ein Zehntel korrekt berechnet und das Ergebnis ist dreiundzwanzig Dreißigstel.")
]
#only("2")[
...
#only("2")[
#voiceover("Also haben wir jetzt zwanzig Dreißigstel statt zwei Drittel,")
]
#only("3")[
#voiceover("und drei Dreißigstel statt ein Zehntel. Du siehst, dass auf jeder Seite der Wert gleich ist, lediglich die Darstellung ist anders.")
]
]
...
#v(20pt)
#only("1-")[Also ist $2/3 + 1/10 = 23/30$.]
#v(20pt)
#only("2-")[Gut gemacht! 🎉]
#only("1")[
#voiceover("Also ist zwei Drittel plus ein Zehntel gleich dreiundzwanzig Dreißigstel.")
]
#only("2")[
