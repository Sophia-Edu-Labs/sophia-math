...
#v(40pt)
//Antwort des Schülers: 27/10
#only("2-")[Deine Antwort: $27/10$]
#only("1")[
#voiceover("Wir sollen sechs Fünftel plus drei Sechstel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist siebenundzwanzig Zehntel. Das ist vollkommen richtig! Lass uns sehen, wie du zu dieser Antwort gekommen bist.")
]
]
...
#v(20pt)
#only("2-")[$ 36/30 + 15/30 = (36+15)/30 = 51/30 = 17/10 $]
#only("1")[
#voiceover("Jetzt kannst du die Brüche addieren. Du addierst die Zähler und behältst den gemeinsamen Nenner.")
]
#only("2")[
#voiceover("Sechsunddreißig Dreißigstel plus fünfzehn Dreißigstel ist gleich einundfünfzig Dreißigstel, was weiter vereinfacht siebzehn Zehntel ergibt.")
]
]
...
#v(40pt)
#only("1-")[Daher ist $6/5 + 3/6 = 17/10$, und das hast du richtig berechnet!]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist sechs Fünftel plus drei Sechstel gleich siebzehn Zehntel, und das hast du ganz richtig berechnet!")
]
#only("2")[
