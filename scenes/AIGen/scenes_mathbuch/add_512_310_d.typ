...
#v(40pt)
//Antwort des Schülers: 41/60
#only("2-")[Deine Antwort: $41/60$]
#only("1")[
#voiceover("Wir sollen fünf Zwölftel plus drei Zehntel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist einundvierzig Sechzigstel. Das ist vollkommen richtig! Lass uns sehen, wie du zu dieser Antwort gekommen bist.")
]
]
#slide()[
...
#v(40pt)
#only("1-")[Daher ist $5/12 + 3/10 = 43/60$, und das hast du richtig berechnet!]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist fünf Zwölftel plus drei Zehntel gleich dreiundvierzig Sechzigstel, und das hast du ganz richtig berechnet!")
]
#only("2")[
