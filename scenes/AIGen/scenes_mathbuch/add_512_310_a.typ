...
#v(40pt)
//Antwort des Schülers: 8/22
#only("2-")[Deine Antwort: $8/22$]
#only("1")[
#voiceover("Wir sollen fünf Zwölftel plus drei Zehntel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist acht Zweiundzwanzigstel. Das ist leider nicht richtig.")
]
]
...
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert hast. Fünf Zwölftel plus drei Zehntel ist nicht gleich fünf plus drei geteilt durch zwölf plus zehn.")
]
#only("2")[
...
#v(40pt)
#only("1-")[Daher ist $5/12 + 3/10 = 43/60$, nicht $8/22$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist fünf Zwölftel plus drei Zehntel gleich dreiundvierzig Sechzigstel, nicht acht Zweiundzwanzigstel.")
]
#only("2")[
