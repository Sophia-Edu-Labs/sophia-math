...
#v(40pt)
//Antwort des Schülers: 17/10
#only("2-")[Deine Antwort: $17/10$]
#only("1")[
#voiceover("Wir sollen ein Fünftel plus drei Halbe berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist siebzehn Zehntel. Das ist vollkommen richtig! Lass uns sehen, wie du zu dieser Antwort gekommen bist.")
]
]
...
#v(20pt)
#only("2-")[Vielfache von 5: 5, 10, 15, 20, ...]
#v(20pt)
...
#v(40pt)
#only("1-")[Daher ist $1/5 + 3/2 = 17/10$, und das hast du richtig berechnet!]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist ein Fünftel plus drei Halbe gleich siebzehn Zehntel, und das hast du ganz richtig berechnet!")
]
#only("2")[
