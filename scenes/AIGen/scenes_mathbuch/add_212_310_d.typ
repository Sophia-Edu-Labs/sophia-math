...
#v(40pt)
//Antwort des Schülers: 19/60
#only("2-")[Deine Antwort: $19/60$]
#only("1")[
#voiceover("Wir sollen zwei Zwölftel plus drei Zehntel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist neunzehn Sechzigstel. Das ist vollkommen richtig! Lass uns sehen, wie du zu dieser Antwort gekommen bist.")
]
]
...
#v(20pt)
#only("2-")[$ 28/60 = 28/60 : 2/2 = 14/30 $]
#v(20pt)
#only("3-")[$ 14/30 = 14/30 : 2/2 = 7/15 $]
#only("1")[
#voiceover("Nun kürzen wir den Bruch, wenn möglich.")
]
#only("2")[
#voiceover("Achtundzwanzig Sechzigstel wird durch zwei geteilt, das ergibt vierzehn Dreißigstel.")
]
#only("3")[
#voiceover("Vierzehn Dreißigstel wird nochmals durch zwei geteilt, das ergibt sieben Fünfzehntel.")
]
]
...
#v(40pt)
#only("1-")[Daher ist $2/12 + 3/10 = 7/15$, und das hast du richtig berechnet!]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist zwei Zwölftel plus drei Zehntel gleich sieben Fünfzehntel, und das hast du ganz richtig berechnet!")
]
#only("2")[
