...
#v(40pt)
//Antwort des Schülers: 8/16
#only("2-")[Deine Antwort: $8/16$]
#only("1")[
#voiceover("Wir sollen ein Zehntel plus sieben Sechstel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist acht Sechzehntel. Das ist leider nicht richtig.")
]
]
#slide()[
...
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert hast. Ein Zehntel plus sieben Sechstel ist nicht gleich eins plus sieben geteilt durch zehn plus sechs.")
]
#only("2")[
...
#v(40pt)
#only("1-")[Daher ist $1/10 + 7/6 = 38/30$, nicht $8/16$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist ein Zehntel plus sieben Sechstel gleich achtunddreißig Dreißigstel, nicht acht Sechzehntel.")
]
#only("2")[
