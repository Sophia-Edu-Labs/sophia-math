...
#v(40pt)
//Antwort des Schülers: 41/24
#only("2-")[Deine Antwort: $41/24$]
#only("1")[
#voiceover("Wir sollen sieben Sechstel plus fünf Achtel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist einundvierzig Vierundzwanzigstel. Das ist vollkommen richtig! Lass uns sehen, wie du zu dieser Antwort gekommen bist.")
]
]
...
#v(40pt)
#only("1-")[Daher ist $7/6 + 5/8 = 43/24$, und das hast du richtig berechnet!]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist sieben Sechstel plus fünf Achtel gleich dreiundvierzig Vierundzwanzigstel, und das hast du ganz richtig berechnet!")
]
#only("2")[
