...
#v(40pt)
//Antwort des Schülers: $31/40$
#only("2-")[Deine Antwort: $31/40$]
#only("1")[
#voiceover("Wir sollen zwei Achtel plus drei Fünftel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist einunddreißig Vierzigstel. Das ist richtig!")
]
]
...
#v(40pt)
#only("1-")[Deine Lösung: $2/8 + 3/5 = 31/40$]
#v(20pt)
#only("2-")[👍 Gut gemacht! Du hast die Brüche korrekt addiert]
#v(20pt)
#only("3-")[🔍 Schauen wir uns das noch einmal genauer an]
#only("1")[
#voiceover("Du hast zwei Achtel plus drei Fünftel korrekt berechnet und das Ergebnis ist einunddreißig Vierzigstel.")
]
#only("2")[
...
#only("2-")[#text()[- $10/40 = 2/8$]]
#v(20pt)
#only("3-")[#text()[- $24/40 = 3/5$]]
#only("1")[
#voiceover("Hier siehst du die Brüche mit einem gemeinsamen Nenner von vierzig.")
]
#only("2")[
#voiceover("Also haben wir jetzt zehn Vierzigstel statt zwei Achtel,")
]
#only("3")[
#voiceover("und vierundzwanzig Vierzigstel statt drei Fünftel. Du siehst, dass auf jeder Seite der Wert gleich ist, lediglich die Darstellung ist anders.")
]
]
...
plot_fraction_circle(ax, 40, 31, '10/40 + 24/40 = 31/40')
...
#only("2")[
#voiceover("Zehn Vierzigstel plus vierundzwanzig Vierzigstel ist also gleich einunddreißig Vierzigstel. Und das ist das korrekte Ergebnis.")
]
]
...
#v(20pt)
#only("1-")[Also ist $2/8 + 3/5 = 31/40$.]
#v(20pt)
#only("2-")[Gut gemacht! 🎉]
#only("1")[
#voiceover("Also ist zwei Achtel plus drei Fünftel gleich einunddreißig Vierzigstel.")
]
#only("2")[
