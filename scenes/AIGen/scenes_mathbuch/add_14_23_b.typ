...
#v(20pt)
#only("2-")[🛠️ Du hast den gemeinsamen Nenner nicht korrekt ermittelt und die Zähler falsch addiert]
#v(20pt)
#only("3-")[🛠️ Du musst auch die Zähler anpassen, um die Brüche korrekt zu addieren]
#only("1")[
#voiceover("Dein Fehler ist, dass du den gemeinsamen Nenner nicht korrekt ermittelt hast und die Zähler falsch addiert hast. Ein Viertel plus zwei Drittel ist nicht gleich drei Zwölftel.")
]
#only("2")[
#voiceover("Denn du hast den gemeinsamen Nenner falsch berechnet und die Zähler müssen ebenfalls angepasst werden, damit der Wert der Brüche erhalten bleibt.")
]
#only("3")[
...
#only("2")[
#voiceover("Diese Brüche haben verschiedene Nenner, also teilen wir sie in Stücke verschiedener Größe ein: Links haben wir Viertel und rechts Drittel. Das bedeutet, dass wir sie nicht direkt addieren können.")
]
#only("3")[
...
#only("1")[
#voiceover("Hier siehst du die Brüche, die wir auf einen gemeinsamen Nenner bringen wollen. Beginnen wir mit ein Viertel.")
]
#only("2")[
#voiceover("Zunächst siehst du ein Viertel, und daneben drei Zwölftel. Du kannst erkennen, dass der Wert gleich bleibt, nur die Darstellung ist anders. Also ist ein Viertel gleich drei Zwölftel, und nicht gleich drei Zwölftel.")
]
#only("3")[
#voiceover("Und hier siehst du zwei Drittel und acht Zwölftel. Auch hier bleibt der Wert gleich, nur die Darstellung ist anders. Zwei Drittel ist also gleich acht Zwölftel, und nicht gleich drei Zwölftel.")
]
]
...
#v(20pt)
#only("1-")[Also ist $1/4 + 2/3 = 11/12$, nicht $3/12$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beachte den Zähler beim Addieren von Brüchen]
#only("1")[
#voiceover("Also ist ein Viertel plus zwei Drittel gleich elf Zwölftel, nicht drei Zwölftel.")
]
#only("2")[
