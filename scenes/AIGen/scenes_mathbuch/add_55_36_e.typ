...
#v(20pt)
#only("2-")[$ 30/30 + 15/30 = (30+15)/30 = 45/30 $]
#only("1")[
#voiceover("Jetzt kannst du die Brüche addieren. Du addierst die Zähler und behältst den gemeinsamen Nenner.")
]
#only("2")[
#voiceover("Dreißig Dreißigstel plus fünfzehn Dreißigstel ist gleich fünfundvierzig Dreißigstel.")
]
]
...
#v(40pt)
#only("1-")[Daher ist $5/5 + 3/6 = 45/30 = 3/2$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist fünf Fünftel plus drei Sechstel gleich fünfundvierzig Dreißigstel, was gekürzt drei Halbe ergibt.")
]
#only("2")[
