...
#only("2")[
#voiceover("Und deine Antwort ist siebenunddreißig Vierzigstel. Das ist vollkommen richtig! Lass uns sehen, wie du zu dieser Antwort gekommen bist.")
]
]
...
#v(40pt)
#only("1-")[Daher ist $1/8 + 4/5 = 37/40$, und das hast du richtig berechnet!]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist ein Achtel plus vier Fünftel gleich siebenunddreißig Vierzigstel, und das hast du ganz richtig berechnet!")
]
#only("2")[
