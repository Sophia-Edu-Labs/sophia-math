...
#v(40pt)
#only("1-")[Dein Fehler: $ 9/10 + 4/6 ≠ (10+6)/(10 dot 6) $]
#v(20pt)
...
#v(40pt)
#only("1-")[Daher ist $9/10 + 4/6 = 47/30$, nicht $16/60$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist neun zehntel plus vier sechstel gleich siebenundvierzig dreißigstel, nicht sechzehn sechzigstel.")
]
#only("2")[
