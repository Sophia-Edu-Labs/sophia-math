...
#v(40pt)
//Antwort des Schülers: 19/15
#only("2-")[Deine Antwort: $19/15$]
#only("1")[
#voiceover("Wir sollen ein Zehntel plus sieben Sechstel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist neunzehn Fünfzehntel. Das ist vollkommen richtig! Lass uns sehen, wie du zu dieser Antwort gekommen bist.")
]
]
#slide()[
...
#v(20pt)
#only("2-")[$ 3/30 + 35/30 = (3+35)/30 = 38/30 = 19/15 $]
#only("1")[
#voiceover("Jetzt kannst du die Brüche addieren. Du addierst die Zähler und behältst den gemeinsamen Nenner.")
]
#only("2")[
#voiceover("Drei Dreißigstel plus fünfunddreißig Dreißigstel ist gleich achtunddreißig Dreißigstel, was gekürzt neunzehn Fünfzehntel ergibt.")
]
]
#slide()[
#text(size: 30pt, weight: "bold")[Fazit]
#v(40pt)
#only("1-")[Daher ist $1/10 + 7/6 = 19/15$, und das hast du richtig berechnet!]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist ein Zehntel plus sieben Sechstel gleich neunzehn Fünfzehntel, und das hast du ganz richtig berechnet!")
]
#only("2")[
