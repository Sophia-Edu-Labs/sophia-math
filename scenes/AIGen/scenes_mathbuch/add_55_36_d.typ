...
#v(20pt)
#only("2-")[$ 30/30 + 15/30 = (30+15)/30 = 45/30 = 3/2 = 1.5 $]
#only("1")[
#voiceover("Jetzt kannst du die Brüche addieren. Du addierst die Zähler und behältst den gemeinsamen Nenner.")
]
#only("2")[
#voiceover("Dreißig Dreißigstel plus fünfzehn Dreißigstel ist gleich fünfundvierzig Dreißigstel, was gleich drei Halbe oder eins Komma fünf ist.")
]
]
#slide()[
#text(size: 30pt, weight: "bold")[Fazit]
#v(40pt)
#only("1-")[Daher ist $5/5 + 3/6 = 2$, und das hast du richtig berechnet!]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist fünf Fünftel plus drei Sechstel gleich zwei, und das hast du ganz richtig berechnet!")
]
#only("2")[
