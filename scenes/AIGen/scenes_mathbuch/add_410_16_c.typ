...
#v(40pt)
#only("1-")[Dein Fehler: $4/10 + 1/6 ≠ (10 + 6)/(10 dot 6)$]
#v(20pt)
...
#v(40pt)
#only("1-")[Daher ist $4/10 + 1/6 = 17/30$, nicht $16/60$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist vier Zehntel plus ein Sechstel gleich siebzehn Dreißigstel, nicht sechzehn Sechzigstel.")
]
#only("2")[
