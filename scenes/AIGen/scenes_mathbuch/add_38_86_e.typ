...
#v(20pt)
#only("2-")[Vielfache von 8: 8, 16, 24, 32, ...]
#v(20pt)
...
#only("2")[
#voiceover("Die Vielfachen von acht sind acht, sechzehn, vierundzwanzig, zweiunddreißig und so weiter.")
]
#only("3")[
...
#v(40pt)
#only("1-")[Daher ist $3/8 + 8/6 = 41/24$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist drei Achtel plus acht Sechstel gleich einundvierzig vierundzwanzigstel.")
]
#only("2")[
