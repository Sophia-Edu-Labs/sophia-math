...
#only("2")[
#voiceover("Und deine Antwort ist einunddreißig Vierzigstel. Das ist vollkommen richtig! Lass uns sehen, wie du zu dieser Antwort gekommen bist.")
]
]
...
#v(40pt)
#only("1-")[Daher ist $1/8 + 3/10 = 17/40$, und das hast du richtig berechnet!]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist ein Achtel plus drei Zehntel gleich siebzehn Vierzigstel, und das hast du ganz richtig berechnet!")
]
#only("2")[
