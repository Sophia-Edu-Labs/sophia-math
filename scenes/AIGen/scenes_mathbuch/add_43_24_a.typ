...
#v(40pt)
//Antwort des Schülers: 6/7
#only("2-")[Deine Antwort: $6/7$]
#only("1")[
#voiceover("Wir sollen vier Drittel plus zwei Viertel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist sechs Siebtel. Das ist leider nicht richtig.")
]
]
...
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert hast. Vier Drittel plus zwei Viertel ist nicht gleich vier plus zwei geteilt durch drei plus vier.")
]
#only("2")[
...
#v(40pt)
#only("1-")[Daher ist $4/3 + 2/4 = 22/12$, nicht $6/7$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist vier Drittel plus zwei Viertel gleich zweiundzwanzig Zwölftel, nicht sechs Siebtel.")
]
#only("2")[
