...
#v(40pt)
//Antwort des Schülers: 38/15
#only("2-")[Deine Antwort: $38/15$]
#only("1")[
#voiceover("Wir sollen sechs Zehntel plus acht Sechstel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist achtunddreißig Fünfzehntel. Das ist vollkommen richtig! Lass uns sehen, wie du zu dieser Antwort gekommen bist.")
]
]
...
#v(20pt)
#only("2-")[$ 18/30 + 40/30 = (18+40)/30 = 58/30 = 29/15 $]
#only("1")[
#voiceover("Jetzt kannst du die Brüche addieren. Du addierst die Zähler und behältst den gemeinsamen Nenner.")
]
#only("2")[
#voiceover("Achtzehn Dreißigstel plus vierzig Dreißigstel ist gleich achtundfünfzig Dreißigstel, was weiter vereinfacht neunundzwanzig Fünfzehntel ergibt.")
]
]
...
#v(40pt)
#only("1-")[Daher ist $6/10 + 8/6 = 29/15$, und das hast du richtig berechnet!]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist sechs Zehntel plus acht Sechstel gleich neunundzwanzig Fünfzehntel, und das hast du ganz richtig berechnet!")
]
#only("2")[
