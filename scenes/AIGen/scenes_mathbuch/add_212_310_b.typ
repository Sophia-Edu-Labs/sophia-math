...
#v(40pt)
//Antwort des Schülers: 5/120
#only("2-")[Deine Antwort: $5/120$]
#only("1")[
#voiceover("Wir sollen zwei Zwölftel plus drei Zehntel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist fünf hundertzwanzigstel. Das ist schon mal ein guter Ansatz, aber leider noch nicht ganz richtig.")
]
]
...
#v(40pt)
#only("2-")[$ 2/12 ≠ 2/120$, #h(10pt)sondern #h(10pt)$2/12 = 1/6 $]
#v(40pt)
#only("3-")[$ 3/10 ≠ 3/120$, #h(10pt)sondern #h(10pt)$3/10 = 3/10 $]
#only("1")[
...
#only("2")[
#voiceover("Zwei Zwölftel ist nicht gleich zwei hundertzwanzigstel, sondern ein Sechstel.")
]
#only("3")[
#voiceover("Und drei Zehntel ist nicht gleich drei hundertzwanzigstel, sondern drei Zehntel.")
]
]
...
#v(40pt)
#only("1-")[Daher ist $2/12 + 3/10 = 28/60$, nicht $5/120$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beim Erweitern der Brüche auf den gemeinsamen Nenner, passe immer auch die Zähler entsprechend an!]
#only("1")[
#voiceover("Daher ist zwei Zwölftel plus drei Zehntel gleich achtundzwanzig Sechzigstel, nicht fünf hundertzwanzigstel.")
]
#only("2")[
