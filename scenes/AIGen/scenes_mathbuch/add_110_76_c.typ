...
#v(40pt)
#only("1-")[Dein Fehler: $1/10 + 7/6 ≠ (10+6)/(10 dot 6)$]
#v(20pt)
...
#v(40pt)
#only("1-")[Daher ist $1/10 + 7/6 = 38/30$, nicht $16/60$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist ein Zehntel plus sieben Sechstel gleich achtunddreißig Dreißigstel, nicht sechzehn Sechzigstel.")
]
#only("2")[
