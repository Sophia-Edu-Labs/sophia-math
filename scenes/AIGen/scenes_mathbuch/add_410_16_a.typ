...
#v(40pt)
//Antwort des Schülers: 5/16
#only("2-")[Deine Antwort: $5/16$]
#only("1")[
#voiceover("Wir sollen vier Zehntel plus ein Sechstel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist fünf Sechzehntel. Das ist leider nicht richtig.")
]
]
#slide()[
...
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert hast. Vier Zehntel plus ein Sechstel ist nicht gleich vier plus eins geteilt durch zehn plus sechs.")
]
#only("2")[
...
#v(40pt)
#only("1-")[Daher ist $4/10 + 1/6 = 17/30$, nicht $5/16$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist vier Zehntel plus ein Sechstel gleich siebzehn Dreißigstel, nicht fünf Sechzehntel.")
]
#only("2")[
