...
#v(40pt)
//Antwort des Schülers: 14/40
#only("2-")[Deine Antwort: $14/40$]
#only("1")[
#voiceover("Wir sollen fünf Viertel plus sieben Zehntel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist vierzehn Vierzigstel. Das ist leider nicht richtig.")
]
]
#slide()[
#text(size: 30pt, weight: "bold")[Dein Fehler]
#v(40pt)
#only("1-")[Dein Fehler: $ 5/4 + 7/10 ≠ (4+10)/(4 dot 10) $]
#v(20pt)
...
#only("3")[
#voiceover("Sieben Zehntel wird mit zwei Zweitel erweitert, das ergibt vierzehn Zwanzigstel.")
]
]
#slide()[
...
#v(40pt)
#only("1-")[Daher ist $5/4 + 7/10 = 39/20$, nicht $14/40$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist fünf Viertel plus sieben Zehntel gleich neununddreißig Zwanzigstel, nicht vierzehn Vierzigstel.")
]
#only("2")[
