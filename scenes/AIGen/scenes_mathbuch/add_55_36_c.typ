...
#v(40pt)
#only("1-")[Dein Fehler: $5/5 + 3/6 ≠ (5+6)/(5 dot 6)$]
#v(20pt)
...
#only("2")[
#voiceover("Indem du die Zähler und Nenner auf diese Weise behandelst, erhältst du nicht das korrekte Ergebnis.")
]
#only("3")[
...
#only("2")[
#voiceover("Dreißig dreißigstel plus fünfzehn dreißigstel ist gleich fünfundvierzig dreißigstel oder drei halbe.")
]
]
...
#v(40pt)
#only("1-")[Daher ist $5/5 + 3/6 = 3/2$, nicht $11/30$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist fünf fünftel plus drei sechstel gleich drei halbe, nicht elf dreißigstel.")
]
#only("2")[
