...
#v(40pt)
//Antwort des Schülers: 9/30
#only("2-")[Deine Antwort: $9/30$]
#only("1")[
#voiceover("Wir sollen sechs Fünftel plus drei Sechstel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist neun Dreißigstel. Das ist schon mal ein guter Ansatz, aber leider noch nicht ganz richtig.")
]
]
...
#v(40pt)
#only("2-")[$6/5 ≠ 6/30$, #h(10pt)sondern #h(10pt)$6/5 = 36/30$]
#v(40pt)
#only("3-")[$3/6 ≠ 3/30$, #h(10pt)sondern #h(10pt)$3/6 = 15/30$]
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner einfach multipliziert hast. Das ist aber nicht richtig, denn")
]
#only("2")[
#voiceover("Sechs Fünftel ist nicht gleich sechs Dreißigstel, sondern sechsunddreißig Dreißigstel.")
]
#only("3")[
#voiceover("Und drei Sechstel ist nicht gleich drei Dreißigstel, sondern fünfzehn Dreißigstel.")
]
]
...
#v(40pt)
#only("1-")[Daher ist $6/5 + 3/6 = 51/30$, nicht $9/30$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beim Erweitern der Brüche auf den gemeinsamen Nenner, passe immer auch die Zähler entsprechend an!]
#only("1")[
#voiceover("Daher ist sechs Fünftel plus drei Sechstel gleich einundfünfzig Dreißigstel, nicht neun Dreißigstel.")
]
#only("2")[
