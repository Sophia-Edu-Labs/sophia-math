...
#v(40pt)
#only("1-")[Dein Fehler: $1/3 + 2/6 ≠ (1+2)/(3+6)$]
#v(20pt)
...
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert hast. Ein Drittel plus zwei Sechstel ist nicht gleich eins plus zwei geteilt durch drei plus sechs.")
]
#only("2")[
...
#only("3")[
#voiceover("und zwei Sechstel statt zwei Sechstel. Du siehst, dass auf jeder Seite der Wert gleich ist, lediglich die Darstellung ist anders.")
]
]
...
#first plot the fraction 2/6, which is equivalent to the fraction 1/3
plot_fraction_circle(axs[0], 6, 2, '2/6')
#then plot the fraction 3/6, which is equivalent to the fraction 2/6
plot_fraction_circle(axs[1], 6, 3, '3/6')
...
plot_fraction_circle(ax, 6, 5, '2/6 + 3/6 = 5/6')
...
#only("2")[
#voiceover("Zwei Sechstel plus drei Sechstel ist also gleich fünf Sechstel. Und das ist das korrekte Ergebnis.")
]
]
...
#v(20pt)
#only("1-")[Also ist $1/3 + 2/6 = 5/6$, nicht $3/9$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beachte den Zähler beim Addieren von Brüchen]
#only("1")[
#voiceover("Also ist ein Drittel plus zwei Sechstel gleich fünf Sechstel, nicht drei Neuntel.")
]
#only("2")[
