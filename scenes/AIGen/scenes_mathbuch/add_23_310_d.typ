...
#v(40pt)
//Antwort des Schülers: 29/30
#only("2-")[Deine Antwort: $29/30$]
#only("1")[
#voiceover("Wir sollen zwei Drittel plus drei Zehntel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist neunundzwanzig Dreißigstel. Das ist vollkommen richtig! Lass uns sehen, wie du zu dieser Antwort gekommen bist.")
]
]
...
#v(40pt)
#only("1-")[Daher ist $2/3 + 3/10 = 29/30$, und das hast du richtig berechnet!]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist zwei Drittel plus drei Zehntel gleich neunundzwanzig Dreißigstel, und das hast du ganz richtig berechnet!")
]
#only("2")[
