...
#v(40pt)
//Antwort des Schülers: 14/16
#only("2-")[Deine Antwort: $14/16$]
#only("1")[
#voiceover("Wir sollen sechs Zehntel plus acht Sechstel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist vierzehn Sechzehntel. Das ist leider nicht richtig.")
]
]
#slide()[
...
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert hast. Sechs Zehntel plus acht Sechstel ist nicht gleich sechs plus acht geteilt durch zehn plus sechs.")
]
#only("2")[
...
#v(40pt)
#only("1-")[Daher ist $6/10 + 8/6 = 58/30$, nicht $14/16$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist sechs Zehntel plus acht Sechstel gleich achtundfünfzig Dreißigstel, nicht vierzehn Sechzehntel.")
]
#only("2")[
