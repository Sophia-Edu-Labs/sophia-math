...
#v(40pt)
#only("1-")[Dein Fehler: $2/8 + 3/5 ≠ (8+5)/(8 dot 5)$]
#v(20pt)
#only("2-")[🛠️ Du hast die Summe der Nenner durch das Produkt der Nenner geteilt]
#v(20pt)
#only("3-")[🛠️ Du musst den Zähler anders bestimmen]
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert und multipliziert hast. Zwei Achtel plus drei Fünftel ist nicht gleich dreizehn Vierzigstel.")
]
#only("2")[
...
#only("4")[
#voiceover("Der gemeinsame Nenner ist vierzig.")
]
]
...
#only("2")[
#voiceover("Zunächst siehst du zwei Achtel, und daneben zehn Vierzigstel. Du kannst erkennen, dass der Wert gleich bleibt, nur die Darstellung ist anders. Also ist zwei Achtel gleich zehn Vierzigstel.")
]
#only("3")[
#voiceover("Und hier siehst du drei Fünftel und vierundzwanzig Vierzigstel. Auch hier bleibt der Wert gleich, nur die Darstellung ist anders. Drei Fünftel ist also gleich vierundzwanzig Vierzigstel.")
]
]
...
#v(20pt)
#only("1-")[Also ist $2/8 + 3/5 = 34/40$, nicht $13/40$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beachte den Zähler beim Addieren von Brüchen]
#only("1")[
#voiceover("Also ist zwei Achtel plus drei Fünftel gleich vierunddreißig Vierzigstel, nicht dreizehn Vierzigstel.")
]
#only("2")[
