...
#v(40pt)
#only("1-")[Dein Fehler: $1/3 + 1/10 ≠ (3+10)/(3 dot 10)$]
#v(20pt)
#only("2-")[🛠️ Du hast die Summe der Zähler durch das Produkt der Nenner geteilt]
#v(20pt)
#only("3-")[🛠️ Du musst den Zähler anders bestimmen]
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert und multipliziert hast. Ein Drittel plus ein Zehntel ist nicht gleich dreizehn Dreißigstel.")
]
#only("2")[
...
#only("2")[
#voiceover("Zunächst siehst du ein Drittel, und daneben zehn Dreißigstel. Du kannst erkennen, dass der Wert gleich bleibt, nur die Darstellung ist anders. Also ist ein Drittel gleich zehn Dreißigstel, und nicht gleich dreizehn Dreißigstel.")
]
#only("3")[
#voiceover("Und hier siehst du ein Zehntel und drei Dreißigstel. Auch hier bleibt der Wert gleich, nur die Darstellung ist anders. Ein Zehntel ist also gleich drei Dreißigstel, und nicht gleich dreizehn Dreißigstel.")
]
]
...
#v(20pt)
#only("1-")[Also ist $1/3 + 1/10 = 13/30$, nicht $13/30$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beachte den Zähler beim Addieren von Brüchen]
#only("1")[
#voiceover("Also ist ein Drittel plus ein Zehntel gleich dreizehn Dreißigstel, nicht dreizehn Dreißigstel.")
]
#only("2")[
