...
#v(40pt)
//Antwort des Schülers: 13/16
#only("2-")[Deine Antwort: $13/16$]
#only("1")[
#voiceover("Wir sollen vier Zehntel plus neun Sechstel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist dreizehn Sechzehntel. Das ist leider nicht richtig.")
]
]
#slide()[
...
#only("1")[
#voiceover("Dein Fehler ist, dass du die Zähler und Nenner separat addiert hast. Vier Zehntel plus neun Sechstel ist nicht gleich vier plus neun geteilt durch zehn plus sechs.")
]
#only("2")[
...
#v(40pt)
#only("1-")[Daher ist $4/10 + 9/6 = 57/30$, nicht $13/16$.]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist vier Zehntel plus neun Sechstel gleich siebenundfünfzig Dreißigstel, nicht dreizehn Sechzehntel.")
]
#only("2")[
