...
fig, axs = plt.subplots(1, 2, figsize=(12, 5))
#first plot the fraction 5/10, which is equivalent to the fraction 1/2
plot_fraction_circle(axs[0], 10, 5, '5/10')
...
#only("2")[
#voiceover("Also haben wir jetzt fünf Zehntel statt einem Halb,")
]
#only("3")[
...
plot_fraction_circle(ax, 10, 6, '5/10 + 1/10 = 6/10')
...
#only("2")[
#voiceover("Fünf Zehntel plus ein Zehntel ist also gleich sechs Zehntel. Und das ist das korrekte Ergebnis.")
]
]
...
#v(20pt)
#only("1-")[Also ist $1/10 + 1/2 = 6/10$.]
#v(20pt)
#only("2-")[Merke dir: 🧮 Beachte den Zähler beim Addieren von Brüchen]
#only("1")[
#voiceover("Also ist ein Zehntel plus ein Halb gleich sechs Zehntel.")
]
#only("2")[
