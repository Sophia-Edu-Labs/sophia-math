...
#v(40pt)
//Antwort des Schülers: 67/40
#only("2-")[Deine Antwort: $67/40$]
#only("1")[
#voiceover("Wir sollen sieben Achtel plus vier Fünftel berechnen.")
]
#only("2")[
#voiceover("Und deine Antwort ist siebenundsechzig Vierzigstel. Das ist vollkommen richtig! Lass uns sehen, wie du zu dieser Antwort gekommen bist.")
]
]
...
#v(40pt)
#only("1-")[Daher ist $7/8 + 4/5 = 67/40$, und das hast du richtig berechnet!]
#v(20pt)
...
#only("1")[
#voiceover("Daher ist sieben Achtel plus vier Fünftel gleich siebenundsechzig Vierzigstel, und das hast du ganz richtig berechnet!")
]
#only("2")[
