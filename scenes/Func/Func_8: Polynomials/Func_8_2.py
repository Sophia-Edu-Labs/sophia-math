...
#             questionText=self.translate("Func_8_2.I1.q.question-text")
#         )
...
#         title = self.add_title(self.translate("Func_8_2.I1.q.title"))
...
#         # Action Sequence
#         with self.voiceover(
#                 text=self.translate("Func_8_2.I1.q.voiceover")
#         ) as tracker:        
...
#         with self.voiceover(
#                 text=self.translate("Func_8_2.I1.a.voiceover")
#         ) as tracker:        
...
#         with self.voiceover(
#                 text=self.translate("Func_8_2.I1.d.voiceover")
#         ) as tracker:        
...
#         deg_translated = self.translate("degree")
#         blist = BulletedList(deg_translated+" $1$", deg_translated+" $2$", deg_translated+" $\geq3$", color=c1t, height=2, width=2).shift(0.6*LEFT)
#         bracket = Brace(VGroup(blist[0], blist[1]), direction=RIGHT, color=GREEN)
#         simple_solution = VGroup(Tex(self.translate("Func_8_2.I2.simple"), font_size=fs3, color=GREEN), Tex(self.translate("Func_8_2.I2.solution"), color=GREEN, font_size=fs3)).arrange(DOWN, aligned_edge=LEFT, buff=.2).next_to(bracket, RIGHT, buff=0.2)
#         for idx in range(3):
#             blist[idx].set_color(BLACK)
#         # Action Sequence
#         with self.voiceover(
#                 text=self.translate("Func_8_2.I2.voiceover")
#         ) as tracker:        
...
#             answerOptions = ["$\{0,1\}$", "$\{1\}$", "$\{0\}$", "$\{-1,1\}$"],
#             correctAnswerIndex = 3,
#             questionText=self.translate("Func_8_2.I3.q.question-text")
#         )
...
#         title = self.add_title(self.translate("Func_8_2.I3.q.title"))
...
#         with self.voiceover(
#                 text=self.translate("Func_8_2.I3.q.voiceover")
#         ) as tracker:        
...
#         # Action Sequence
#         with self.voiceover(
#                 text=self.translate("Func_8_2.I3.a.voiceover")
#         ) as tracker:        
