...
class Func_6_P_2_4_b(SophiaCursorScene):
...
class Func_6_P_2_4_c(SophiaCursorScene):
...
class Func_6_P_2_4_d(SophiaCursorScene):
...
#####################################
class Func_6_P_2_1_q(SophiaCursorScene):
...
class Func_6_P_2_1_b(SophiaCursorScene):
...
class Func_6_P_2_1_c(SophiaCursorScene):
...
class Func_6_P_2_1_d(SophiaCursorScene):
...
#####################################
##################################### ADD PROTOTYPES
# class Func_6_P_2_2_q(SophiaCursorScene):
...
# #####################################
# #####################################
# class Func_6_P_2_3_q(SophiaCursorScene):
