...
class Func_4_2_I_1_q(SophiaCursorScene):
    ...
    def task_definition(self) -> SophiaTaskDefinition:
        return SophiaTaskDefinition(
            answerOptions=ast.literal_eval(self.translate("Func_4_2.I1.q.answer-options")),
...
PROTOTYPES = [
    ...
    PagePrototypeQuestion.from_scene(Func_4_2_I_1_q),
    ...
    PagePrototypeQuestion.from_scene(Func_4_2_I_2_q),
    ...
    PagePrototypeQuestion.from_scene(Func_4_2_I_4_q),
    ...
    PagePrototypeQuestion.from_scene(Func_4_2_I_5_q),
